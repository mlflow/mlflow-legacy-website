...
### Running Your First Project[​](#running-your-first-project "Direct link to Running Your First Project")
...
:::tip Project Structure Any directory with a `MLproject` file or containing `.py`/`.sh` files can be run as an MLflow Project. No complex setup required! :::

## Core Concepts[​](#core-concepts "Direct link to Core Concepts")

### Project Components[​](#project-components "Direct link to Project Components")
...
## Project Structure & Configuration[​](#project-structure--configuration "Direct link to Project Structure & Configuration")

### Convention-Based Projects[​](#convention-based-projects "Direct link to Convention-Based Projects")
...
### MLproject File Configuration[​](#mlproject-file-configuration "Direct link to MLproject File Configuration")
...
:::note Parameter Resolution `path` parameters automatically download remote files (S3, GCS, etc.) to local storage before execution. Use `uri` for applications that can read directly from remote storage. :::

## Environment Management[​](#environment-management "Direct link to Environment Management")

### Python Virtual Environments (Recommended)[​](#python-virtual-environments-recommended "Direct link to Python Virtual Environments (Recommended)")
...
:::warning Conda Terms By using Conda, you agree to [Anaconda's Terms of Service](https://legal.anaconda.com/policies/en/?name=terms-of-service). :::

### Docker Environments[​](#docker-environments "Direct link to Docker Environments")
...
### Local Execution[​](#local-execution "Direct link to Local Execution")
...
#### Databricks Platform[​](#databricks-platform "Direct link to Databricks Platform")
...
### Multi-Step Pipelines[​](#multi-step-pipelines "Direct link to Multi-Step Pipelines")
...
def hyperparameter_search():
    ...
    param_combinations = [
        ...
        dict(zip(param_grid.keys(), values)) for values in itertools.product(*param_grid.values())
...
### Docker Image Building[​](#docker-image-building "Direct link to Docker Image Building")
...
setup(
    ...
    entry_points={
        ...
        "mlflow.project_backend": ["my-backend=my_package.custom_backend:MyCustomBackend"]
