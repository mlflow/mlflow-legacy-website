...
[](/docs/3.12.0rc0/images/llms/tracing/chat-sessions-demo.mp4)
...
MLflow provides dedicated `session_id` and `user` parameters in both [`mlflow.update_current_trace()`](/docs/3.12.0rc0/api_reference/python_api/mlflow.html#mlflow.update_current_trace) and [`mlflow.tracing.context()`](/docs/3.12.0rc0/api_reference/python_api/mlflow.tracing.html#mlflow.tracing.context) for session and user tracking. Once they are set, you can filter and group traces by session and user.
...
When using auto-instrumented libraries (e.g. `mlflow.langchain.autolog()`), you don't control the traced function directly. Use [`mlflow.tracing.context()`](/docs/3.12.0rc0/api_reference/python_api/mlflow.tracing.html#mlflow.tracing.context) to inject user and session information into any trace created within its scope.
...
To record user and session information within a function you control, use the [`mlflow.update_current_trace()`](/docs/3.12.0rc0/api_reference/python_api/mlflow.html#mlflow.update_current_trace) API and pass the user and session IDs directly.
...
[Assess multi-turn session quality with conversation-level scorers](/docs/3.12.0rc0/genai/eval-monitor/running-evaluation/multi-turn.md)

[Evaluate sessions →](/docs/3.12.0rc0/genai/eval-monitor/running-evaluation/multi-turn.md)

### [Search Traces](/docs/3.12.0rc0/genai/tracing/search-traces.md)

[Master advanced filtering techniques for user and session analysis](/docs/3.12.0rc0/genai/tracing/search-traces.md)

[Learn search →](/docs/3.12.0rc0/genai/tracing/search-traces.md)

### [Production Monitoring](/docs/3.12.0rc0/genai/tracing/prod-tracing.md)

[Set up comprehensive production observability with user context](/docs/3.12.0rc0/genai/tracing/prod-tracing.md)

[Monitor production →](/docs/3.12.0rc0/genai/tracing/prod-tracing.md)
