...
:::tip Looking for Databricks Foundation Model APIs? This guide covers tracing LLM calls through **Databricks AI Gateway**. If you're using Databricks Foundation Model APIs directly, see the [Databricks Integration](/docs/3.12.0rc0/genai/tracing/integrations/listing/databricks.md) guide instead. :::
...
When you want to self-host MLflow outside Databricks, follow the [Self-hosting](/docs/3.12.0rc0/self-hosting.md) guide to set up your MLflow server and set the tracking URI accordingly.
