...
![Instructor Tracing via autolog](/docs/3.12.0rc0/assets/images/instructor-tracing-9d197095322fed09f9b5f0b28577542c.png)
...
[MLflow Tracing](/docs/3.12.0rc0/genai/tracing.md) works with Instructor by enabling auto-tracing for the underlying LLM libraries. For example, if you use Instructor for OpenAI LLMs, you can enable tracing with `mlflow.openai.autolog()` and the generated traces will capture the structured outputs from Instructor.
