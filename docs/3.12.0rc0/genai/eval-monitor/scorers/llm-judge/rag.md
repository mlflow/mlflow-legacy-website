...
All RAG judges require MLflow Traces with at least one span marked as `span_type="RETRIEVER"`. Use the [@mlflow.trace](/docs/3.12.0rc0/api_reference/python_api/mlflow.html#mlflow.trace) decorator with `span_type="RETRIEVER"` on your retrieval functions.
...
2. Create an MLflow experiment by following the [setup your environment quickstart](/docs/3.12.0rc0/genai/getting-started/connect-environment.md).
...
### [RetrievalRelevance](/docs/3.12.0rc0/genai/eval-monitor/scorers/llm-judge/rag/relevance.md#retrievalrelevance-judge)

[Evaluate if retrieved documents are relevant to queries](/docs/3.12.0rc0/genai/eval-monitor/scorers/llm-judge/rag/relevance.md#retrievalrelevance-judge)

[Learn more →](/docs/3.12.0rc0/genai/eval-monitor/scorers/llm-judge/rag/relevance.md#retrievalrelevance-judge)

### [RetrievalGroundedness](/docs/3.12.0rc0/genai/eval-monitor/scorers/llm-judge/rag/groundedness.md)

[Check if responses are grounded in retrieved context](/docs/3.12.0rc0/genai/eval-monitor/scorers/llm-judge/rag/groundedness.md)

[Learn more →](/docs/3.12.0rc0/genai/eval-monitor/scorers/llm-judge/rag/groundedness.md)

### [RetrievalSufficiency](/docs/3.12.0rc0/genai/eval-monitor/scorers/llm-judge/rag/context-sufficiency.md)

[Verify retrieved context contains all necessary information](/docs/3.12.0rc0/genai/eval-monitor/scorers/llm-judge/rag/context-sufficiency.md)

[Learn more →](/docs/3.12.0rc0/genai/eval-monitor/scorers/llm-judge/rag/context-sufficiency.md)
