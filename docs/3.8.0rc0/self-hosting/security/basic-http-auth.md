...
* [MLflow Authentication Python API](/docs/3.8.0rc0/api_reference/auth/python-api.html#mlflow.server.auth)
* [MLflow Authentication REST API](/docs/3.8.0rc0/api_reference/rest-api.html/)
...
| ------------------------------------------------------------------------------------------------------------ | ------------------------------------------- | ------ | ------------------- |
| [Create Experiment](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicecreateexperiment)         | `2.0/mlflow/experiments/create`             | `POST` | None                |
| [Get Experiment](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicegetexperiment)               | `2.0/mlflow/experiments/get`                | `GET`  | can\_read           |
| [Get Experiment By Name](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicegetexperimentbyname) | `2.0/mlflow/experiments/get-by-name`        | `GET`  | can\_read           |
| [Delete Experiment](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicedeleteexperiment)         | `2.0/mlflow/experiments/delete`             | `POST` | can\_delete         |
| [Restore Experiment](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicerestoreexperiment)       | `2.0/mlflow/experiments/restore`            | `POST` | can\_delete         |
| [Update Experiment](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowserviceupdateexperiment)         | `2.0/mlflow/experiments/update`             | `POST` | can\_update         |
| [Search Experiments](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicesearchexperiments)       | `2.0/mlflow/experiments/search`             | `POST` | None                |
| [Search Experiments](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicesearchexperiments)       | `2.0/mlflow/experiments/search`             | `GET`  | None                |
| [Set Experiment Tag](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicesetexperimenttag)        | `2.0/mlflow/experiments/set-experiment-tag` | `POST` | can\_update         |
| [Create Run](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicecreaterun)                       | `2.0/mlflow/runs/create`                    | `POST` | can\_update         |
| [Get Run](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicegetrun)                             | `2.0/mlflow/runs/get`                       | `GET`  | can\_read           |
| [Update Run](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowserviceupdaterun)                       | `2.0/mlflow/runs/update`                    | `POST` | can\_update         |
| [Delete Run](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicedeleterun)                       | `2.0/mlflow/runs/delete`                    | `POST` | can\_delete         |
| [Restore Run](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicerestorerun)                     | `2.0/mlflow/runs/restore`                   | `POST` | can\_delete         |
| [Search Runs](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicesearchruns)                     | `2.0/mlflow/runs/search`                    | `POST` | None                |
| [Set Tag](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicesettag)                             | `2.0/mlflow/runs/set-tag`                   | `POST` | can\_update         |
| [Delete Tag](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicedeletetag)                       | `2.0/mlflow/runs/delete-tag`                | `POST` | can\_update         |
| [Log Metric](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicelogmetric)                       | `2.0/mlflow/runs/log-metric`                | `POST` | can\_update         |
| [Log Param](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicelogparam)                         | `2.0/mlflow/runs/log-parameter`             | `POST` | can\_update         |
| [Log Batch](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicelogbatch)                         | `2.0/mlflow/runs/log-batch`                 | `POST` | can\_update         |
| [Log Model](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicelogmodel)                         | `2.0/mlflow/runs/log-model`                 | `POST` | can\_update         |
| [List Artifacts](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicelistartifacts)               | `2.0/mlflow/artifacts/list`                 | `GET`  | can\_read           |
| [Get Metric History](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicegetmetrichistory)        | `2.0/mlflow/metrics/get-history`            | `GET`  | can\_read           |

Required Permissions for accessing registered models:

| API                                                                                                                                 | Endpoint                                           | Method   | Required permission |
| ----------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- | -------- | ------------------- |
| [Create Registered Model](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicecreateregisteredmodel)              | `2.0/mlflow/registered-models/create`              | `POST`   | None                |
| [Rename Registered Model](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicerenameregisteredmodel)              | `2.0/mlflow/registered-models/rename`              | `POST`   | can\_update         |
| [Update Registered Model](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryserviceupdateregisteredmodel)              | `2.0/mlflow/registered-models/update`              | `PATCH`  | can\_update         |
| [Delete Registered Model](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicedeleteregisteredmodel)              | `2.0/mlflow/registered-models/delete`              | `DELETE` | can\_delete         |
| [Get Registered Model](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicegetregisteredmodel)                    | `2.0/mlflow/registered-models/get`                 | `GET`    | can\_read           |
| [Search Registered Models](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicesearchregisteredmodels)            | `2.0/mlflow/registered-models/search`              | `GET`    | None                |
| [Get Latest Versions](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicegetlatestversions)                      | `2.0/mlflow/registered-models/get-latest-versions` | `POST`   | can\_read           |
| [Get Latest Versions](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicegetlatestversions)                      | `2.0/mlflow/registered-models/get-latest-versions` | `GET`    | can\_read           |
| [Set Registered Model Tag](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicesetregisteredmodeltag)             | `2.0/mlflow/registered-models/set-tag`             | `POST`   | can\_update         |
| [Delete Registered Model Tag](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicedeleteregisteredmodeltag)       | `2.0/mlflow/registered-models/delete-tag`          | `DELETE` | can\_update         |
| [Set Registered Model Alias](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicesetregisteredmodelalias)         | `2.0/mlflow/registered-models/alias`               | `POST`   | can\_update         |
| [Delete Registered Model Alias](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicedeleteregisteredmodelalias)   | `2.0/mlflow/registered-models/alias`               | `DELETE` | can\_delete         |
| [Get Model Version By Alias](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicegetmodelversionbyalias)          | `2.0/mlflow/registered-models/alias`               | `GET`    | can\_read           |
| [Create Model Version](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicecreatemodelversion)                    | `2.0/mlflow/model-versions/create`                 | `POST`   | can\_update         |
| [Update Model Version](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryserviceupdatemodelversion)                    | `2.0/mlflow/model-versions/update`                 | `PATCH`  | can\_update         |
| [Transition Model Version Stage](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicetransitionmodelversionstage) | `2.0/mlflow/model-versions/transition-stage`       | `POST`   | can\_update         |
| [Delete Model Version](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicedeletemodelversion)                    | `2.0/mlflow/model-versions/delete`                 | `DELETE` | can\_delete         |
| [Get Model Version](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicegetmodelversion)                          | `2.0/mlflow/model-versions/get`                    | `GET`    | can\_read           |
| [Search Model Versions](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicesearchmodelversions)                  | `2.0/mlflow/model-versions/search`                 | `GET`    | None                |
| [Get Model Version Download Uri](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicegetmodelversiondownloaduri)  | `2.0/mlflow/model-versions/get-download-uri`       | `GET`    | can\_read           |
| [Set Model Version Tag](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicesetmodelversiontag)                   | `2.0/mlflow/model-versions/set-tag`                | `POST`   | can\_update         |
| [Delete Model Version Tag](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicedeletemodelversiontag)             | `2.0/mlflow/model-versions/delete-tag`             | `DELETE` | can\_delete         |
...
| API                                                                                                                                | Endpoint                                          | Method   | Required permission         |
| ---------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------- | -------- | --------------------------- |
| [Create User](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowauthservicecreateuser)                                             | `2.0/mlflow/users/create`                         | `POST`   | None                        |
| [Get User](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowauthservicegetuser)                                                   | `2.0/mlflow/users/get`                            | `GET`    | Only readable by that user  |
| [Update User Password](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowauthserviceupdateuserpassword)                            | `2.0/mlflow/users/update-password`                | `PATCH`  | Only updatable by that user |
| [Update User Admin](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowauthserviceupdateuseradmin)                                  | `2.0/mlflow/users/update-admin`                   | `PATCH`  | Only admin                  |
| [Delete User](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowauthservicedeleteuser)                                             | `2.0/mlflow/users/delete`                         | `DELETE` | Only admin                  |
| [Create Experiment Permission](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowauthservicecreateexperimentpermission)            | `2.0/mlflow/experiments/permissions/create`       | `POST`   | can\_manage                 |
| [Get Experiment Permission](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowauthservicegetexperimentpermission)                  | `2.0/mlflow/experiments/permissions/get`          | `GET`    | can\_manage                 |
| [Update Experiment Permission](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowauthserviceupdateexperimentpermission)            | `2.0/mlflow/experiments/permissions/update`       | `PATCH`  | can\_manage                 |
| [Delete Experiment Permission](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowauthservicedeleteexperimentpermission)            | `2.0/mlflow/experiments/permissions/delete`       | `DELETE` | can\_manage                 |
| [Create Registered Model Permission](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowauthservicecreateregisteredmodelpermission) | `2.0/mlflow/registered-models/permissions/create` | `POST`   | can\_manage                 |
| [Get Registered Model Permission](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowauthservicegetregisteredmodelpermission)       | `2.0/mlflow/registered-models/permissions/get`    | `GET`    | can\_manage                 |
| [Update Registered Model Permission](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowauthserviceupdateregisteredmodelpermission) | `2.0/mlflow/registered-models/permissions/update` | `PATCH`  | can\_manage                 |
| [Delete Registered Model Permission](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowauthservicedeleteregisteredmodelpermission) | `2.0/mlflow/registered-models/permissions/delete` | `DELETE` | can\_manage                 |
...
| ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------- | ------ | ----------------------------------------------------------------------- |
| [Create Experiment](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicecreateexperiment)                     | `2.0/mlflow/experiments/create`       | `POST` | Automatically grants `MANAGE` permission to the creator.                |
| [Create Registered Model](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicecreateregisteredmodel)   | `2.0/mlflow/registered-models/create` | `POST` | Automatically grants `MANAGE` permission to the creator.                |
| [Search Experiments](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicesearchexperiments)                   | `2.0/mlflow/experiments/search`       | `POST` | Only returns experiments which the user has `READ` permission on.       |
| [Search Experiments](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicesearchexperiments)                   | `2.0/mlflow/experiments/search`       | `GET`  | Only returns experiments which the user has `READ` permission on.       |
| [Search Runs](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmlflowservicesearchruns)                                 | `2.0/mlflow`                          | `POST` | Only returns experiments which the user has `READ` permission on.       |
| [Search Registered Models](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicesearchregisteredmodels) | `2.0/mlflow/registered-models/search` | `GET`  | Only returns registered models which the user has `READ` permission on. |
| [Search Model Versions](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowmodelregistryservicesearchmodelversions)       | `2.0/mlflow/model-versions/search`    | `GET`  | Only returns registered models which the user has `READ` permission on. |
...
MLflow provides [REST APIs](/docs/3.8.0rc0/api_reference/rest-api.html/#mlflowauthservicecreateuser) and a client class [`AuthServiceClient`](/docs/3.8.0rc0/api_reference/auth/python-api.html#mlflow.server.auth.client.AuthServiceClient) to manage users and permissions. To instantiate `AuthServiceClient`, it is recommended that you use [`mlflow.server.get_app_client()`](/docs/3.8.0rc0/api_reference/python_api/mlflow.server.html#mlflow.server.get_app_client).
...
![](/docs/3.8.0rc0/assets/images/auth_prompt-fae372058246a97a44a2236263de5c75.png)
...
MLflow [`AuthServiceClient`](/docs/3.8.0rc0/api_reference/auth/python-api.html#mlflow.server.auth.client.AuthServiceClient) provides a function to create new users easily.
