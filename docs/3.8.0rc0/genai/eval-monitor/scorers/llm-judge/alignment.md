...
![MLflow UI Feedback Interface](/docs/3.8.0rc0/images/assessments/add_feedback_ui.png)
...
To create a custom alignment optimizer, extend the [AlignmentOptimizer](/docs/3.8.0rc0/api_reference/python_api/mlflow.genai.html#mlflow.genai.judges.base.AlignmentOptimizer) abstract base class:
...
[Learn to create domain-specific judges with make\_judge.](/docs/3.8.0rc0/genai/eval-monitor/scorers/llm-judge/make-judge.md)

[Create judges →](/docs/3.8.0rc0/genai/eval-monitor/scorers/llm-judge/make-judge.md)

### [Development Workflow](/docs/3.8.0rc0/genai/eval-monitor/scorers/llm-judge/workflow.md)

[See complete workflow from creation to aligned production judge.](/docs/3.8.0rc0/genai/eval-monitor/scorers/llm-judge/workflow.md)

[View workflow →](/docs/3.8.0rc0/genai/eval-monitor/scorers/llm-judge/workflow.md)

### [Dataset Integration](/docs/3.8.0rc0/genai/datasets.md)

[Use judges with evaluation datasets for systematic testing.](/docs/3.8.0rc0/genai/datasets.md)

[Learn integration →](/docs/3.8.0rc0/genai/datasets.md)
