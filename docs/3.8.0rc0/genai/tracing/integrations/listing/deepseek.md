...
![Deepseek Tracing via autolog](/docs/3.8.0rc0/assets/images/deepseek-tracing-agent-9bc5d50e8a028ac3e2f11325c0c05277.png)

[MLflow Tracing](/docs/3.8.0rc0/genai/tracing/integrations.md) provides automatic tracing capability for Deepseek models through the OpenAI SDK integration. Since DeepSeek uses an OpenAI-compatible API format, you can use `mlflow.openai.autolog()` to trace interactions with DeepSeek models.
...
![Deepseek Tracing](/docs/3.8.0rc0/assets/images/deepseek-tracing-148528f9d4da0be7e5c4ec64b21ce52c.png)

## Streaming and Async Support[​](#streaming-and-async-support "Direct link to Streaming and Async Support")

MLflow supports tracing for streaming and async DeepSeek APIs. Visit the [OpenAI Tracing documentation](/docs/3.8.0rc0/genai/tracing/integrations/listing/openai.md) for example code snippets for tracing streaming and async calls through OpenAI SDK.
