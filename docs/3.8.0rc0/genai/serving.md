...
### [Custom Applications](/docs/3.8.0rc0/genai/serving/custom-apps.md)

[Build sophisticated serving logic with custom preprocessing, routing, and business rules](/docs/3.8.0rc0/genai/serving/custom-apps.md)

[Build custom apps →](/docs/3.8.0rc0/genai/serving/custom-apps.md)

### [Responses Agents](/docs/3.8.0rc0/genai/serving/responses-agent.md)

[Handle complex response patterns and multi-step inference workflows](/docs/3.8.0rc0/genai/serving/responses-agent.md)

[Learn about agents →](/docs/3.8.0rc0/genai/serving/responses-agent.md)
