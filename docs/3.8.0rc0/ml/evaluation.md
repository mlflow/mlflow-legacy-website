...
**For GenAI/LLM evaluation**, please use the system at [GenAI Evaluation](/docs/3.8.0rc0/genai/eval-monitor.md) which uses:
...
MLflow 2.18.0 moved model validation from [`mlflow.models.evaluate()`](/docs/3.8.0rc0/api_reference/python_api/mlflow.models.html#mlflow.models.evaluate) to [`mlflow.validate_evaluation_results()`](/docs/3.8.0rc0/api_reference/python_api/mlflow.html#mlflow.validate_evaluation_results).
...
For GenAI/LLM custom metrics, use the [@scorer decorator](/docs/3.8.0rc0/genai/eval-monitor/scorers/custom.md) instead.
...
* [`mlflow.models.evaluate()`](/docs/3.8.0rc0/api_reference/python_api/mlflow.models.html#mlflow.models.evaluate) - Main evaluation API
* [`mlflow.validate_evaluation_results()`](/docs/3.8.0rc0/api_reference/python_api/mlflow.html#mlflow.validate_evaluation_results) - Validate evaluation results
* [`mlflow.models.make_metric()`](/docs/3.8.0rc0/api_reference/python_api/mlflow.models.html#mlflow.models.make_metric) - Create custom metrics
* [`mlflow.metrics.base.MetricValue()`](/docs/3.8.0rc0/api_reference/python_api/mlflow.metrics.html#mlflow.metrics.base.MetricValue) - Metric return value
