...
![Gateway Overview](/docs/3.9.1.dev0/assets/images/gateway-overview-2bbf3cf41c12806962300767a53094c0.png)
...
![API Keys Page](/docs/3.9.1.dev0/assets/images/api-keys-page-120794235927669caacd55978043270f.png)
...
Endpoints define how requests are routed to AI models. For advanced routing features like traffic splitting and fallbacks, see the [Advanced Routing](/docs/3.9.1.dev0/genai/governance/ai-gateway/routing.md) guide.
