...
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| [Agent-as-a-Judge](/docs/3.9.1.dev0/genai/eval-monitor/scorers/llm-judge/agentic-overview.md)       | ✅                                                                                   |
| [Template-based LLM Scorers](/docs/3.9.1.dev0/genai/eval-monitor/scorers/llm-judge/make-judge.md)   | ✅                                                                                   |
| [Code-based Scorers](/docs/3.9.1.dev0/genai/eval-monitor/scorers/custom.md)                         | ❌                                                                                   |
| [Guidelines-based LLM Scorers](/docs/3.9.1.dev0/genai/eval-monitor/scorers/llm-judge/guidelines.md) | ❌ (Use [MLflow Prompt Registry](/docs/3.9.1.dev0/genai/prompt-registry.md) instead) |
...
When you create a judge using the [Judge Builder UI](/docs/3.9.1.dev0/genai/eval-monitor/scorers/llm-judge/make-judge.md), it is automatically registered to the current experiment as version 1.
