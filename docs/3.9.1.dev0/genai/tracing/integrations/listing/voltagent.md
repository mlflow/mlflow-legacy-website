...
![VoltAgent Tracing](/docs/3.9.1.dev0/images/llms/tracing/voltagent-tracing.png)

[MLflow Tracing](/docs/3.9.1.dev0/genai/tracing.md) provides automatic tracing capability for [VoltAgent](https://github.com/VoltAgent/voltagent), an open-source TypeScript framework for building AI agents. MLflow supports tracing for VoltAgent through the [OpenTelemetry](/docs/3.9.1.dev0/genai/tracing/opentelemetry.md) integration.
...
![VoltAgent trace in MLflow UI](/docs/3.9.1.dev0/images/llms/tracing/voltagent-tracing.png)
