...
![txtai Tracing via autolog](/docs/3.10.0rc0/assets/images/txtai-rag-tracing-507199b924f1c7ed180e0d940758e2dc.png)
...
[MLflow Tracing](/docs/3.10.0rc0/genai/tracing.md) provides automatic tracing capability for txtai. Auto tracing for txtai can be enabled by calling the `mlflow.txtai.autolog` function, MLflow will capture traces for LLM invocation, embeddings, vector search, and log them to the active MLflow Experiment.
...
![txtai Textractor Tracing via autolog](/docs/3.10.0rc0/assets/images/txtai-textractor-tracing-15f2e1b268fc3fc4921c06e5e9a87cd8.png)
...
![txtai Rag Tracing via autolog](/docs/3.10.0rc0/assets/images/txtai-rag-tracing-507199b924f1c7ed180e0d940758e2dc.png)
...
![txtai Agent Tracing via autolog](/docs/3.10.0rc0/assets/images/txtai-agent-tracing-f69f47a9de38c40814ea985887782850.png)
