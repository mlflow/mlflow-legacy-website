...
![AutoGen tracing via autolog](/docs/3.10.0rc0/assets/images/autogen-trace-872bd836d047c1a308cee87a312d0260.png)
...
[MLflow Tracing](/docs/3.10.0rc0/genai/tracing/integrations.md) provides automatic tracing capability for AutoGen AgentChat. By enabling auto tracing for AutoGen by calling the [`mlflow.autogen.autolog()`](/docs/3.10.0rc0/api_reference/python_api/mlflow.autogen.html#mlflow.autogen.autolog) function, MLflow will capture nested traces and log them to the active MLflow Experiment upon agents execution.
