...
![Pipecat Logo](/docs/3.10.0rc0/images/logos/pipecat.png)
...
To use other types of SQL databases such as PostgreSQL, MySQL, and MSSQL, change the store URI as described in the [backend store documentation](/docs/3.10.0rc0/self-hosting/architecture/backend-store.md).
...
For complete step-by-step instructions on sending traces to MLflow from OpenTelemetry compatible frameworks, see the [Collect OpenTelemetry Traces into MLflow](/docs/3.10.0rc0/genai/tracing/opentelemetry/ingest.md).
