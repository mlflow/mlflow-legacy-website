...
All scorers in MLflow produce standardized output that integrates seamlessly with the evaluation framework. Scorers return a [`mlflow.entities.Feedback()`](/docs/3.10.0rc0/api_reference/python_api/mlflow.entities.html#mlflow.entities.Feedback) object containing:
...
MLflow's alignment system uses a plugin architecture, allowing you to create custom optimizers by extending the [AlignmentOptimizer](/docs/3.10.0rc0/api_reference/python_api/mlflow.genai.html#mlflow.genai.judges.base.AlignmentOptimizer) base class:
...
### [LLM-based Scorers](/docs/3.10.0rc0/genai/eval-monitor/scorers/llm-judge/custom-judges.md)

[Learn about using LLMs as judges for evaluation](/docs/3.10.0rc0/genai/eval-monitor/scorers/llm-judge/custom-judges.md)

[Explore LLM judges →](/docs/3.10.0rc0/genai/eval-monitor/scorers/llm-judge/custom-judges.md)

### [Judge Alignment](/docs/3.10.0rc0/genai/eval-monitor/scorers/llm-judge/alignment.md)

[Align judges with human feedback for domain expertise](/docs/3.10.0rc0/genai/eval-monitor/scorers/llm-judge/alignment.md)

[Learn alignment →](/docs/3.10.0rc0/genai/eval-monitor/scorers/llm-judge/alignment.md)

### [Code-based Scorers](/docs/3.10.0rc0/genai/eval-monitor/scorers/custom.md)

[Create custom Python functions for evaluation](/docs/3.10.0rc0/genai/eval-monitor/scorers/custom.md)

[Build custom scorers →](/docs/3.10.0rc0/genai/eval-monitor/scorers/custom.md)

### [Evaluation Guide](/docs/3.10.0rc0/genai/eval-monitor/quickstart.md)

[Learn how to run comprehensive evaluations](/docs/3.10.0rc0/genai/eval-monitor/quickstart.md)
