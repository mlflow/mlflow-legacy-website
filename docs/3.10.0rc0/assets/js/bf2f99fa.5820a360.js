...
print(answer)`})}),(0,n.jsx)(i.A,{value:"typescript",label:"TypeScript",children:(0,n.jsx)(f.A,{language:"typescript",children:`import { init, trace, SpanType } from "mlflow-tracing";
import { tracedOpenAI } from "mlflow-openai";
import { OpenAI } from "openai";
...
for chunk in stream:
    if chunk.choices[0].delta.content:
        print(chunk.choices[0].delta.content, end="")`})}),(0,n.jsx)(i.A,{value:"typescript",label:"TypeScript",children:(0,n.jsx)(f.A,{language:"typescript",children:`import { init } from "mlflow-tracing";
import { tracedOpenAI } from "mlflow-openai";
import { OpenAI } from "openai";
