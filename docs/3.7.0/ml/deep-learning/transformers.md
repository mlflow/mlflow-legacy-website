...
[Learn how to fine-tune a transformers model using MLflow to keep track of the training process and to log a use-case-specific tuned pipeline.](/docs/3.7.0/ml/deep-learning/transformers/tutorials/fine-tuning/transformers-fine-tuning.md)
...
[Learn how to leverage the Whisper Model with MLflow to generate accurate audio transcriptions.](/docs/3.7.0/ml/deep-learning/transformers/tutorials/audio-transcription/whisper.md)

[Translation with Transformers](/docs/3.7.0/ml/deep-learning/transformers/tutorials/translation/component-translation.md)

[Learn about the options for saving and loading transformers models in MLflow for customization of your workflows with a fun translation example!](/docs/3.7.0/ml/deep-learning/transformers/tutorials/translation/component-translation.md)

[Chat with Transformers](/docs/3.7.0/ml/deep-learning/transformers/tutorials/conversational/conversational-model.md)

[Learn the basics of stateful chat Conversational Pipelines with Transformers and MLflow.](/docs/3.7.0/ml/deep-learning/transformers/tutorials/conversational/conversational-model.md)
...
[Learn how to build an OpenAI-compatible chatbot using a local Transformers model and MLflow, and serve it with minimal configuration.](/docs/3.7.0/ml/deep-learning/transformers/tutorials/conversational/pyfunc-chat-model.md)
