...
![Transformers Pipeline Architecture](/docs/3.7.0/assets/images/transformers-pipeline-architecture-7a4ac0c60f92b89ff3b0252c1789fe59.png)
...
* **Prompt Management**: [Save prompt templates](/docs/3.7.0/ml/deep-learning/transformers/guide.md#saving-prompt-templates-with-transformer-pipelines) with transformers pipelines to optimize inference with less boilerplate.
...
![Fine-tuning a Transformers Model with MLflow](/docs/3.7.0/assets/images/transformers-fine-tuning-546c747f338376a20679ae21511fc07e.png)
...
[Quickstart: Text Generation with Transformers](/docs/3.7.0/ml/deep-learning/transformers/tutorials/text-generation/text-generation.md)

[Learn how to leverage the transformers integration with MLflow in this **introductory quickstart**.](/docs/3.7.0/ml/deep-learning/transformers/tutorials/text-generation/text-generation.md)
...
[Fine tuning a transformers Foundation Model](/docs/3.7.0/ml/deep-learning/transformers/tutorials/fine-tuning/transformers-fine-tuning.md)

[Learn how to fine-tune a transformers model using MLflow to keep track of the training process and to log a use-case-specific tuned pipeline.](/docs/3.7.0/ml/deep-learning/transformers/tutorials/fine-tuning/transformers-fine-tuning.md)[](/docs/3.7.0/ml/deep-learning/transformers/tutorials/fine-tuning/transformers-peft.md)

[Fine tuning LLMs efficiently using PEFT and MLflow](/docs/3.7.0/ml/deep-learning/transformers/tutorials/fine-tuning/transformers-peft.md)

[](/docs/3.7.0/ml/deep-learning/transformers/tutorials/fine-tuning/transformers-peft.md)

[Learn how to fine-tune a large foundational models with significantly reduced memory usage using PEFT (QLoRA) and MLflow.](/docs/3.7.0/ml/deep-learning/transformers/tutorials/fine-tuning/transformers-peft.md)
...
[Audio Transcription with Transformers](/docs/3.7.0/ml/deep-learning/transformers/tutorials/audio-transcription/whisper.md)

[Learn how to leverage the Whisper Model with MLflow to generate accurate audio transcriptions.](/docs/3.7.0/ml/deep-learning/transformers/tutorials/audio-transcription/whisper.md)[](/docs/3.7.0/ml/deep-learning/transformers/tutorials/translation/component-translation.md)

[Translation with Transformers](/docs/3.7.0/ml/deep-learning/transformers/tutorials/translation/component-translation.md)

[](/docs/3.7.0/ml/deep-learning/transformers/tutorials/translation/component-translation.md)

[Learn about the options for saving and loading transformers models in MLflow for customization of your workflows with a fun translation example!](/docs/3.7.0/ml/deep-learning/transformers/tutorials/translation/component-translation.md)[](/docs/3.7.0/ml/deep-learning/transformers/tutorials/conversational/conversational-model.md)

[Chat with Transformers](/docs/3.7.0/ml/deep-learning/transformers/tutorials/conversational/conversational-model.md)

[](/docs/3.7.0/ml/deep-learning/transformers/tutorials/conversational/conversational-model.md)

[Learn the basics of stateful chat Conversational Pipelines with Transformers and MLflow.](/docs/3.7.0/ml/deep-learning/transformers/tutorials/conversational/conversational-model.md)[](/docs/3.7.0/ml/deep-learning/transformers/tutorials/conversational/pyfunc-chat-model.md)

[Building and Serving an OpenAI-Compatible Chatbot](/docs/3.7.0/ml/deep-learning/transformers/tutorials/conversational/pyfunc-chat-model.md)

[](/docs/3.7.0/ml/deep-learning/transformers/tutorials/conversational/pyfunc-chat-model.md)

[Learn how to build an OpenAI-compatible chatbot using a local Transformers model and MLflow, and serve it with minimal configuration.](/docs/3.7.0/ml/deep-learning/transformers/tutorials/conversational/pyfunc-chat-model.md)[](/docs/3.7.0/ml/deep-learning/transformers/tutorials/prompt-templating/prompt-templating.md)

[Prompt templating with Transformers Pipelines](/docs/3.7.0/ml/deep-learning/transformers/tutorials/prompt-templating/prompt-templating.md)

[](/docs/3.7.0/ml/deep-learning/transformers/tutorials/prompt-templating/prompt-templating.md)

[Learn how to set prompt templates on Transformers Pipelines to optimize your LLM's outputs, and simplify the end-user experience.](/docs/3.7.0/ml/deep-learning/transformers/tutorials/prompt-templating/prompt-templating.md)
...
In MLflow Transformers flavor, `task` plays a crucial role in determining the input and output format of the model. Please refer to the [Tasks in MLflow Transformers](/docs/3.7.0/ml/deep-learning/transformers/task.md) guide on how to use the native Transformers task types, and leverage the advanced tasks such as `llm/v1/chat` and `llm/v1/completions` for OpenAI-compatible inference.

## [Detailed Documentation](/docs/3.7.0/ml/deep-learning/transformers/guide.md)[​](#detailed-documentation "Direct link to detailed-documentation")

To learn more about the nuances of the *transformers* flavor in MLflow, delve into [the comprehensive guide](/docs/3.7.0/ml/deep-learning/transformers/guide.md), which covers:

* [Pipelines vs. Component Logging](/docs/3.7.0/ml/deep-learning/transformers/guide.md#pipelines-vs-component-logging): Explore the different approaches for saving model components or complete pipelines and understand the nuances of loading these models for various use cases.
...
* [Prompt Template](/docs/3.7.0/ml/deep-learning/transformers/guide.md#saving-prompt-templates-with-transformer-pipelines): Learn how to save a prompt template with transformers pipelines to optimize inference with less boilerplate.
* [Model Config and Model Signature Params for Inference](/docs/3.7.0/ml/deep-learning/transformers/guide.md#using-model-config-and-model-signature-params-for-inference): Learn how to leverage `model_config` and `ModelSignature` for flexible and customized model loading and inference.
* [Automatic Metadata and ModelCard Logging](/docs/3.7.0/ml/deep-learning/transformers/guide.md#automatic-metadata-and-modelcard-logging): Discover the automatic logging features for model cards and other metadata, enhancing model documentation and transparency.
* [Model Signature Inference](/docs/3.7.0/ml/deep-learning/transformers/guide.md#automatic-signature-inference) : Learn about MLflow's capability within the `transformers` flavor to automatically infer and attach model signatures, facilitating easier model deployment.
* [Overriding Pytorch dtype](/docs/3.7.0/ml/deep-learning/transformers/guide.md#scalability-for-inference) : Gain insights into optimizing `transformers` models for inference, focusing on memory optimization and data type configurations.
* [Input Data Types for Audio Pipelines](/docs/3.7.0/ml/deep-learning/transformers/guide.md#input-data-types-for-audio-pipelines): Understand the specific requirements for handling audio data in transformers pipelines, including the handling of different input types like str, bytes, and np.ndarray.
