...
MLflow provides native support for spaCy models through the [`mlflow.spacy.log_model()`](/docs/3.7.0/api_reference/python_api/mlflow.spacy.html#mlflow.spacy.log_model) function:
