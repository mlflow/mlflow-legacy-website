...
![Deep Learning Training](/docs/3.7.0/images/deep-learning/dl-training-ui.gif)
...
You can customize system metrics collection frequency and behavior. See the **[System Metrics documentation](/docs/3.7.0/ml/tracking/system-metrics.md)** for detailed configuration options.
...
[Version and manage PyTorch models](/docs/3.7.0/ml/model-registry.md)
