...
* 🛠️ **Advanced Customization**: When you need more control, use the [`mlflow.keras.callback.MlflowCallback()`](/docs/3.7.0/api_reference/python_api/mlflow.keras.html#mlflow.keras.callback.MlflowCallback) API for specialized logging requirements
...
[Get Started with Keras 3.0 + MLflow](/docs/3.7.0/ml/deep-learning/keras/quickstart/quickstart-keras.md)

[Master the fundamentals through a hands-on MNIST tutorial covering automatic logging, custom callbacks, multi-backend experimentation, and advanced tracking techniques.](/docs/3.7.0/ml/deep-learning/keras/quickstart/quickstart-keras.md)
...
[View the Comprehensive Guide](/docs/3.7.0/ml/deep-learning/keras/guide.md)
