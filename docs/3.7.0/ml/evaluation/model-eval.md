...
For GenAI/LLM custom evaluation metrics, use the [@scorer decorator](/docs/3.7.0/genai/eval-monitor/scorers/custom.md) instead.
...
More information on model validation behavior and outputs can be found in the [`mlflow.validate_evaluation_results()`](/docs/3.7.0/api_reference/python_api/mlflow.html#mlflow.validate_evaluation_results) API documentation.
