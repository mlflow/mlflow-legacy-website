...
### [Setting Up the MLflow AI Gateway](/docs/3.7.0/genai/governance/ai-gateway/guides/step1-create-deployments.md)

[Install dependencies, configure providers, and launch your gateway server](/docs/3.7.0/genai/governance/ai-gateway/guides/step1-create-deployments.md)

[Setup guide →](/docs/3.7.0/genai/governance/ai-gateway/guides/step1-create-deployments.md)

### [Querying the MLflow AI Gateway](/docs/3.7.0/genai/governance/ai-gateway/guides/step2-query-deployments.md)

[Interact with endpoints using Python client APIs and REST requests](/docs/3.7.0/genai/governance/ai-gateway/guides/step2-query-deployments.md)

[Query guide →](/docs/3.7.0/genai/governance/ai-gateway/guides/step2-query-deployments.md)
