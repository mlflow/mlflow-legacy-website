...
### [Observability with Tracing](/docs/3.7.0/genai/tracing/quickstart/python-openai.md)

[Auto-instrument your GenAI application to capture every LLM call, prompt, and tool interaction for complete visibility](/docs/3.7.0/genai/tracing/quickstart/python-openai.md)

[Learn tracing →](/docs/3.7.0/genai/tracing/quickstart/python-openai.md)
