...
To use the prompt engineering UI, you need to create one or more [MLflow AI Gateway](/docs/3.7.0/genai/governance/ai-gateway.md) completions or chat endpoints. Follow the [MLflow AI Gateway Quickstart guide](/docs/3.7.0/genai/governance/ai-gateway/setup.md) to easily create an endpoint in less than five minutes. If you already have access to an MLflow AI Gateway endpoint of type `llm/v1/completions` or `llm/v1/chat`, you can skip this step.
