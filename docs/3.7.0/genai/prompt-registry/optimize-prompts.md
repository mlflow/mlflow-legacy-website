...
The example below shows how easy it is to optimize prompts in a LangChain workflow with minimal changes. Note that we call [`PromptVersion.to_single_brace_format()`](/docs/3.7.0/api_reference/python_api/mlflow.entities.html#mlflow.entities.model_registry.PromptVersion.to_single_brace_format) instead of [`PromptVersion.format()`](/docs/3.7.0/api_reference/python_api/mlflow.entities.html#mlflow.entities.model_registry.PromptVersion.format) inside `predict_fn`.
