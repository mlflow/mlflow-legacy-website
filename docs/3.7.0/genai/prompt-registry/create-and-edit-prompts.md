...
To create a new prompt programmatically, use the [`mlflow.genai.register_prompt()`](/docs/3.7.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.register_prompt) function. This is particularly useful for automating prompt creation or managing prompts as part of a larger script.
...
To create a new version of an existing prompt, you again use the [`mlflow.genai.register_prompt()`](/docs/3.7.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.register_prompt) function, but this time, you provide the `name` of an existing prompt. MLflow will automatically increment the version number.
...
![Compare Prompt Versions](/docs/3.7.0/assets/images/compare-prompt-versions-2082121aeaca4be99a0cf968535141ed.png)
