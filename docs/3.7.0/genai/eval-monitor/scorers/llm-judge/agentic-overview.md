...
![](/docs/3.7.0/assets/images/llm-judge-vs-agent-judge-64ca5835fdfc045c406055ab2510218a.png)
...
![Agent-as-a-Judge Evaluation Results](/docs/3.7.0/images/mlflow-3/eval-monitor/scorers/agentic-judge-result.png)
...
To apply the scorer to a batch of traces, use the [mlflow.genai.evaluate](/docs/3.7.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.evaluate) API.
