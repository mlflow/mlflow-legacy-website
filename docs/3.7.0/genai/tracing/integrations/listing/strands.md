...
![Agno Tracing via autolog](/docs/3.7.0/images/llms/strands/strands-tracing.png)
...
[MLflow Tracing](/docs/3.7.0/genai/tracing/integrations.md) provides automatic tracing capability for Strands Agents SDK. By enabling auto tracing for Strands Agents SDK by calling the [`mlflow.strands.autolog()`](/docs/3.7.0/api_reference/python_api/mlflow.strands.html#mlflow.strands.autolog) function, MLflow will capture traces for Agent invocation and log them to the active MLflow Experiment.
...
![Strands Agent SDK Tracing via autolog](/docs/3.7.0/assets/images/strands-tracing-d93b7aa1a7acb19402282286c1b02843.png)
