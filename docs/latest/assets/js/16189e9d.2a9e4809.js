...
print(df.shape)
df.head()`}),"\n",(0,l.jsx)(a.p,{children:"(15000, 5)"}),"\n",(0,l.jsx)(i.Q,{children:(0,l.jsx)("div",{dangerouslySetInnerHTML:{__html:`<div>
<style scoped>
...
<tbody>
  ...
  with mlflow.start_run():
      ...
      mlflow.set_tag("dow", dow)`}),"\n",(0,l.jsx)(a.p,{isStderr:!0,children:`Successfully registered model 'DOW_model_4'.
...
print(mme_tuesday_fitted_values)`}),"\n",(0,l.jsx)(a.p,{children:`Model URIs:
...
[-0.8571552   0.61833952  0.61625155  0.28999143  0.49778144]`}),"\n",(0,l.jsx)(t.h4,{id:"23---register-our-custom-pyfunc-model",children:"2.3 - Register our Custom PyFunc Model"}),"\n",(0,l.jsx)(n.d,{executionCount:10,children:`with mlflow.start_run():
  ...
  mlflow.log_param("num_models", len(model.models))`}),"\n",(0,l.jsx)(a.p,{children:`inputs: 
['x1': double (required), 'x2': double (required), 'x3': double (required)]
outputs: 
[Tensor('float64', (-1,))]
params: 
['dow': long (default: 1)]`}),"\n",(0,l.jsx)(a.p,{isStderr:!0,children:`Successfully registered model 'MME_DOW_model'.
...
)`}),"\n",(0,l.jsx)(a.p,{children:`Run the below command in a new window. You must be in the same repo as your mlruns directory and have mlflow installed...
