"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([["2905"],{11899:function(e,t,o){o.r(t),o.d(t,{metadata:()=>d,default:()=>f,frontMatter:()=>m,contentTitle:()=>u,toc:()=>h,assets:()=>c});var d=JSON.parse('{"id":"traditional-ml/tutorials/serving-multiple-models-with-pyfunc/notebooks/MME_Tutorial-ipynb","title":"Deploy an MLflow PyFunc model with Model Serving","description":"Download this notebook","source":"@site/docs/classic-ml/traditional-ml/tutorials/serving-multiple-models-with-pyfunc/notebooks/MME_Tutorial-ipynb.mdx","sourceDirName":"traditional-ml/tutorials/serving-multiple-models-with-pyfunc/notebooks","slug":"/traditional-ml/tutorials/serving-multiple-models-with-pyfunc/notebooks/MME_Tutorial","permalink":"/docs/3.11.1.dev0/ml/traditional-ml/tutorials/serving-multiple-models-with-pyfunc/notebooks/MME_Tutorial","draft":false,"unlisted":false,"editUrl":"https://github.com/mlflow/mlflow/edit/master/docs/docs/classic-ml/traditional-ml/tutorials/serving-multiple-models-with-pyfunc/notebooks/MME_Tutorial.ipynb","tags":[],"version":"current","frontMatter":{"custom_edit_url":"https://github.com/mlflow/mlflow/edit/master/docs/docs/classic-ml/traditional-ml/tutorials/serving-multiple-models-with-pyfunc/notebooks/MME_Tutorial.ipynb","slug":"MME_Tutorial"},"sidebar":"classicMLSidebar","previous":{"title":"Serving Multiple Models on a Single Endpoint with a Custom PyFunc Model","permalink":"/docs/3.11.1.dev0/ml/traditional-ml/tutorials/serving-multiple-models-with-pyfunc/"},"next":{"title":"Scikit-learn","permalink":"/docs/3.11.1.dev0/ml/traditional-ml/sklearn/"}}'),l=o(74848),n=o(28453),r=o(75940),i=o(75453),a=o(66354),s=o(42676);let m={custom_edit_url:"https://github.com/mlflow/mlflow/edit/master/docs/docs/classic-ml/traditional-ml/tutorials/serving-multiple-models-with-pyfunc/notebooks/MME_Tutorial.ipynb",slug:"MME_Tutorial"},u="Deploy an MLflow PyFunc model with Model Serving",c={},h=[{value:"Install and import libraries",id:"install-and-import-libraries",level:2},{value:"1 - Create Some Sample Models",id:"1---create-some-sample-models",level:2},{value:"1.1 - Create Dummy Data",id:"11---create-dummy-data",level:4},{value:"1.2 - Train Models for Each Day of the Week",id:"12---train-models-for-each-day-of-the-week",level:4},{value:"1.3 - Test inference on our DOW models",id:"13---test-inference-on-our-dow-models",level:4},{value:"2 - Create an MME Custom PyFunc Model",id:"2---create-an-mme-custom-pyfunc-model",level:2},{value:"2.1 - Create a Child Implementation of <code>mlflow.pyfunc.PythonModel</code>",id:"21---create-a-child-implementation-of-mlflowpyfuncpythonmodel",level:4},{value:"2.2 - Test our Implementation",id:"22---test-our-implementation",level:4},{value:"2.3 - Register our Custom PyFunc Model",id:"23---register-our-custom-pyfunc-model",level:4},{value:"3 - Serve our Model",id:"3---serve-our-model",level:2},{value:"4 - Query our Served Model",id:"4---query-our-served-model",level:2}];function p(e){let t={code:"code",h1:"h1",h2:"h2",h4:"h4",header:"header",li:"li",ol:"ol",p:"p",...(0,n.R)(),...e.components};return(0,l.jsxs)(l.Fragment,{children:[(0,l.jsx)(t.header,{children:(0,l.jsxs)(t.h1,{id:"deploy-an-mlflow-pyfunc-model-with-model-serving",children:["Deploy an MLflow ",(0,l.jsx)(t.code,{children:"PyFunc"})," model with Model Serving"]})}),"\n",(0,l.jsx)(s.O,{href:"https://raw.githubusercontent.com/mlflow/mlflow/master/docs/docs/classic-ml/traditional-ml/tutorials/serving-multiple-models-with-pyfunc/notebooks/MME_Tutorial.ipynb",children:"Download this notebook"}),"\n",(0,l.jsx)(t.p,{children:"In this notebook, learn how to deploy a custom MLflow PyFunc model to a serving endpoint. MLflow pyfunc offers greater flexibility and customization to your deployment. You can run any custom model, add preprocessing or post-processing logic, or execute any arbitrary Python code. While using the MLflow built-in flavor is recommended for optimal performance, you can use MLflow PyFunc models where more customization is required."}),"\n",(0,l.jsx)(t.h2,{id:"install-and-import-libraries",children:"Install and import libraries"}),"\n",(0,l.jsx)(r.d,{executionCount:13,children:"%pip install --upgrade mlflow scikit-learn -q"}),"\n",(0,l.jsx)(i.p,{isStderr:!0,children:"213.32s - pydevd: Sending message related to process being replaced timed-out after 5 seconds"}),"\n",(0,l.jsx)(r.d,{executionCount:2,children:`import json
import warnings
...
print(df.shape)
df.head()`}),"\n",(0,l.jsx)(i.p,{children:"(15000, 5)"}),"\n",(0,l.jsx)(a.Q,{children:(0,l.jsx)("div",{dangerouslySetInnerHTML:{__html:`<div>
<style scoped>
...
</div>`}})}),"\n",(0,l.jsx)(r.d,{executionCount:9,children:`# Instantiate our DOW MME
...
{'predictions': [-0.8571551951905747, 0.618339524354309, 0.6162515496343108, 0.2899914313294642, 0.4977814353066934]}`})]})}function f(e={}){let{wrapper:t}={...(0,n.R)(),...e.components};return t?(0,l.jsx)(t,{...e,children:(0,l.jsx)(p,{...e})}):p(e)}},75453:function(e,t,o){o.d(t,{p:()=>l});var d=o(74848);let l=({children:e,isStderr:t})=>(0,d.jsx)("pre",{style:{margin:0,borderRadius:0,background:"none",fontSize:"0.85rem",flexGrow:1,padding:"var(--padding-sm)"},children:e})},75940:function(e,t,o){o.d(t,{d:()=>n});var d=o(74848),l=o(37449);let n=({children:e,executionCount:t})=>(0,d.jsx)("div",{style:{flexGrow:1,minWidth:0,marginTop:"var(--padding-md)",width:"100%"},children:(0,d.jsx)(l.A,{className:"codeBlock_oJcR",language:"python",children:e})})},42676:function(e,t,o){o.d(t,{O:()=>r});var d=o(74848),l=o(96540);let n="3.11.1.dev0";function r({children:e,href:t}){let o=(0,l.useCallback)(async e=>{if(e.preventDefault(),window.gtag)try{window.gtag("event","notebook-download",{href:t})}catch{}n.includes("dev")||(t=t.replace(/\/master\//,`/v${n}/`));let o=await fetch(t),d=await o.blob(),l=window.URL.createObjectURL(d),r=document.createElement("a");r.style.display="none",r.href=l,r.download=t.split("/").pop(),document.body.appendChild(r),r.click(),window.URL.revokeObjectURL(l),document.body.removeChild(r)},[t]);return(0,d.jsx)("a",{className:"button button--primary",style:{marginBottom:"1rem",display:"block",width:"min-content"},href:t,download:!0,onClick:o,children:e})}},66354:function(e,t,o){o.d(t,{Q:()=>l});var d=o(74848);let l=({children:e})=>(0,d.jsx)("div",{style:{flexGrow:1,minWidth:0,fontSize:"0.8rem",width:"100%"},children:e})},52915:function(e,t,o){o.d(t,{A:()=>u});var d=o(74848);o(96540);var l=o(34164),n=o(71643),r=o(66697),i=o(92949),a=o(64560),s=o(35062);function m({language:e}){return(0,d.jsxs)("div",{className:(0,l.A)("codeBlockHeader_C_1e"),"aria-label":`Code block header for ${e} code with copy and toggle buttons`,children:[(0,d.jsx)("span",{className:"languageLabel_zr_I",children:e}),(0,d.jsx)(s.A,{})]})}function u({className:e}){let{metadata:t}=(0,n.Ph)(),o=t.language||"text";return(0,d.jsxs)(r.A,{as:"div",className:(0,l.A)(e,t.className),children:[t.title&&(0,d.jsx)("div",{className:"codeBlockTitle_d3dP",children:(0,d.jsx)(i.A,{children:t.title})}),(0,d.jsxs)("div",{className:"codeBlockContent_bxn0",children:[(0,d.jsx)(m,{language:o}),(0,d.jsx)(a.A,{})]})]})}}}]);