...
client = OpenAI(
    base_url="${t.baseUrl}",
    api_key="${t.apiKeyPlaceholder}",${v?function(e,t){let a=Object.entries(e);if(0===a.length)return"";let n=a.map(([e,a])=>{let n=t?`  # ${t}`:"";return`        "${e}": "${a}",${n}`});return`
    default_headers={
${n.join("\n")}
    },`}(x,t.headerComment):""}
)
...
const client = tracedOpenAI(
  new OpenAI({
    baseURL: "${t.baseUrl}",
    apiKey: "${t.apiKeyPlaceholder}",${j?function(e,t){let a=Object.entries(e);if(0===a.length)return"";let n=a.map(([e,a])=>{let n=t?` // ${t}`:"";return`      "${e}": "${a}",${n}`});return`
    defaultHeaders: {
${n.join("\n")}
    },`}(I,t.headerComment):""}
  })
...
}`})})]})}),(0,n.jsx)("p",{children:"MLflow will automatically capture the complete streamed response in the trace."}),(0,n.jsx)("h2",{children:"Next Steps"}),(0,n.jsxs)(l.A,{children:[(0,n.jsx)(s.A,{icon:u.A,iconSize:48,title:"Track User Feedback",description:"Record user feedback on traces for tracking user satisfaction.",href:"/genai/tracing/collect-user-feedback",linkText:"Learn about feedback \u2192",containerHeight:64}),(0,n.jsx)(s.A,{icon:m.A,iconSize:48,title:"Manage Prompts",description:"Learn how to manage prompts with MLflow's prompt registry.",href:"/genai/prompt-registry",linkText:"Manage prompts \u2192",containerHeight:64}),(0,n.jsx)(s.A,{icon:g.A,iconSize:48,title:"Evaluate Traces",description:"Evaluate traces with LLM judges to understand and improve your AI application's behavior.",href:"/genai/eval-monitor/running-evaluation/traces",linkText:"Evaluate traces \u2192",containerHeight:64})]})]})}},89001:function(e,t,a){a.d(t,{A:()=>i});var n=a(74848);a(96540);let i=({number:e,title:t})=>(0,n.jsxs)("div",{className:"stepHeader_RqmM",children:[(0,n.jsx)("div",{className:"stepNumber_exmH",children:e}),(0,n.jsx)("h3",{className:"stepTitle_SzBx",children:t})]})},95986:function(e,t,a){a.d(t,{A:()=>i});var n=a(74848);a(96540);function i({children:e}){return(0,n.jsx)("div",{className:"wrapper_sf5q",children:e})}},77541:function(e,t,a){a.d(t,{A:()=>c});var n=a(74848);a(96540);var i=a(95310),r=a(34164);let o="tileImage_O4So";var l=a(66497),s=a(92802);function c({icon:e,image:t,imageDark:a,imageWidth:c,imageHeight:p,iconSize:d=32,containerHeight:h,title:u,description:m,href:g,linkText:f="Learn more \u2192",className:y}){if(!e&&!t)throw Error("TileCard requires either an icon or image prop");let w=h?{height:`${h}px`}:{},A={};return c&&(A.width=`${c}px`),p&&(A.height=`${p}px`),(0,n.jsxs)(i.A,{href:g,className:(0,r.A)("tileCard_NHsj",y),children:[(0,n.jsx)("div",{className:"tileIcon_pyoR",style:w,children:e?(0,n.jsx)(e,{size:d}):a?(0,n.jsx)(s.A,{sources:{light:(0,l.default)(t),dark:(0,l.default)(a)},alt:u,className:o,style:A}):(0,n.jsx)("img",{src:(0,l.default)(t),alt:u,className:o,style:A})}),(0,n.jsx)("h3",{children:u}),(0,n.jsx)("p",{children:m}),(0,n.jsx)("div",{className:"tileLink_iUbu",children:f})]})}},10440:function(e,t,a){a.d(t,{A:()=>r});var n=a(74848);a(96540);var i=a(34164);function r({children:e,className:t}){return(0,n.jsx)("div",{className:(0,i.A)("tilesGrid_hB9N",t),children:e})}},52915:function(e,t,a){a.d(t,{A:()=>d});var n=a(74848);a(96540);var i=a(34164),r=a(71643),o=a(66697),l=a(92949),s=a(64560),c=a(35062);function p({language:e}){return(0,n.jsxs)("div",{className:(0,i.A)("codeBlockHeader_C_1e"),"aria-label":`Code block header for ${e} code with copy and toggle buttons`,children:[(0,n.jsx)("span",{className:"languageLabel_zr_I",children:e}),(0,n.jsx)(c.A,{})]})}function d({className:e}){let{metadata:t}=(0,r.Ph)(),a=t.language||"text";return(0,n.jsxs)(o.A,{as:"div",className:(0,i.A)(e,t.className),children:[t.title&&(0,n.jsx)("div",{className:"codeBlockTitle_d3dP",children:(0,n.jsx)(l.A,{children:t.title})}),(0,n.jsxs)("div",{className:"codeBlockContent_bxn0",children:[(0,n.jsx)(p,{language:a}),(0,n.jsx)(s.A,{})]})]})}}}]);