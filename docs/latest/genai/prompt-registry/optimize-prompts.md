...
* [Optimizing Prompts for LangChain](/docs/latest/genai/prompt-registry/optimize-prompts/langchain-optimization.md): Learn how to optimize LangChain chains with minimal code changes
* [Optimizing Prompts for LangGraph](/docs/latest/genai/prompt-registry/optimize-prompts/langgraph-optimization.md): Learn how to optimize LangGraph agents
* [Optimizing Prompts for OpenAI Agents](/docs/latest/genai/prompt-registry/optimize-prompts/openai-agent-optimization.md): Learn how to optimize OpenAI Agent prompts
