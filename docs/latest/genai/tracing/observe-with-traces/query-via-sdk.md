...
This guide shows you how to programmatically query traces using the MLflow SDK for debugging, monitoring, and analysis. While the [Search Traces](/docs/latest/genai/tracing/search-traces.md) guide covers comprehensive search functionality, this page focuses on practical SDK usage patterns for observability workflows. To learn more about detailed search syntax and filtering capabilities, see the [Search Traces](/docs/latest/genai/tracing/search-traces.md) guide.
...
The [`mlflow.search_traces()`](/docs/latest/api_reference/python_api/mlflow.html#mlflow.search_traces) function returns trace data in two formats:
...
**[MLflow Tracing UI](/docs/latest/genai/tracing/observe-with-traces/ui.md)**: Learn the web interface for interactive trace exploration

**[Search Traces](/docs/latest/genai/tracing/search-traces.md)**: Master advanced search and filtering techniques

**[Delete and Manage Traces](/docs/latest/genai/tracing/observe-with-traces/delete-traces.md)**: Understand trace lifecycle management
