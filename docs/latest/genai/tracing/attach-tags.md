...
The [`mlflow.update_current_trace()`](/docs/latest/api_reference/python_api/mlflow.html#mlflow.update_current_trace) function adds the specified tag(s) to the current trace when the key is not already present. If the key is already present, it updates the key with the new value.
...
| API                                                                                                                                               | Use Case                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- |
| [`mlflow.set_trace_tag()`](/docs/latest/api_reference/python_api/mlflow.html#mlflow.set_trace_tag)                                                | Fluent API for setting tags |
| [`mlflow.client.MlflowClient.set_trace_tag()`](/docs/latest/api_reference/python_api/mlflow.client.html#mlflow.client.MlflowClient.set_trace_tag) | Client API for setting tags |
