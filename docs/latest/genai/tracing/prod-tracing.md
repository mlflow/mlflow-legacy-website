...
The [MLflow Tracing SDK `mlflow-tracing`](/docs/latest/genai/tracing/lightweight-sdk.md) is a lightweight package that only includes the minimum set of dependencies to instrument your code/models/agents with MLflow Tracing.
...
Refer to the [tracking server setup guide](/docs/latest/ml/tracking.md#tracking-setup) for more details.
...
MLflow Traces can be exported to any OpenTelemetry-compatible backend. See the [OpenTelemetry Integration](/docs/latest/genai/tracing/opentelemetry/export.md) documentation for more details.
...
**[Debug & Observe Your App with Tracing](/docs/latest/genai/tracing/observe-with-traces.md)**: Learn foundational observability concepts and techniques

**[Query Traces via SDK](/docs/latest/genai/tracing/observe-with-traces/query-via-sdk.md)**: Understand how to programmatically access trace data for analysis

**[Track Users & Sessions](/docs/latest/genai/tracing/track-users-sessions.md)**: Implement user and session context tracking for better monitoring insights
