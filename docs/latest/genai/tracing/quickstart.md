...
1. **Search and Filter Traces** Learn how to find specific traces using the [search functionality](/docs/latest/genai/tracing/search-traces.md).

2. **Add Tags and Context** Organize your traces with [custom tags](/docs/latest/genai/tracing/attach-tags.md) for better monitoring.

3. **Production Deployment** Set up [production monitoring](/docs/latest/genai/tracing/prod-tracing.md) with the lightweight SDK.

4. **Integration with Other Libraries** Explore [automatic tracing](/docs/latest/genai/tracing/integrations.md) for LangChain, LlamaIndex, and more.

5. **Manual Instrumentation** Learn [manual tracing techniques](/docs/latest/genai/tracing/app-instrumentation/manual-tracing.md) for custom applications.
