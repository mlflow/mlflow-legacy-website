...
The Python quickstart is available [here](/docs/latest/genai/tracing/quickstart/python-openai.md).
...
If [authentication](/docs/latest/self-hosting/security/basic-http-auth.md) is enabled on the tracking server, you can pass the credential through `trackingServerUsername` and `trackingServerPassword`.
...
![Single Trace Detail](/docs/latest/images/llms/tracing/quickstart/single-openai-trace-detail.png)
...
![Tool Calling Trace](/docs/latest/images/llms/tracing/quickstart/openai-tool-calling-trace-detail.png)
...
![Tool Calling Trace Timeline](/docs/latest/images/llms/tracing/quickstart/openai-tool-calling-trace-timeline.png)
...
![Feedback Input Form](/docs/latest/images/llms/tracing/quickstart/openai-trace-feedback-input.png)

When you submit the form with "Create" button, the feedback will be attached to the trace.

![Feedback List](/docs/latest/images/llms/tracing/quickstart/openai-trace-feedback-record.png)
...
![Feedback Aggregated](/docs/latest/images/llms/tracing/quickstart/openai-trace-feedback-aggregate.png)
...
* [Typescript SDK Guide](/docs/latest/genai/tracing/app-instrumentation/typescript-sdk.md): Learn more about how to use the Typescript SDK.
* [Automatic Evaluation](/docs/latest/genai/eval-monitor.md): Learn how to set up automatic evaluation for traces using MLflow's GenAI evaluation feature.
