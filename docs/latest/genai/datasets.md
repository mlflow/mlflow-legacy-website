...
### [Evaluation Integration](/docs/latest/genai/eval-monitor.md)

[Learn how to use datasets with MLflow's evaluation framework](/docs/latest/genai/eval-monitor.md)
