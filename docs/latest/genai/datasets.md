...
![Evaluation Datasets Video](/docs/latest/images/eval-datasets.gif)
...
Source types are automatically inferred based on record characteristics but can be explicitly overridden when needed. See the [SDK Guide](/docs/latest/genai/datasets/sdk-guide.md#source-type-inference) for detailed inference rules and examples.
...
[Complete guide to creating and managing evaluation datasets programmatically](/docs/latest/genai/datasets/sdk-guide.md)
...
### [Tracing Guide](/docs/latest/genai/tracing.md)

[Capture detailed execution data from your GenAI applications](/docs/latest/genai/tracing.md)
