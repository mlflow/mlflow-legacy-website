...
The fastest way to create LLM judges is through the **Judge Builder UI** - no code required. Navigate to your experiment's **Judges** tab to create and test judges visually. See the [Template-based Scorers](/docs/latest/genai/eval-monitor/scorers/llm-judge/make-judge.md) page for details. Requires MLflow >= 3.9.0.
