...
See the [make\_judge documentation](/docs/latest/genai/eval-monitor/scorers/llm-judge/make-judge.md) for migration guidance.
...
MLflow supports all major LLM providers, such as OpenAI, Anthropic, Google, xAI, and more. See [Supported Models](/docs/latest/genai/eval-monitor/scorers/llm-judge.md#supported-models) for more details.
