...
| `trace`        | Trace is a special template variable which uses [agent-as-a-judge](/docs/latest/genai/eval-monitor/scorers/llm-judge/agentic-overview.md). The judge has access to all parts of the trace. |
