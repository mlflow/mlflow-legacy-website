...
* [Set Up MLflow Server](/docs/latest/genai/getting-started/connect-environment.md) — connect to a local or hosted MLflow instance
* [Start Tracing](/docs/latest/genai/tracing/quickstart.md) — instrument your LLM app and capture your first traces
* [Evaluate LLMs and Agents](/docs/latest/genai/eval-monitor/quickstart.md) — run systematic evaluations with LLM judges
