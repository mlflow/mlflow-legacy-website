...
### [Setting Up the MLflow AI Gateway](/docs/latest/genai/governance/ai-gateway/guides/step1-create-deployments.md)

[Install dependencies, configure providers, and launch your gateway server](/docs/latest/genai/governance/ai-gateway/guides/step1-create-deployments.md)

[Setup guide →](/docs/latest/genai/governance/ai-gateway/guides/step1-create-deployments.md)

### [Querying the MLflow AI Gateway](/docs/latest/genai/governance/ai-gateway/guides/step2-query-deployments.md)

[Interact with endpoints using Python client APIs and REST requests](/docs/latest/genai/governance/ai-gateway/guides/step2-query-deployments.md)

[Query guide →](/docs/latest/genai/governance/ai-gateway/guides/step2-query-deployments.md)
