...
Endpoints define how requests are routed to AI models. For advanced routing features like traffic splitting and fallbacks, see the [Advanced Routing](/docs/latest/genai/governance/ai-gateway/routing.md) guide.
