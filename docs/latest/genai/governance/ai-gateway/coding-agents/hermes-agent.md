...
![MLflow AI Gateway usage tracking for a Hermes endpoint, showing token usage, tokens per request, cost breakdown, and cost over time](/docs/latest/images/llms/hermes/hermes-agent-gateway-dashboard.png)

## Setup[​](#setup "Direct link to Setup")

### Prerequisites[​](#prerequisites "Direct link to Prerequisites")

* An MLflow tracking environment. See the [Connect Your Environment](/docs/latest/genai/getting-started/connect-environment.md) guide if you need to set one up.
...
![Create Guardrail dialog in the MLflow AI Gateway with Safety, PII Detection, and Custom Guardrail options](/docs/latest/images/llms/hermes/hermes-agent-gateway-guardrail.png)
...
[Monitor token usage and latency across Hermes sessions routed through the gateway](/docs/latest/genai/governance/ai-gateway/usage-tracking.md)
...
[Apply centralized guardrails to the model calls Hermes makes through the gateway](/docs/latest/genai/governance/ai-gateway/guardrails.md)
...
[Set spending limits for long-running Hermes workloads before they run away](/docs/latest/genai/governance/ai-gateway/budget-alerts-limits.md)
...
To capture those, follow the [Tracing Hermes Agent](/docs/latest/genai/tracing/integrations/listing/hermes_agent.md) guide for the full setup.

![Hermes Agent tool-calling trace in the MLflow UI](/docs/latest/images/llms/hermes/hermes-agent-trace-detail.png)
