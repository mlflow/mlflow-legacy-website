...
For new deployments, we recommend using the [Gateway Guide](/docs/latest/genai/governance/ai-gateway/setup.md) which provides a modern web interface for managing endpoints, API keys, and routing configurations with zero-downtime updates.
