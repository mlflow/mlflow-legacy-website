...
If your `server.json` is hosted at a URL or stored as a local file, use [`mlflow.genai.register_mcp_server_from_url()`](/docs/latest/api_reference/python_api/mlflow.genai.html#mlflow.genai.register_mcp_server_from_url):
...
![Register MCP Server UI](/docs/latest/assets/images/register-mcp-server-ui-867e86cdd8569d4f17293586dda577e3.png)
