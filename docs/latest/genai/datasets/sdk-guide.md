...
Start by creating a new evaluation dataset with meaningful metadata using the [`mlflow.genai.datasets.create_dataset()`](/docs/latest/api_reference/python_api/mlflow.genai.html#mlflow.genai.datasets.create_dataset) API:
...
[Learn how to define expectations →](/docs/latest/genai/assessments/expectations.md) Expectations are the ground truth values that define what your AI should produce. They're added by SMEs who review outputs and establish quality standards.
...
As you discover edge cases and improve your understanding, continuously update your dataset. The [`mlflow.entities.EvaluationDataset.merge_records()`](/docs/latest/api_reference/python_api/mlflow.entities.html#mlflow.entities.EvaluationDataset.merge_records) method intelligently handles both new records and updates to existing ones:
...
Use tags to track dataset evolution and enable powerful searches. Learn more about [`mlflow.search_traces()`](/docs/latest/api_reference/python_api/mlflow.html#mlflow.search_traces) to build your datasets from production data:
...
Find datasets using powerful search capabilities with [`mlflow.genai.datasets.search_datasets()`](/docs/latest/api_reference/python_api/mlflow.genai.html#mlflow.genai.datasets.search_datasets):
...
Datasets can be dynamically associated with experiments after creation using [`mlflow.genai.datasets.add_dataset_to_experiments()`](/docs/latest/api_reference/python_api/mlflow.genai.html#mlflow.genai.datasets.add_dataset_to_experiments) and [`mlflow.genai.datasets.remove_dataset_from_experiments()`](/docs/latest/api_reference/python_api/mlflow.genai.html#mlflow.genai.datasets.remove_dataset_from_experiments).
...
[Use your datasets to systematically evaluate and improve your GenAI applications](/docs/latest/genai/eval-monitor.md)
...
### [Capture Traces](/docs/latest/genai/tracing.md)

[Instrument your applications to capture production data for building datasets](/docs/latest/genai/tracing.md)

[Enable tracing →](/docs/latest/genai/tracing.md)
