...
For detailed API usage, see the [SDK Guide](/docs/latest/genai/datasets/sdk-guide.md).
...
See the [SDK Guide](/docs/latest/genai/datasets/sdk-guide.md#step-4-organize-with-tags) for detailed API usage.

## Next Steps[​](#next-steps "Direct link to Next Steps")

### [SDK Guide](/docs/latest/genai/datasets/sdk-guide.md)

[Complete reference for creating and managing evaluation datasets](/docs/latest/genai/datasets/sdk-guide.md)

[View SDK guide →](/docs/latest/genai/datasets/sdk-guide.md)

### [Expectations](/docs/latest/genai/concepts/expectations.md)

[Learn how to define ground truth for your test cases](/docs/latest/genai/concepts/expectations.md)

[Understand expectations →](/docs/latest/genai/concepts/expectations.md)

### [Evaluation Framework](/docs/latest/genai/eval-monitor.md)

[Use datasets with MLflow's evaluation capabilities](/docs/latest/genai/eval-monitor.md)

[Explore evaluation →](/docs/latest/genai/eval-monitor.md)
