...
![MLflow OpenAI tutorials](/docs/latest/assets/images/openai-tutorials-explanation-b678f6281a071c316e351bc6c89eeb21.png)
...
[OpenAI Quickstart](/docs/latest/genai/flavors/openai/notebooks/openai-quickstart.md)

[Learn the very basics of using the OpenAI package with MLflow with some simple prompt engineering and a fun use case to get started with this powerful integration.](/docs/latest/genai/flavors/openai/notebooks/openai-quickstart.md)
