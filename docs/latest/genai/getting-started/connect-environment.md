...
Creating a Databricks Notebook will create an MLflow Experiment that is the container for your GenAI application. Learn more about Experiments in the [MLflow documentation](/docs/latest/ml/tracking.md).
...
* **Instrument your app with tracing**: Follow the [quickstart](/docs/latest/genai/tracing/quickstart/python-openai.md) to instrument your first GenAI app
