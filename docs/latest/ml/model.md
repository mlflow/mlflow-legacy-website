...
The `diviner` model flavor enables logging of [diviner models](https://databricks-diviner.readthedocs.io/en/latest/index.html) in MLflow format via the [`mlflow.diviner.save_model()`](/docs/latest/api_reference/python_api/mlflow.diviner.html#mlflow.diviner.save_model) and [`mlflow.diviner.log_model()`](/docs/latest/api_reference/python_api/mlflow.diviner.html#mlflow.diviner.log_model) methods. These methods also add the `python_function` flavor to the MLflow Models that they produce, allowing the model to be interpreted as generic Python functions for inference via [`mlflow.pyfunc.load_model()`](/docs/latest/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.load_model). This loaded PyFunc model can only be scored with a DataFrame input. You can also use the [`mlflow.diviner.load_model()`](/docs/latest/api_reference/python_api/mlflow.diviner.html#mlflow.diviner.load_model) method to load MLflow Models with the `diviner` model flavor in native diviner formats.
...
* Writing the DataFrames to local storage and using [`mlflow.log_artifacts()`](/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_artifacts)
...
* Writing directly as a JSON artifact using [`mlflow.log_dict()`](/docs/latest/api_reference/python_api/mlflow.html#mlflow.log_dict)
