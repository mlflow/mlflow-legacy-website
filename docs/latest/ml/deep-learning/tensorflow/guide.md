...
You can customize autologging behavior by passing arguments to [`mlflow.tensorflow.autolog()`](/docs/latest/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.autolog):
...
MLflow provides [`mlflow.tensorflow.MlflowCallback`](/docs/latest/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.MlflowCallback) that offers the same functionality as autologging but with more explicit control:
...
If you haven't enabled autologging (which saves models automatically), you can manually save your TensorFlow model using [`mlflow.tensorflow.log_model()`](/docs/latest/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.log_model):
...
![TensorFlow Model Signature](/docs/latest/assets/images/tensorflow-model-signature-b99a17dca0d6d45fc0e0663f41824bf1.png)
