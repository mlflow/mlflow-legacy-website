...
The `--backend-store-uri` option is not mandatory, but highly recommended for better performance and reliability. Check out [Backend Store](/docs/latest/self-hosting/architecture/backend-store.md).
