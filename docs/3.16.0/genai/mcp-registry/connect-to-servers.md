...
## Access Endpoints[​](#access-endpoints "Direct link to Access Endpoints")
...
### Create an Access Endpoint[​](#create-an-access-endpoint "Direct link to Create an Access Endpoint")
...
Use [`mlflow.genai.create_mcp_access_endpoint()`](/docs/3.16.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.create_mcp_access_endpoint):
...
### Search and Manage Endpoints[​](#search-and-manage-endpoints "Direct link to Search and Manage Endpoints")
...
![Connection Instructions](/docs/3.16.0/assets/images/connection-instructions-49ffe465331494eb0fc3cecf522383b0.png)
...
## Tool Discovery[​](#tool-discovery "Direct link to Tool Discovery")

MLflow can automatically discover the tools that an MCP server exposes by connecting to its remote endpoint.

### Automatic Discovery During Registration[​](#automatic-discovery-during-registration "Direct link to Automatic Discovery During Registration")

When you register a server version without explicitly providing tools, MLflow connects to the first usable remote in `server_json.remotes[]` and queries the server's tool list. See [Register MCP Servers](/docs/3.16.0/genai/mcp-registry/register-mcp-servers.md#tool-auto-discovery) for details.

### Refresh Tools[​](#refresh-tools "Direct link to Refresh Tools")
...
Use [`mlflow.genai.refresh_mcp_server_version_tools()`](/docs/3.16.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.refresh_mcp_server_version_tools):
