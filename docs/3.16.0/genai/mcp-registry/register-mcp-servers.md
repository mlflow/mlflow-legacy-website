...
## Register from a server\_json Payload[​](#register-from-a-server_json-payload "Direct link to Register from a server_json Payload")

The most direct way to register an MCP server is by providing a [`server_json`](https://registry.modelcontextprotocol.io/docs#/schemas/ServerJSON) dictionary containing the server's configuration. Use [`mlflow.genai.register_mcp_server()`](/docs/3.16.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.register_mcp_server):
...
### server\_json Structure[​](#server_json-structure "Direct link to server_json Structure")
...
## Register from a URL[​](#register-from-a-url "Direct link to Register from a URL")

If your `server.json` is hosted at a URL or stored as a local file, use [`mlflow.genai.register_mcp_server_from_url()`](/docs/3.16.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.register_mcp_server_from_url):
...
## Register via the UI[​](#register-via-the-ui "Direct link to Register via the UI")

![Register MCP Server UI](/docs/3.16.0/assets/images/register-mcp-server-ui-867e86cdd8569d4f17293586dda577e3.png)
...
## Tool Auto-Discovery[​](#tool-auto-discovery "Direct link to Tool Auto-Discovery")
...
## Auto-Create Access Endpoints from Remotes[​](#auto-create-access-endpoints-from-remotes "Direct link to Auto-Create Access Endpoints from Remotes")
...
## Update and Delete Servers[​](#update-and-delete-servers "Direct link to Update and Delete Servers")
