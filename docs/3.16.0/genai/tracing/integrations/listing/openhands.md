...
[MLflow Tracing](/docs/3.16.0/genai/tracing.md) provides automatic tracing for [OpenHands](https://github.com/All-Hands-AI/OpenHands), a leading open-source AI agent framework for autonomous software development. OpenHands agents interact with code, terminals, file systems, and the web, and support multiple LLM providers including Claude, OpenAI, and open-source models.

![OpenHands Tracing](/docs/3.16.0/images/llms/openhands/openhands-trace.png)
...
[Start an MLflow server](/docs/3.16.0/genai/getting-started/connect-environment.md) if you haven't already. This step is common to both the SDK and CLI.
...
Or using [Docker Compose](/docs/3.16.0/self-hosting.md#docker-compose):
...
![OpenHands Token Usage](/docs/3.16.0/images/llms/openhands/openhands-token-usage.png)

Governing OpenHands Agents with AI Gateway

[AI Gateway](/docs/3.16.0/genai/governance/ai-gateway.md) provides centralized governance for all LLM traffic from OpenHands, including budget control, usage tracking, and secret management.
...
* **Budget control** - set [budget policies](/docs/3.16.0/genai/governance/ai-gateway/budget-alerts-limits.md) to alert or reject when spending exceeds a threshold
