...
![Groq tracing via autolog](/docs/3.16.0/images/llms/groq/groq-tracing.png)

[MLflow Tracing](/docs/3.16.0/genai/tracing.md) provides automatic tracing capability when using Groq. When Groq auto-tracing is enabled by calling the [`mlflow.groq.autolog()`](/docs/3.16.0/api_reference/python_api/mlflow.groq.html#mlflow.groq.autolog) function, usage of the Groq SDK will automatically record generated traces during interactive development.
