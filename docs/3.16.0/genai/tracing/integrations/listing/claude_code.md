...
![Claude Code Trace in MLflow UI](/docs/3.16.0/images/llms/anthropic/claude-code-trace-ui.png)

[MLflow Tracing](/docs/3.16.0/genai/tracing.md) provides automatic tracing for the [Claude Code](https://claude.com/product/claude-code) CLI. Once configured, every Claude Code session in your project is recorded to MLflow with:
...
This page covers tracing the **Claude Code CLI**. If you're building an application on top of the Claude Agent SDK, see [Claude Agent SDK (Python)](/docs/3.16.0/genai/tracing/integrations/listing/claude_agent_sdk_python.md) or [Claude Agent SDK (TypeScript)](/docs/3.16.0/genai/tracing/integrations/listing/claude_agent_sdk_typescript.md) instead.
...
![Claude Code token usage and cost dashboard in MLflow](/docs/3.16.0/assets/images/claude-code-token-cost-93b59d672945aa960af000ccbeca86df.png)
