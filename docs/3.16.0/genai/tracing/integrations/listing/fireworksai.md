...
![FireworksAI Tracing via autolog](/docs/3.16.0/images/llms/tracing/fireworks-ai-tracing.png)
...
[MLflow Tracing](/docs/3.16.0/genai/tracing.md) provides automatic tracing capability for FireworksAI through the OpenAI SDK compatibility. FireworksAI is [OpenAI SDK compatible](https://fireworks.ai/docs/tools-sdks/openai-compatibility#openai-compatibility), you can use the [`mlflow.openai.autolog()`](/docs/3.16.0/api_reference/python_api/mlflow.openai.html#mlflow.openai.autolog) function to enable automatic tracing. MLflow will capture traces for LLM invocations and log them to the active MLflow Experiment.
...
![FireworksAI Tracing in MLflow UI](/docs/3.16.0/images/llms/tracing/fireworks-ai-tracing.png)
