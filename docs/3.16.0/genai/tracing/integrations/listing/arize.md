...
## Dual Tracing with Phoenix[​](#dual-tracing-with-phoenix "Direct link to Dual Tracing with Phoenix")
...
## Span Type Mapping[​](#span-type-mapping "Direct link to Span Type Mapping")
...
## Export Mode[​](#export-mode "Direct link to Export Mode")
