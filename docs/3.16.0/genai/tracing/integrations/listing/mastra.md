...
![Mastra Tracing](/docs/3.16.0/images/llms/tracing/mastra-tracing.png)

[MLflow Tracing](/docs/3.16.0/genai/tracing.md) provides automatic tracing capability for [Mastra](https://github.com/mastra-ai/mastra), a flexible and modular AI agents framework developed by Mastra. MLflow supports tracing for Mastra through the [OpenTelemetry](/docs/3.16.0/genai/tracing/opentelemetry.md) integration.
...
![Mastra Playground](/docs/3.16.0/images/llms/tracing/mastra-playground.png)
