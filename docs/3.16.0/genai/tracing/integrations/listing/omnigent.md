...
Or use [Docker Compose](/docs/3.16.0/self-hosting.md#docker-compose):
...
See [Token Usage and Cost Tracking](/docs/3.16.0/genai/tracing/token-usage-cost.md) for details on accessing this information programmatically.
...
[Search and filter traces to find specific agent sessions.](/docs/3.16.0/genai/tracing/search-traces.md)
