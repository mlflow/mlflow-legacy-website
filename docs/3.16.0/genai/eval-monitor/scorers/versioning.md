...
| [Guidelines Judges](/docs/3.16.0/genai/eval-monitor/scorers/llm-judge/guidelines.md)    | ❌ (Use [MLflow Prompt Registry](/docs/3.16.0/genai/prompt-registry.md) instead) |
...
When you create a judge using the [Judge Builder UI](/docs/3.16.0/genai/eval-monitor/scorers/llm-judge/custom-judges.md), it is automatically registered to the current experiment as version 1.
...
To register a judge to the experiment, call the [`register()`](/docs/3.16.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.Scorer.register) method on the judge instance. The first registration creates version 1.
...
Use [`get_scorer()`](/docs/3.16.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.get_scorer) without `version` to load the highest available version, or specify a version number to load that exact definition.
...
Use [`list_scorers()`](/docs/3.16.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.list_scorers) to retrieve the latest version of each registered scorer.
...
Use [`delete_scorer()`](/docs/3.16.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.delete_scorer) with an explicit version number to delete one version, or pass `version="all"` to delete the scorer and its complete version history.
