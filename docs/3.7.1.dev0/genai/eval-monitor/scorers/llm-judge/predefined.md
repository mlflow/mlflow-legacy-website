...
See [custom LLM scorers](/docs/3.7.1.dev0/genai/eval-monitor/scorers/llm-judge/guidelines.md) guide for detailed examples.

## Example Usage[​](#example-usage "Direct link to Example Usage")

To use the predefined LLM scorers, select the scorer class from the [available scorers](#available-scorers) and pass it to the `scorers` argument of the [evaluate](/docs/3.7.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.evaluate) function.
...
![Predefined LLM scorers result](/docs/3.7.1.dev0/images/mlflow-3/eval-monitor/scorers/predefined-scorers-results.png)
...
| --------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ | ---------------------- | --------------------- |
| [RelevanceToQuery](/docs/3.7.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.RelevanceToQuery)             | Does the app's response directly address the user's input?   | No                     | No                    |
| [Correctness](/docs/3.7.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.Correctness)                       | Is the app's response correct compared to ground-truth?      | Yes\*                  | No                    |
| [Guidelines](/docs/3.7.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.Guidelines)                         | Does the response adhere to provided guidelines?             | Yes\*                  | No                    |
| [ExpectationsGuidelines](/docs/3.7.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.ExpectationsGuidelines) | Does the response meet specific expectations and guidelines? | Yes\*                  | No                    |
| [Safety](/docs/3.7.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.Safety)                                 | Does the app's response avoid harmful or toxic content?      | No                     | No                    |
| [Equivalence](/docs/3.7.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.Equivalence)                       | Is the app's response equivalent to the expected output?     | Yes                    | No                    |
| [RetrievalGroundedness](/docs/3.7.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.RetrievalGroundedness)   | Is the app's response grounded in retrieved information?     | No                     | ⚠️ **Trace Required** |
| [RetrievalRelevance](/docs/3.7.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.RetrievalRelevance)         | Are retrieved documents relevant to the user's request?      | No                     | ⚠️ **Trace Required** |
| [RetrievalSufficiency](/docs/3.7.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.RetrievalSufficiency)     | Do retrieved documents contain all necessary information?    | Yes                    | ⚠️ **Trace Required** |
...
* Use [automatic tracing integration](/docs/3.7.1.dev0/genai/tracing/app-instrumentation/automatic.md) with your application
...
See [Supported Models](/docs/3.7.1.dev0/genai/eval-monitor/scorers/llm-judge.md#supported-models) for more details.
...
### [Guidelines Scorer](/docs/3.7.1.dev0/genai/eval-monitor/scorers/llm-judge/guidelines.md)

[Learn how to use the Guidelines scorer to evaluate responses against custom criteria](/docs/3.7.1.dev0/genai/eval-monitor/scorers/llm-judge/guidelines.md)

[Learn more →](/docs/3.7.1.dev0/genai/eval-monitor/scorers/llm-judge/guidelines.md)

### [Evaluate Agents](/docs/3.7.1.dev0/genai/eval-monitor/running-evaluation/agents.md)

[Learn how to evaluate AI agents with specialized techniques and scorers](/docs/3.7.1.dev0/genai/eval-monitor/running-evaluation/agents.md)

[Learn more →](/docs/3.7.1.dev0/genai/eval-monitor/running-evaluation/agents.md)

### [Evaluate Traces](/docs/3.7.1.dev0/genai/eval-monitor/running-evaluation/traces.md)

[Evaluate production traces to understand and improve your AI application's behavior](/docs/3.7.1.dev0/genai/eval-monitor/running-evaluation/traces.md)

[Learn more →](/docs/3.7.1.dev0/genai/eval-monitor/running-evaluation/traces.md)
