...
![VoltAgent Tracing](/docs/3.7.1.dev0/images/llms/tracing/voltagent-tracing.png)

[MLflow Tracing](/docs/3.7.1.dev0/genai/tracing.md) provides automatic tracing capability for [VoltAgent](https://github.com/VoltAgent/voltagent), an open-source TypeScript framework for building AI agents. MLflow supports tracing for VoltAgent through the [OpenTelemetry](/docs/3.7.1.dev0/genai/tracing/opentelemetry.md) integration.
...
![VoltAgent trace in MLflow UI](/docs/3.7.1.dev0/images/llms/tracing/voltagent-tracing.png)

## Next Steps[​](#next-steps "Direct link to Next Steps")

* [Evaluate the Agent](/docs/3.7.1.dev0/genai/eval-monitor/running-evaluation/agents.md): Learn how to evaluate the agent's performance.
* [Manage Prompts](/docs/3.7.1.dev0/genai/prompt-registry.md): Learn how to manage prompts for the agent.
* [Automatic Agent Optimization](/docs/3.7.1.dev0/genai/prompt-registry/optimize-prompts.md): Learn how to automatically optimize the agent end-to-end with state-of-the-art optimization algorithms.
