...
* [Optimizing Prompts for LangChain](/docs/3.7.1.dev0/genai/prompt-registry/optimize-prompts/langchain-optimization.md): Learn how to optimize LangChain chains with minimal code changes
* [Optimizing Prompts for OpenAI Agents](/docs/3.7.1.dev0/genai/prompt-registry/optimize-prompts/openai-agent-optimization.md): Learn how to optimize OpenAI Agent prompts
