...
![OpenAI Agent Logo](/docs/3.7.1.dev0/images/logos/openai-agent-logo.png)

This guide demonstrates how to leverage [`mlflow.genai.optimize_prompts()`](/docs/3.7.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.optimize_prompts) alongside the [OpenAI Agent framework](https://github.com/openai/openai-agents-python) to enhance your agent's prompts automatically. The [`mlflow.genai.optimize_prompts()`](/docs/3.7.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.optimize_prompts) API is framework-agnostic, enabling you to perform end-to-end prompt optimization of your agents from any framework using state-of-the-art techniques. For more information about the API, please visit [Optimize Prompts](/docs/3.7.1.dev0/genai/prompt-registry/optimize-prompts.md).
