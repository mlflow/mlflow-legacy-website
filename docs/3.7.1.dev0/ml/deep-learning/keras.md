...
Save Keras models with [`mlflow.tensorflow.log_model()`](/docs/3.7.1.dev0/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.log_model):
...
[Version and manage Keras models](/docs/3.7.1.dev0/ml/model-registry.md)
