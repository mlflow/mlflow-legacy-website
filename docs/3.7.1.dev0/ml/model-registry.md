...
| Concept                      | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Model                        | An MLflow Model is created with one of the model flavor's **`mlflow.<model_flavor>.log_model()`** methods, or **[`mlflow.create_external_model()`](/docs/3.7.1.dev0/api_reference/python_api/mlflow.html#mlflow.create_external_model)** API since MLflow 3. Once logged, this model can then be registered with the Model Registry.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
To learn more about the OSS Model Registry, refer to the [tutorial on the model registry](/docs/3.7.1.dev0/ml/model-registry/tutorial.md).
...
ML model versions in UC must have a [model signature](/docs/3.7.1.dev0/ml/model/signatures.md). If you want to set a signature on a model that's already logged or saved, the [`mlflow.models.set_signature()`](/docs/3.7.1.dev0/api_reference/python_api/mlflow.models.html#mlflow.models.set_signature) API is available for this purpose.
...
![](/docs/3.7.1.dev0/assets/images/uc_register_model_1_dialog-dbc7806e79613776eb84159fa6c394e2.png)

3. Click Register.

![](/docs/3.7.1.dev0/assets/images/uc_register_model_2_button-e6b3b94bde6506bda3be82836db5e019.png)
