...
![Tags, experiments, and runs relationships](/docs/3.6.0/assets/images/tag-exp-run-relationship-fc898eccc4bb05fe59f41372ab5f6b50.svg)
...
![Challenges with hyperparameter data storage](/docs/3.6.0/assets/images/what-to-do-with-hyperparam-runs-f300784edeacd21609ad71852b184bd5.svg)
...
![Hyperparameter tuning no child runs](/docs/3.6.0/assets/images/no-child-first-ac9b59845a4d7aa095ec913220cc5913.gif)
...
![Adding more runs](/docs/3.6.0/assets/images/no-child-more-be952d9e9b8c849bf5b05290d49ce24a.gif)
...
![Using child runs](/docs/3.6.0/assets/images/child-runs-3a77b805cd47d1e997c3268c47b6d22d.gif)
...
![Challenge](/docs/3.6.0/assets/images/parent-child-challenge-b7198bdf22d9b91c5bff5de671e5f629.gif)
