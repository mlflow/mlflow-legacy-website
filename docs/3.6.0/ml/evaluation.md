...
**For GenAI/LLM evaluation**, please use the system at [GenAI Evaluation](/docs/3.6.0/genai/eval-monitor.md) which uses:
...
[Model Evaluation](/docs/3.6.0/ml/evaluation/model-eval.md)

[Core model evaluation workflows for classification and regression tasks with automated metrics, visualizations, and performance assessment.](/docs/3.6.0/ml/evaluation/model-eval.md)

[Dataset Evaluation](/docs/3.6.0/ml/evaluation/dataset-eval.md)

[Evaluate static datasets and pre-computed predictions without re-running models, perfect for batch processing and historical analysis.](/docs/3.6.0/ml/evaluation/dataset-eval.md)

[Function Evaluation](/docs/3.6.0/ml/evaluation/function-eval.md)

[Lightweight evaluation of Python functions and custom prediction logic without the overhead of model logging and registration.](/docs/3.6.0/ml/evaluation/function-eval.md)

[Custom Metrics & Visualizations](/docs/3.6.0/ml/evaluation/metrics-visualizations.md)

[Define domain-specific evaluation criteria, custom metrics, and specialized visualizations tailored to your business requirements.](/docs/3.6.0/ml/evaluation/metrics-visualizations.md)

[SHAP Integration](/docs/3.6.0/ml/evaluation/shap.md)

[Deep model interpretation with SHAP values, feature importance analysis, and explainable AI capabilities for transparent ML.](/docs/3.6.0/ml/evaluation/shap.md)

[Plugin Evaluators](/docs/3.6.0/ml/evaluation/plugin-evaluators.md)

[Extend evaluation capabilities with specialized plugins like Giskard for vulnerability scanning and Trubrics for advanced validation.](/docs/3.6.0/ml/evaluation/plugin-evaluators.md)
...
Start with [Model Evaluation](/docs/3.6.0/ml/evaluation/model-eval.md) to understand comprehensive performance assessment, then explore **Custom Metrics** for domain-specific requirements.

#### For ML Engineers[​](#for-ml-engineers "Direct link to For ML Engineers")

Begin with [Function Evaluation](/docs/3.6.0/ml/evaluation/function-eval.md) for lightweight testing, then advance to **Model Validation** for production readiness assessment.

#### For ML Researchers[​](#for-ml-researchers "Direct link to For ML Researchers")

Explore [SHAP Integration](/docs/3.6.0/ml/evaluation/shap.md) for model interpretability, then investigate **Plugin Evaluators** for specialized analysis capabilities.

#### For Enterprise Teams[​](#for-enterprise-teams "Direct link to For Enterprise Teams")

Start with [Model Validation](/docs/3.6.0/ml/evaluation/metrics-visualizations.md) for governance requirements, then implement [Dataset Evaluation](/docs/3.6.0/ml/evaluation/dataset-eval.md) for large-scale assessment workflows.
