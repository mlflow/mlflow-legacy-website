...
![MLflow Traces UI](/docs/3.6.0/assets/images/tracing-top-dcca046565ab33be6afe0447dd328c22.gif)
...
1. **Search and Filter Traces** Learn how to find specific traces using the [search functionality](/docs/3.6.0/genai/tracing/search-traces.md).

2. **Add Tags and Context** Organize your traces with [custom tags](/docs/3.6.0/genai/tracing/attach-tags.md) for better monitoring.

3. **Production Deployment** Set up [production monitoring](/docs/3.6.0/genai/tracing/prod-tracing.md) with the lightweight SDK.

4. **Integration with Other Libraries** Explore [automatic tracing](/docs/3.6.0/genai/tracing/integrations.md) for LangChain, LlamaIndex, and more.

5. **Manual Instrumentation** Learn [manual tracing techniques](/docs/3.6.0/genai/tracing/app-instrumentation/manual-tracing.md) for custom applications.
