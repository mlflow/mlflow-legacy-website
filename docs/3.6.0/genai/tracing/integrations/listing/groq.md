...
![Groq tracing via autolog](/docs/3.6.0/assets/images/groq-tracing-c479723e95472339d07b0dd94b38854b.png)

MLflow Tracing provides automatic tracing capability when using Groq. When Groq auto-tracing is enabled by calling the [`mlflow.groq.autolog()`](/docs/3.6.0/api_reference/python_api/mlflow.groq.html#mlflow.groq.autolog) function, usage of the Groq SDK will automatically record generated traces during interactive development.
