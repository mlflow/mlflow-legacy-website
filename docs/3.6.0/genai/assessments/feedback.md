...
For complete API documentation and implementation details, see the [`mlflow.log_feedback()`](/docs/3.6.0/api_reference/python_api/mlflow.html#mlflow.log_feedback) reference.

## What is Feedback?[​](#what-is-feedback "Direct link to What is Feedback?")

[Feedback](/docs/3.6.0/genai/concepts/feedback.md) captures evaluations of how well your AI performed. It measures the actual quality of what your AI produced across various dimensions like accuracy, relevance, safety, and helpfulness. Unlike [expectations](/docs/3.6.0/genai/assessments/expectations.md) that define what should happen, feedback tells you what actually happened and how well it met your quality standards.
...
### [Feedback Concepts](/docs/3.6.0/genai/concepts/feedback.md)

[Deep dive into feedback architecture and schema](/docs/3.6.0/genai/concepts/feedback.md)

[Learn concepts →](/docs/3.6.0/genai/concepts/feedback.md)

### [Ground Truth Expectations](/docs/3.6.0/genai/assessments/expectations.md)

[Learn how to define expected outputs for evaluation](/docs/3.6.0/genai/assessments/expectations.md)
