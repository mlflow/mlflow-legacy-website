...
MLflow supports different backends for tracking your experiment data. Choose one of the following options to get started. Refer to the [Self Hosting Guide](/docs/3.6.0/self-hosting.md) for detailed setup and configurations.
...
Start a remote MLflow tracking server following the [Self Hosting Guide](/docs/3.6.0/self-hosting.md). Then configure your client to use the remote server:
...
Refer to the [Network Security Guide](/docs/3.6.0/self-hosting/security/network.md) for detailed configuration options.
...
Creating a Databricks Notebook will create an MLflow Experiment that is the container for your GenAI application. Learn more about Experiments in the [MLflow documentation](/docs/3.6.0/ml/tracking.md).
...
* **Instrument your app with tracing**: Follow the [quickstart](/docs/3.6.0/genai/tracing/quickstart/python-openai.md) to instrument your first GenAI app
