...
For detailed API usage, see the [SDK Guide](/docs/3.6.0/genai/datasets/sdk-guide.md).
...
See the [SDK Guide](/docs/3.6.0/genai/datasets/sdk-guide.md#step-4-organize-with-tags) for detailed API usage.

## Next Steps[​](#next-steps "Direct link to Next Steps")

### [SDK Guide](/docs/3.6.0/genai/datasets/sdk-guide.md)

[Complete reference for creating and managing evaluation datasets](/docs/3.6.0/genai/datasets/sdk-guide.md)

[View SDK guide →](/docs/3.6.0/genai/datasets/sdk-guide.md)

### [Expectations](/docs/3.6.0/genai/concepts/expectations.md)

[Learn how to define ground truth for your test cases](/docs/3.6.0/genai/concepts/expectations.md)

[Understand expectations →](/docs/3.6.0/genai/concepts/expectations.md)

### [Evaluation Framework](/docs/3.6.0/genai/eval-monitor.md)

[Use datasets with MLflow's evaluation capabilities](/docs/3.6.0/genai/eval-monitor.md)
