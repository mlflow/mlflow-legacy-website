...
[](/docs/3.7.0rc0/images/llms/tracing/vercel-ai-tracing.mp4)

[MLflow Tracing](/docs/3.7.0rc0/genai/tracing.md) provides automatic tracing for applications built with the [Vercel AI SDK](https://ai-sdk.dev/) (the `ai` package), unlocking powerful observability capabilities for TypeScript and Javascript application developers.
