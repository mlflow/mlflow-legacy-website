...
![Semantic Kernel Tracing via autolog](/docs/3.7.0rc0/images/llms/tracing/semantic-kernel-tracing.png)
...
[MLflow Tracing](/docs/3.7.0rc0/genai/tracing.md) provides automatic tracing capability for Semantic Kernel. By enabling auto tracing for Semantic Kernel via the [`mlflow.semantic_kernel.autolog()`](/docs/3.7.0rc0/api_reference/python_api/mlflow.html#mlflow.semantic_kernel.autolog) function, MLflow will capture traces for LLM invocations and log them to the active MLflow Experiment.
