...
![Trace Example](/docs/3.7.0rc0/images/llms/tracing/genai-trace-debug.png)
...
The [TraceInfo](/docs/3.7.0rc0/api_reference/python_api/mlflow.entities.html#mlflow.entities.TraceInfo) within MLflow's tracing feature aims to provide a lightweight snapshot of critical data about the overall trace. In Python SDK, [TraceInfo](/docs/3.7.0rc0/api_reference/python_api/mlflow.entities.html#mlflow.entities.TraceInfo) is designed as a dataclass object that contains metadata about the trace.

This metadata includes information about the trace's origin, status, and various other data that aids in retrieving and filtering traces when used with [`mlflow.search_traces()`](/docs/3.7.0rc0/api_reference/python_api/mlflow.html#mlflow.search_traces) and for navigation of traces within the MLflow UI.

| Field                | Type                                                                                                          | Description                                                                                                                                                                                                                                                                                                                                                     |
| -------------------- | ------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `trace_id`           | `str`                                                                                                         | The primary identifier for the trace.                                                                                                                                                                                                                                                                                                                           |
| `trace_location`     | [`TraceLocation`](/docs/3.7.0rc0/api_reference/python_api/mlflow.entities.html#mlflow.entities.TraceLocation) | The location where the trace is stored, represented as a TraceLocation object. MLflow currently supports MLflow Experiment as a trace location.                                                                                                                                                                                                                 |
| `request_time`       | `int`                                                                                                         | Start time of the trace, in milliseconds.                                                                                                                                                                                                                                                                                                                       |
| `state`              | [`TraceState`](/docs/3.7.0rc0/api_reference/python_api/mlflow.entities.html#mlflow.entities.TraceState)       | State of the trace, represented as a TraceState enum. Can be one of `OK`, `ERROR`, `IN_PROGRESS`, `STATE_UNSPECIFIED`.                                                                                                                                                                                                                                          |
...
![Span Architecture](/docs/3.7.0rc0/assets/images/span_architecture-a0ce1bb4698cf4ba9a5910029a8be6cf.png)

To learn more about the span object and its schema, continue to the [Span Concepts](/docs/3.7.0rc0/genai/concepts/span.md) page.
