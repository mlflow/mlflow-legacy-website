...
The TypeScript SDK supports [tracing](/docs/3.16.1/genai/tracing.md) for GenAI applications. [Experiment tracking](/docs/3.16.1/ml/tracking/quickstart.md) APIs (`start_run`, `log_param`, `log_metric`) are available in the Python SDK only.
