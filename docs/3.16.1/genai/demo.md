...
[](/docs/3.16.1/images/genai/live-mlflow-ui-demo.mp4)
...
* [Set Up MLflow Server](/docs/3.16.1/genai/getting-started/connect-environment.md) — connect to a local or hosted MLflow instance
* [Start Tracing](/docs/3.16.1/genai/tracing/quickstart.md) — instrument your LLM app and capture your first traces
* [Evaluate LLMs and Agents](/docs/3.16.1/genai/eval-monitor/quickstart.md) — run systematic evaluations with LLM judges
