...
![Create Prompt UI](/docs/3.16.1/assets/images/create-prompt-ui-03c88144e65d28eb7847b2ae5d8dd49a.png)
...
To create a new prompt using the Python API, use [`mlflow.genai.register_prompt()`](/docs/3.16.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.register_prompt) API:
...
![Registered Prompt in UI](/docs/3.16.1/assets/images/registered-prompt-d457d27524f55e7575e9a129e53487e4.png)
...
![Update Prompt UI](/docs/3.16.1/assets/images/update-prompt-ui-9fe89b08b9318729754441fbe67f0a90.png)
...
To update an existing prompt with a new version, use the [`mlflow.genai.register_prompt()`](/docs/3.16.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.register_prompt) API with the existing prompt name:
...
![Compare Prompt
Versions](/docs/3.16.1/assets/images/compare-prompt-versions-cfb444eca59dc0c2e14b98d480aa2c17.png)

### 4. Load and Use the Prompt[​](#4-load-and-use-the-prompt "Direct link to 4. Load and Use the Prompt")

To use a prompt in your LLM application or AI agent, you can load it with the [`mlflow.genai.load_prompt()`](/docs/3.16.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.load_prompt) API and fill in the variables using the [`mlflow.entities.Prompt.format()`](/docs/3.16.1/api_reference/python_api/mlflow.entities.html#mlflow.entities.Prompt.format) method of the prompt object.
...
Any registered prompt can be loaded directly into the [**LLM Playground**](/docs/3.16.1/genai/prompt-registry/playground.md) for interactive testing against an [AI Gateway](/docs/3.16.1/genai/governance/ai-gateway.md) endpoint. Chat-typed prompts preserve their full message structure, and any stored **model config** is applied automatically.
...
* `Alias`: An mutable named reference to the prompt. For example, you can create an alias named `production` to refer to the version used in your production system. See [Aliases](/docs/3.16.1/genai/prompt-registry/manage-prompt-lifecycles-with-aliases.md) for more details.
...
For better type safety and validation, you can use the [`mlflow.entities.model_registry.PromptModelConfig()`](/docs/3.16.1/api_reference/python_api/mlflow.entities.html#mlflow.entities.model_registry.PromptModelConfig) class:
...
Use [`mlflow.genai.set_prompt_model_config()`](/docs/3.16.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.set_prompt_model_config) to set or update the model configuration for a prompt version:
...
Use [`mlflow.genai.delete_prompt_model_config()`](/docs/3.16.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.delete_prompt_model_config) to remove model configuration from a prompt version:
