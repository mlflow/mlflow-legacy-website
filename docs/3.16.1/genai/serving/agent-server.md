...
You can use [`mlflow.genai.evaluate()`](/docs/3.16.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.evaluate) to evaluate your agent. See the [Evaluating Agents](/docs/3.16.1/genai/eval-monitor.md) guide and [Scorer](/docs/3.16.1/genai/eval-monitor/scorers.md) documentation for more information.
