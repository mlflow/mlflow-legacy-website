...
[MLflow Tracing](/docs/3.16.1/genai/tracing.md) provides automatic tracing for Python applications built on the [Claude Agent SDK](https://docs.claude.com/en/api/agent-sdk/overview). Traces capture:
...
This page covers the **Python** Claude Agent SDK. For the TypeScript SDK, see [Tracing the Claude Agent SDK (TypeScript)](/docs/3.16.1/genai/tracing/integrations/listing/claude_agent_sdk_typescript.md).
