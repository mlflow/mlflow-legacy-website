...
![Koog Logo](/docs/3.16.1/images/logos/koog.png)
...
[MLflow Tracing](/docs/3.16.1/genai/tracing.md) provides automatic tracing capability for [Koog](https://github.com/JetBrains/koog), JetBrains' framework for building AI agents in Kotlin. MLflow supports tracing for Koog through the [OpenTelemetry](/docs/3.16.1/genai/tracing/opentelemetry.md) integration — Koog's built-in OpenTelemetry feature sends traces directly to MLflow's OTLP endpoint with no additional adapters needed.
...
To use other types of SQL databases such as PostgreSQL, MySQL, and MSSQL, change the store URI as described in the [backend store documentation](/docs/3.16.1/self-hosting/architecture/backend-store.md).
...
When [workspaces](/docs/3.16.1/self-hosting/workspaces/getting-started.md) are enabled on your MLflow server, OTLP clients can also send the `X-MLFLOW-WORKSPACE` header to override the default workspace for a request.
...
![Koog Tracing](/docs/3.16.1/assets/images/koog-tracing-03957e45fbf8444190b33267b67733ba.png)
...
* [Evaluate the Agent](/docs/3.16.1/genai/eval-monitor/running-evaluation/traces.md): Learn how to evaluate the agent's performance.
* [Collect User Feedback](/docs/3.16.1/genai/tracing/collect-user-feedback.md): Learn how to collect user feedback on traces for improving the agent.
* [Search Traces](/docs/3.16.1/genai/tracing/search-traces.md): Learn how to search and analyze traces for insights.

## Reference[​](#reference "Direct link to Reference")

* [Collect OpenTelemetry Traces into MLflow](/docs/3.16.1/genai/tracing/opentelemetry/ingest.md) — complete reference for sending OpenTelemetry traces to MLflow
