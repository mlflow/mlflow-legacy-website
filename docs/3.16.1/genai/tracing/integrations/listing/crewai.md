...
[](/docs/3.16.1/images/llms/crewai/crewai-tracing.mp4)

[CrewAI](https://www.crewai.com/) is an open-source framework for orchestrating role-playing, autonomous AI agent.

[MLflow Tracing](/docs/3.16.1/genai/tracing/integrations.md) provides automatic tracing capability for [CrewAI](https://www.crewai.com/), an open source framework for building multi-agent applications. By enabling auto tracing for CrewAI by calling the [`mlflow.crewai.autolog()`](/docs/3.16.1/api_reference/python_api/mlflow.crewai.html#mlflow.crewai.autolog) function, , MLflow will capture nested traces for CrewAI workflow execution and logged them to the active MLflow Experiment.
