...
![Open WebUI connections settings](/docs/3.16.1/images/llms/tracing/open-webui/openwebui_settings.png)
...
![Open WebUI pipeline valve configuration](/docs/3.16.1/images/llms/tracing/open-webui/pipeline_config.png)
...
![Open WebUI chat session](/docs/3.16.1/images/llms/tracing/open-webui/chat_session.png)

Open the MLflow UI and navigate to the Traces tab. Each conversation turn appears as a separate trace:

![MLflow single trace view](/docs/3.16.1/images/llms/tracing/open-webui/trace_single_1.png)

![MLflow trace detail](/docs/3.16.1/images/llms/tracing/open-webui/trace_single_2.png)

Enable **"Group by session"** to see the full conversation grouped under one session:

![MLflow session grouped view](/docs/3.16.1/images/llms/tracing/open-webui/trace_session.png)
