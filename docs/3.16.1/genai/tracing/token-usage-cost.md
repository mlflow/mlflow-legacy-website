...
[](/docs/3.16.1/images/llms/tracing/token-usage-and-cost-charts.mp4)
...
The `[genai]` extra enables other powerful features such as [AI Gateway](/docs/3.16.1/genai/governance/ai-gateway.md), [Automatic Evaluation](/docs/3.16.1/genai/eval-monitor/automatic-evaluations.md), and [Prompt Optimization](/docs/3.16.1/genai/prompt-registry/optimize-prompts.md). It is recommended to start your MLflow server with the extra installed, even if you don't need cost tracking.
...
[](/docs/3.16.1/images/llms/tracing/token-and-cost-ui.mp4)

<br />

The aggregated cost and trend charts are available in the **Overview** tab of the experiment page.

![Token Usage and Cost charts in Overview tab](/docs/3.16.1/images/llms/tracing/overview-token-cost-charts.png)
...
Token usage and cost tracking is supported for most MLflow tracing integrations. See the individual [integration pages](/docs/3.16.1/genai/tracing/integrations.md) for specific support details.
...
### [View Traces in UI](/docs/3.16.1/genai/tracing/observe-with-traces/ui.md)

[Learn how to navigate and analyze traces in the MLflow UI.](/docs/3.16.1/genai/tracing/observe-with-traces/ui.md)

[View traces →](/docs/3.16.1/genai/tracing/observe-with-traces/ui.md)

### [Search Traces](/docs/3.16.1/genai/tracing/search-traces.md)

[Search and filter traces based on various criteria.](/docs/3.16.1/genai/tracing/search-traces.md)

[Search traces →](/docs/3.16.1/genai/tracing/search-traces.md)

### [Tracing Integrations](/docs/3.16.1/genai/tracing/integrations.md)

[See which integrations support token usage and cost tracking.](/docs/3.16.1/genai/tracing/integrations.md)

[View integrations →](/docs/3.16.1/genai/tracing/integrations.md)
