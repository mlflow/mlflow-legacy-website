...
![Create LLM Connection](/docs/3.16.1/assets/images/create-api-key-367dec6af39b6e7a30dcb6666fb9afa1.png)
...
[Learn about LLM connections and best practices for managing API keys](/docs/3.16.1/genai/governance/ai-gateway/api-keys/create-and-manage.md)

[Manage LLM connections →](/docs/3.16.1/genai/governance/ai-gateway/api-keys/create-and-manage.md)

### [Endpoints](/docs/3.16.1/genai/governance/ai-gateway/endpoints/create-and-manage.md)

[Configure endpoints with multiple models and query options](/docs/3.16.1/genai/governance/ai-gateway/endpoints/create-and-manage.md)
...
[Set up A/B testing, fallbacks, and high availability](/docs/3.16.1/genai/governance/ai-gateway/traffic-routing-fallbacks.md)

[Set up routing →](/docs/3.16.1/genai/governance/ai-gateway/traffic-routing-fallbacks.md)
