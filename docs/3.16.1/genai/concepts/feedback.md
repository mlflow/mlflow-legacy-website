...
![Feedbacks attached to traces](/docs/3.16.1/images/llms/tracing/genai-human-feedback.png)
...
### [Feedback Guide](/docs/3.16.1/genai/assessments/feedback.md)

[Complete guide for using mlflow.log\_feedback with practical examples and code samples](/docs/3.16.1/genai/assessments/feedback.md)

[View the feedback guide →](/docs/3.16.1/genai/assessments/feedback.md)

### [Expectations Concepts](/docs/3.16.1/genai/concepts/expectations.md)

[Learn how to define ground truth expectations for comprehensive evaluation](/docs/3.16.1/genai/concepts/expectations.md)

[Learn about expectations →](/docs/3.16.1/genai/concepts/expectations.md)

### [Ground Truth Expectations](/docs/3.16.1/genai/assessments/expectations.md)

[Understand how to define expected outputs for comprehensive evaluation](/docs/3.16.1/genai/assessments/expectations.md)

[Learn about expectations →](/docs/3.16.1/genai/assessments/expectations.md)
