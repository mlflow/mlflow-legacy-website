...
Run the [`mlflow.genai.evaluate()`](/docs/3.15.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.evaluate) API to evaluate the model with the prepared data and prompt. In this example, we will use the following two built-in metrics.
...
![Evaluation Results](/docs/3.15.0/assets/images/prompt-evaluation-result-2a8eb8bdd0d27413488af07919dd844b.png)
