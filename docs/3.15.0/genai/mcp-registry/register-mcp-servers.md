...
The most direct way to register an MCP server is by providing a [`server_json`](https://registry.modelcontextprotocol.io/docs#/schemas/ServerJSON) dictionary containing the server's configuration. Use [`mlflow.genai.register_mcp_server()`](/docs/3.15.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.register_mcp_server):
...
If your `server.json` is hosted at a URL or stored as a local file, use [`mlflow.genai.register_mcp_server_from_url()`](/docs/3.15.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.register_mcp_server_from_url):
...
![Register MCP Server UI](/docs/3.15.0/assets/images/register-mcp-server-ui-867e86cdd8569d4f17293586dda577e3.png)
