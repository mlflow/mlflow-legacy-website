...
![Watsonx Orchestrate Logo](/docs/3.15.0/images/logos/watsonx-orchestrate.png)

#### Integration via OpenTelemetry

Watsonx Orchestrate<!-- --> can be integrated with MLflow via OpenTelemetry. Configure <!-- -->Watsonx Orchestrate<!-- -->'s OpenTelemetry exporter to send traces to MLflow's OTLP endpoint.
