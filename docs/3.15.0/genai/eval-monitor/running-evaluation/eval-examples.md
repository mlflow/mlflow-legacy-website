...
To create datasets from traces or scratch, see [Build evaluation datasets](/docs/3.15.0/genai/datasets.md).
...
For production, convert to an [MLflow Evaluation Dataset](/docs/3.15.0/genai/datasets.md).
...
The DataFrame must comply with the [evaluation dataset schema](/docs/3.15.0/genai/datasets/sdk-guide.md#evaluation-dataset-schema).
