...
Looking for using MLflow for LLMs/Agent development? Checkout the [MLflow for GenAI](/docs/3.14.0/genai.md) documentation instead. This guide is intended for data scientists who train traditional machine learning models, such as decision trees.
...
To learn more about autologging and supported libraries, see the [Autologging](/docs/3.14.0/ml/tracking/autolog.md) documentation.
...
![MLflow UI Home page](/docs/3.14.0/images/tutorials/introductory/quickstart-tracking/quickstart-ui-home.png)

The "Experiments" section shows a list of (recently created) experiments. Click on the "MLflow Quickstart" experiment.

![MLflow UI Run list page](/docs/3.14.0/images/tutorials/introductory/quickstart-tracking/quickstart-ui-run-list.png)

The training **Run** created by MLflow is listed in the table. Click the run to view the details.

![MLflow UI Run detail page](/docs/3.14.0/images/tutorials/introductory/quickstart-tracking/quickstart-our-run.png)
...
![MLflow UI Model detail page](/docs/3.14.0/images/tutorials/introductory/quickstart-tracking/quickstart-ui-logged-models.png)
...
![MLflow UI Model detail page](/docs/3.14.0/images/tutorials/introductory/quickstart-tracking/quickstart-our-model.png)
...
* [MLflow for GenAI](/docs/3.14.0/genai.md): Learn how to use MLflow for GenAI/LLM development.
