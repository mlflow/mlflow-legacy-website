...
For setting up authentication and managing users (login, signup, admin status, password updates), see [Username and Password](/docs/3.14.0/self-hosting/security/basic-http-auth.md); this page picks up once users exist.
...
![Admin UI showing Users and Roles tabs](/docs/3.14.0/assets/images/rbac-admin-ui-overview-a5075132ef5242015a49103fd0cda1fa.png)
...
![User detail page showing role assignments](/docs/3.14.0/assets/images/rbac-users-tab-roles-a34813123da1f12a4b6121c5eade1fdf.png)
...
![Roles tab listing roles across workspaces](/docs/3.14.0/assets/images/rbac-roles-tab-ba32fa6fea950378ece781254180faf2.png)

![Edit role form with Role details and Permissions sections](/docs/3.14.0/assets/images/rbac-edit-role-form-e75bdd49289e813bcd01c9f77df7b4f6.png)
...
* [`AuthServiceClient` Python API](/docs/3.14.0/api_reference/auth/python-api.html#mlflow.server.auth.client.AuthServiceClient)
* [Authentication REST API](/docs/3.14.0/api_reference/auth/rest-api.html/)
