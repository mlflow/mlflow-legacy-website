...
![Guidelines judge result](/docs/3.14.0/images/genai/eval-monitor/guidelines-judge-results.png)
...
![Expectations Guidelines judge results](/docs/3.14.0/images/genai/eval-monitor/expectations-guidelines-judge-results.png)

## Return values[​](#return-values "Direct link to Return values")

Guidelines judges return an [mlflow.entities.Feedback](/docs/3.14.0/api_reference/python_api/mlflow.entities.html#mlflow.entities.Feedback) object containing:
...
### [Use built-in LLM judges](/docs/3.14.0/genai/eval-monitor/scorers/llm-judge/predefined.md#available-judges)

[Evaluate quality with MLflow's other research-backed, built-in LLM judges](/docs/3.14.0/genai/eval-monitor/scorers/llm-judge/predefined.md#available-judges)

[Learn more →](/docs/3.14.0/genai/eval-monitor/scorers/llm-judge/predefined.md#available-judges)

### [Create custom LLM judges](/docs/3.14.0/genai/eval-monitor/scorers/llm-judge/custom-judges.md)

[Build custom judges for your specific needs](/docs/3.14.0/genai/eval-monitor/scorers/llm-judge/custom-judges.md)
...
[Improve judge accuracy to match your quality standards](/docs/3.14.0/genai/eval-monitor/scorers/llm-judge/alignment.md)

[Learn more →](/docs/3.14.0/genai/eval-monitor/scorers/llm-judge/alignment.md)
