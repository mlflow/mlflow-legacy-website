...
Trace archival lets MLflow move older trace span payloads out of the SQL tracking store and into a configured archive artifact location while keeping the traces readable in the UI and APIs. To enable trace archival on a self-hosted server, see [MLflow Tracking Server](/docs/3.14.0/self-hosting/architecture/tracking-server.md).
...
## What Trace Archival Does[​](#what-trace-archival-does "Direct link to What Trace Archival Does")
...
![Trace archival flow](/docs/3.14.0/images/llms/tracing/archive-diagram.svg)

## Configuring Retention Policy[​](#configuring-retention-policy "Direct link to Configuring Retention Policy")

### How Retention Is Resolved[​](#how-retention-is-resolved "Direct link to How Retention Is Resolved")
...
| Workspace  | [`mlflow.create_workspace()`](/docs/3.14.0/api_reference/python_api/mlflow.html#mlflow.create_workspace) / [`mlflow.update_workspace()`](/docs/3.14.0/api_reference/python_api/mlflow.html#mlflow.update_workspace) with `TraceArchivalConfig` | Workspace-specific archive location and retention defaults           |
...
![Archive after badge in the trace list](/docs/3.14.0/images/llms/tracing/archive-after-badge.png)
...
### Before You Configure Retention[​](#before-you-configure-retention "Direct link to Before You Configure Retention")
...
For workspace-specific setup, see [Getting Started with Workspaces](/docs/3.14.0/self-hosting/workspaces/getting-started.md).

### Set Workspace-Level Defaults[​](#set-workspace-level-defaults "Direct link to Set Workspace-Level Defaults")
...
#### Create a workspace with archival settings[​](#create-a-workspace-with-archival-settings "Direct link to Create a workspace with archival settings")
...
#### Update a workspace[​](#update-a-workspace "Direct link to Update a workspace")
...
### Set Experiment-Level Retention[​](#set-experiment-level-retention "Direct link to Set Experiment-Level Retention")
...
1. Navigate to a specific experiment, for example `/experiments/2/overview/usage?workspace=team-a`.
...
## Trigger Archival Immediately[​](#trigger-archival-immediately "Direct link to Trigger Archival Immediately")
...
## What Changes After Archival[​](#what-changes-after-archival "Direct link to What Changes After Archival")
...
## Limitations and Troubleshooting[​](#limitations-and-troubleshooting "Direct link to Limitations and Troubleshooting")
...
* If a trace is stuck in a malformed state, administrators can clear `mlflow.trace.archivalFailure` with [`mlflow.client.MlflowClient.delete_trace_tag()`](/docs/3.14.0/api_reference/python_api/mlflow.client.html#mlflow.client.MlflowClient.delete_trace_tag) after fixing the underlying trace data so the scheduler can try again.
...
* If you need to remove old traces permanently rather than move their payloads, use [Delete Traces](/docs/3.14.0/genai/tracing/observe-with-traces/delete-traces.md).

For related workflows, see [View Traces](/docs/3.14.0/genai/tracing/observe-with-traces/ui.md) and [Search Traces](/docs/3.14.0/genai/tracing/search-traces.md).
