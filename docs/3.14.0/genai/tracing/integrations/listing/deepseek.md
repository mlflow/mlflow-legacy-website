...
[MLflow Tracing](/docs/3.14.0/genai/tracing/integrations.md) provides automatic tracing capability for <!-- -->DeepSeek<!-- --> models through the OpenAI SDK integration. Since <!-- -->DeepSeek<!-- --> offers an OpenAI-compatible API format, you can use<!-- --> `mlflow.openai.autolog()` to trace interactions with <!-- -->DeepSeek<!-- --> models.
...
![DeepSeek Tracing](/docs/3.14.0/images/llms/tracing/basic-openai-trace.png)
...
MLflow supports tracing for streaming and async <!-- -->DeepSeek<!-- --> APIs. Visit the<!-- --> [OpenAI Tracing documentation](/docs/3.14.0/genai/tracing/integrations/listing/openai.md) for example code snippets for tracing streaming and async calls through OpenAI SDK.
...
![DeepSeek Tracing with Manual Tracing](/docs/3.14.0/images/llms/tracing/openai-trace-with-manual-span.png)
