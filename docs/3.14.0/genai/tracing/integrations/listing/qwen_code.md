...
![Qwen Code Tracing via the Stop hook](/docs/3.14.0/assets/images/qwen-code-tracing-e013bb0baa72ca6e8d47a1ae6332af3e.png)

[MLflow Tracing](/docs/3.14.0/genai/tracing.md) provides automatic tracing for [Qwen Code](https://github.com/QwenLM/qwen-code), Alibaba's open-source terminal-based coding agent. After setup, MLflow will automatically capture traces of your Qwen Code conversations including:
...
MLflow automatically tracks token usage for each LLM call within Qwen Code conversations. See the [Token Usage and Cost Tracking](/docs/3.14.0/genai/tracing/token-usage-cost.md) documentation for details.
