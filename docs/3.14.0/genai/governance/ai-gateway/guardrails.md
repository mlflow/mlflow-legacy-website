...
![Guardrails tab showing empty state](/docs/3.14.0/images/genai/governance/ai-gateway/guardrails-tab-empty.png)
...
![Create Guardrail modal showing type picker with Safety, PII Detection, and Custom Guardrail options](/docs/3.14.0/images/genai/governance/ai-gateway/guardrails-create-type-picker.png)
...
![Create Guardrail configuration step showing Name, Stage picker, Instructions, Guardrail Model, and Action fields](/docs/3.14.0/images/genai/governance/ai-gateway/guardrails-create-config.png)
