...
![Codex trace in MLflow](/docs/3.13.0rc0/assets/images/codex-trace-d99ee01cf96742f403c2877e724de4de.png)

### [Usage Tracking](/docs/3.13.0rc0/genai/governance/ai-gateway/usage-tracking.md)

[Monitor token usage and costs across all Codex sessions](/docs/3.13.0rc0/genai/governance/ai-gateway/usage-tracking.md)
...
[Add content policies to all Codex requests automatically](/docs/3.13.0rc0/genai/governance/ai-gateway/guardrails.md)
