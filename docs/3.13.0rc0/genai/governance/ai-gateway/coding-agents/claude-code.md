...
![Claude Code trace in MLflow](/docs/3.13.0rc0/assets/images/claude-code-trace-0403511578a90d62cfefdb34aa3cec72.png)

### [Usage Tracking](/docs/3.13.0rc0/genai/governance/ai-gateway/usage-tracking.md)

[Monitor token usage and costs across all Claude Code sessions](/docs/3.13.0rc0/genai/governance/ai-gateway/usage-tracking.md)
...
[Add content policies to all Claude Code requests automatically](/docs/3.13.0rc0/genai/governance/ai-gateway/guardrails.md)
