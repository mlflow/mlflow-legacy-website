...
![LiteLLM Proxy Tracing](/docs/3.13.0rc0/images/llms/litellm-proxy/litellm-proxy-tracing.png)

:::tip Looking for LiteLLM SDK? This guide covers the **LiteLLM Proxy Server**. If you're using the LiteLLM Python SDK directly in your application, see the [LiteLLM SDK Integration](/docs/3.13.0rc0/genai/tracing/integrations/listing/litellm.md) guide instead. :::
