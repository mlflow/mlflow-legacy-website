...
## Setting the level on a span[​](#setting-the-level-on-a-span "Direct link to Setting the level on a span")
...
## Default Log Level[​](#default-log-level "Direct link to Default Log Level")
...
### Spans with an exception event are bumped to `ERROR`[​](#spans-with-an-exception-event-are-bumped-to-error "Direct link to spans-with-an-exception-event-are-bumped-to-error")
...
* An explicit call to span.record\_exception(...)
...
## Applying Log Level Filter on UI[​](#applying-log-level-filter-on-ui "Direct link to Applying Log Level Filter on UI")
...
* [`mlflow.entities.SpanLogLevel()`](/docs/3.13.0rc0/api_reference/python_api/mlflow.entities.html#mlflow.entities.SpanLogLevel) — the level enum.
* [`mlflow.start_span()`](/docs/3.13.0rc0/api_reference/python_api/mlflow.html#mlflow.start_span) / [`mlflow.start_span_no_context()`](/docs/3.13.0rc0/api_reference/python_api/mlflow.html#mlflow.start_span_no_context) / [`mlflow.trace()`](/docs/3.13.0rc0/api_reference/python_api/mlflow.html#mlflow.trace) — public APIs that accept the `log_level` kwarg.
