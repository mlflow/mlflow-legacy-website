...
When a trace is received via the [OTLP endpoint](/docs/3.13.0rc0/genai/tracing/opentelemetry/ingest.md), MLflow runs each span through a series of translators. Each translator understands a specific set of OTel semantic conventions and maps them to MLflow span attributes.
...
For more details, see [Track Users and Sessions](/docs/3.13.0rc0/genai/tracing/track-users-sessions.md).
