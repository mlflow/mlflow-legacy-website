...
### [Evaluate tool call correctness](/docs/3.13.0rc0/genai/eval-monitor/scorers/llm-judge/tool-call/correctness.md)

[Check if tools are called with correct arguments](/docs/3.13.0rc0/genai/eval-monitor/scorers/llm-judge/tool-call/correctness.md)
...
[Create test cases for testing agent efficiency](/docs/3.13.0rc0/genai/datasets.md)
