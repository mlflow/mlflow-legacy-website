...
## When to Use GEPA[​](#when-to-use-gepa "Direct link to When to Use GEPA")
...
For simpler alignment tasks, consider using the default [MemAlign optimizer](/docs/3.13.0rc0/genai/eval-monitor/scorers/llm-judge/memalign.md).
