...
![Agent Evaluation](/docs/3.13.0rc0/images/mlflow-3/eval-monitor/agent-evaluation-hero.png)
...
Create a math agent that can use tools to answer questions. We use [OpenAI Agents](/docs/3.13.0rc0/genai/tracing/integrations/listing/openai-agent.md) to build the tool-calling agent in a few lines of code.
...
* [ToolCallCorrectness](/docs/3.13.0rc0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.ToolCallCorrectness): Evaluates if tool calls and arguments are correct for the user query
* [ToolCallEfficiency](/docs/3.13.0rc0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.ToolCallEfficiency): Evaluates if tool calls are efficient without redundancy

These scorers automatically analyze traces to assess tool usage patterns. See the [Built-in Judges](/docs/3.13.0rc0/genai/eval-monitor/scorers/llm-judge/predefined.md) guide for more details.

For custom evaluation patterns, you can create your own scorers that parse traces. See the [Custom Scorers](/docs/3.13.0rc0/genai/eval-monitor/scorers/custom.md) guide.
...
![Agent Evaluation](/docs/3.13.0rc0/images/mlflow-3/eval-monitor/agent-evaluation-result.png)
...
![Agent Evaluation](/docs/3.13.0rc0/images/mlflow-3/eval-monitor/agent-evaluation-trace.png)
...
In MLflow 2.x, you can pass the model URI directly to the `model` argument of the legacy [`mlflow.evaluate()`](/docs/3.13.0rc0/api_reference/python_api/mlflow.html#mlflow.evaluate) API (deprecated). The new evaluation API in MLflow **3.x** still supports evaluating MLflow Models, but the workflow is slightly different.
...
For complete documentation on multi-turn evaluation, see [Evaluate Conversations](/docs/3.13.0rc0/genai/eval-monitor/running-evaluation/multi-turn.md) and [Conversation Simulation](/docs/3.13.0rc0/genai/eval-monitor/running-evaluation/conversation-simulation.md).

## Next steps[​](#next-steps "Direct link to Next steps")

### [Customize Scorers](/docs/3.13.0rc0/genai/eval-monitor/scorers.md)

[Build advanced evaluation criteria and metrics specifically designed for agent behaviors and tool usage patterns.](/docs/3.13.0rc0/genai/eval-monitor/scorers.md)

[Create custom scorers →](/docs/3.13.0rc0/genai/eval-monitor/scorers.md)

### [Evaluate Production Traces](/docs/3.13.0rc0/genai/eval-monitor/running-evaluation/traces.md)

[Analyze real agent executions in production environments to understand performance and identify improvement opportunities.](/docs/3.13.0rc0/genai/eval-monitor/running-evaluation/traces.md)

[Analyze traces →](/docs/3.13.0rc0/genai/eval-monitor/running-evaluation/traces.md)

### [Evaluate Conversations](/docs/3.13.0rc0/genai/eval-monitor/running-evaluation/multi-turn.md)

[Assess multi-turn conversations with specialized scorers for dialogue quality and user satisfaction.](/docs/3.13.0rc0/genai/eval-monitor/running-evaluation/multi-turn.md)
