...
* [`mlflow.pyfunc.ResponsesAgent.create_reasoning_item()`](/docs/3.15.2/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.ResponsesAgent.create_reasoning_item)
* [`mlflow.pyfunc.ResponsesAgent.create_text_output_item()`](/docs/3.15.2/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.ResponsesAgent.create_text_output_item)
* [`mlflow.pyfunc.ResponsesAgent.create_function_call_item()`](/docs/3.15.2/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.ResponsesAgent.create_function_call_item)
* [`mlflow.pyfunc.ResponsesAgent.create_function_call_output_item()`](/docs/3.15.2/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.ResponsesAgent.create_function_call_output_item)
* [`mlflow.pyfunc.ResponsesAgent.create_text_delta()`](/docs/3.15.2/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.ResponsesAgent.create_text_delta) (only for streaming)
* [`mlflow.pyfunc.ResponsesAgent.create_annotation_added()`](/docs/3.15.2/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.ResponsesAgent.create_annotation_added) (only for streaming)
...
**Enable [tracing](/docs/3.15.2/genai/tracing.md)** for troubleshooting, if your model is traced:
