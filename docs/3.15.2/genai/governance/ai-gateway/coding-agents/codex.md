...
![Codex trace in MLflow](/docs/3.15.2/assets/images/codex-trace-d99ee01cf96742f403c2877e724de4de.png)

### [Usage Tracking](/docs/3.15.2/genai/governance/ai-gateway/usage-tracking.md)

[Monitor token usage and costs across all Codex sessions](/docs/3.15.2/genai/governance/ai-gateway/usage-tracking.md)
...
[Add content policies to all Codex requests automatically](/docs/3.15.2/genai/governance/ai-gateway/guardrails.md)
...
[Set spending limits globally or per workspace to keep sessions within budget](/docs/3.15.2/genai/governance/ai-gateway/budget-alerts-limits.md)
