...
[](/docs/3.15.2/images/eval-datasets.mp4)
...
The [`mlflow.genai.datasets.EvaluationDataset()`](/docs/3.15.2/api_reference/python_api/mlflow.genai.html#mlflow.genai.datasets.EvaluationDataset) object returned by [`mlflow.genai.datasets.create_dataset()`](/docs/3.15.2/api_reference/python_api/mlflow.genai.html#mlflow.genai.datasets.create_dataset) and [`mlflow.genai.datasets.get_dataset()`](/docs/3.15.2/api_reference/python_api/mlflow.genai.html#mlflow.genai.datasets.get_dataset) exposes the following fields:
...
Records are fetched lazily — call [`mlflow.genai.datasets.EvaluationDataset.to_df()`](/docs/3.15.2/api_reference/python_api/mlflow.genai.html#mlflow.genai.datasets.EvaluationDataset.to_df) to load them into a pandas `DataFrame`.
...
### [SDK Guide](/docs/3.15.2/genai/datasets/sdk-guide.md)

[Complete reference for creating and managing evaluation datasets via the MLflow SDK](/docs/3.15.2/genai/datasets/sdk-guide.md)

[View SDK guide →](/docs/3.15.2/genai/datasets/sdk-guide.md)

### [End-to-End Workflow](/docs/3.15.2/genai/datasets/end-to-end-workflow.md)

[Learn the complete evaluation-driven development workflow from building to production](/docs/3.15.2/genai/datasets/end-to-end-workflow.md)

[See workflow →](/docs/3.15.2/genai/datasets/end-to-end-workflow.md)

### [Expectations](/docs/3.15.2/genai/assessments/expectations.md)

[Learn how to define ground truth and quality criteria for your test cases](/docs/3.15.2/genai/assessments/expectations.md)

[Understand expectations →](/docs/3.15.2/genai/assessments/expectations.md)
