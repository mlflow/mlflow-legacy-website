...
![Codex CLI Tracing via the notify hook](/docs/3.15.2/assets/images/codex-tracing-3af27e0962dcbb7293c35a6b86adfda9.png)

[MLflow Tracing](/docs/3.15.2/genai/tracing.md) provides automatic tracing for [Codex CLI](https://github.com/openai/codex), OpenAI's terminal-based coding agent. After setup, MLflow will automatically capture traces of your Codex conversations including:
...
MLflow automatically tracks token usage for each LLM call within Codex conversations. See the [Token Usage and Cost Tracking](/docs/3.15.2/genai/tracing/token-usage-cost.md) documentation for details.
