...
Or use [Docker Compose](/docs/3.15.2/self-hosting.md#docker-compose):
...
[Search and filter traces to find specific agent sessions.](/docs/3.15.2/genai/tracing/search-traces.md)
