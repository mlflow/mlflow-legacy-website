...
![Amazon Bedrock AgentCore Logo](/docs/3.15.2/images/logos/bedrock-logo.png)
...
## Enable OpenTelemetry in Amazon Bedrock AgentCore[​](#enable-opentelemetry-in-amazon-bedrock-agentcore "Direct link to Enable OpenTelemetry in Amazon Bedrock AgentCore")
