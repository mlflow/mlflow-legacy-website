...
[](/docs/3.15.2/images/llms/tracing/openai-tracing.mp4)

[MLflow Tracing](/docs/3.15.2/genai/tracing.md) provides automatic tracing capability for OpenAI. By enabling auto tracing for OpenAI by calling the [`mlflow.openai.autolog()`](/docs/3.15.2/api_reference/python_api/mlflow.openai.html#mlflow.openai.autolog) function, MLflow will capture traces for LLM invocation and log them to the active MLflow Experiment. In Typescript, you can instead use the `tracedOpenAI` function to wrap the OpenAI client.
...
![OpenAI Tracing](/docs/3.15.2/images/llms/tracing/basic-openai-trace.png)
...
See [OpenAI Agents SDK Tracing](/docs/3.15.2/genai/tracing/integrations/listing/openai-agent.md) for more details.
...
MLflow automatically captures images and audio sent to OpenAI models. See [Multimodal Content and Attachments in Traces](/docs/3.15.2/genai/tracing/observe-with-traces/multimodal.md) for examples and supported formats.
...
![OpenAI Function Calling Trace](/docs/3.15.2/images/llms/tracing/openai-function-calling.png)
...
Refer to the [Typescript OpenAI Quickstart](/docs/3.15.2/genai/tracing/quickstart.md) for the example of function calling agent in Typescript SDK.

## Tracking Token Usage and Cost[​](#tracking-token-usage-and-cost "Direct link to Tracking Token Usage and Cost")

MLflow automatically tracks token usage and cost for OpenAI API calls. The token usage for each LLM call will be logged in each Trace/Span and the aggregated cost and time trend are displayed in the built-in dashboard. See the [Token Usage and Cost Tracking](/docs/3.15.2/genai/tracing/token-usage-cost.md) documentation for details on accessing this information programmatically.

![OpenAI Token Usage](/docs/3.15.2/images/llms/tracing/openai-token-usage.png)
