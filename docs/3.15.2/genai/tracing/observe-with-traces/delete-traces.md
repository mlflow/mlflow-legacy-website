...
You can delete traces based on specific criteria using the [`mlflow.client.MlflowClient.delete_traces()`](/docs/3.15.2/api_reference/python_api/mlflow.client.html#mlflow.client.MlflowClient.delete_traces) method. This method allows you to delete traces by **timestamp** or **trace IDs**.
...
![Delete Traces from MLflow UI](/docs/3.15.2/images/llms/tracing/trace-ui-delete.png)
