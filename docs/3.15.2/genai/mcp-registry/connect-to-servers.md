...
Use [`mlflow.genai.create_mcp_access_endpoint()`](/docs/3.15.2/api_reference/python_api/mlflow.genai.html#mlflow.genai.create_mcp_access_endpoint):
...
![Connection Instructions](/docs/3.15.2/assets/images/connection-instructions-49ffe465331494eb0fc3cecf522383b0.png)
...
When you register a server version without explicitly providing tools, MLflow connects to the first usable remote in `server_json.remotes[]` and queries the server's tool list. See [Register MCP Servers](/docs/3.15.2/genai/mcp-registry/register-mcp-servers.md#tool-auto-discovery) for details.
...
Use [`mlflow.genai.refresh_mcp_server_version_tools()`](/docs/3.15.2/api_reference/python_api/mlflow.genai.html#mlflow.genai.refresh_mcp_server_version_tools):
