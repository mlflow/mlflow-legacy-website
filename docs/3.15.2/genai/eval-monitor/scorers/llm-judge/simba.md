...
MLflow provides a prompt-optimization alignment optimizer built on [DSPy's implementation of SIMBA](https://dspy.ai/api/optimizers/SIMBA/) (Simplified Multi-Bootstrap Aggregation). Pass `SIMBAAlignmentOptimizer` to `align()` to use it instead of the [default MemAlign optimizer](/docs/3.15.2/genai/eval-monitor/scorers/llm-judge/memalign.md).
