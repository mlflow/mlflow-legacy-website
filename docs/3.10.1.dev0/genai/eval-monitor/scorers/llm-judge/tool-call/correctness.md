...
For a complete agent example with this judge, see the [Tool Call Evaluation guide](/docs/3.10.1.dev0/genai/eval-monitor/scorers/llm-judge/tool-call.md).
...
### [Evaluate tool call efficiency](/docs/3.10.1.dev0/genai/eval-monitor/scorers/llm-judge/tool-call/efficiency.md)

[Check if tool calls are efficient without redundancy](/docs/3.10.1.dev0/genai/eval-monitor/scorers/llm-judge/tool-call/efficiency.md)
...
[Learn comprehensive agent evaluation techniques](/docs/3.10.1.dev0/genai/eval-monitor/running-evaluation/agents.md)
...
[Create test cases with expected tool calls for testing](/docs/3.10.1.dev0/genai/datasets.md)
