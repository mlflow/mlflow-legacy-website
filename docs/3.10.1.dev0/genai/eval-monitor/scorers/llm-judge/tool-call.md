...
All tool call judges require MLflow Traces with at least one span marked as `span_type="TOOL"`. Use the [@mlflow.trace](/docs/3.10.1.dev0/api_reference/python_api/mlflow.html#mlflow.trace) decorator with `span_type="TOOL"` on your tool functions.
...
### [ToolCallCorrectness](/docs/3.10.1.dev0/genai/eval-monitor/scorers/llm-judge/tool-call/correctness.md)

[Evaluate if tool calls and arguments are correct](/docs/3.10.1.dev0/genai/eval-monitor/scorers/llm-judge/tool-call/correctness.md)

[Learn more →](/docs/3.10.1.dev0/genai/eval-monitor/scorers/llm-judge/tool-call/correctness.md)

### [ToolCallEfficiency](/docs/3.10.1.dev0/genai/eval-monitor/scorers/llm-judge/tool-call/efficiency.md)

[Check for redundant or unnecessary tool calls](/docs/3.10.1.dev0/genai/eval-monitor/scorers/llm-judge/tool-call/efficiency.md)

[Learn more →](/docs/3.10.1.dev0/genai/eval-monitor/scorers/llm-judge/tool-call/efficiency.md)

### [Build evaluation datasets](/docs/3.10.1.dev0/genai/datasets.md)

[Create ground truth datasets for testing agents](/docs/3.10.1.dev0/genai/datasets.md)
