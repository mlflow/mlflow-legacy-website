...
In MLflow Evaluation for GenAI, [custom code-based scorers](/docs/3.10.1.dev0/genai/eval-monitor/scorers/custom.md) allow you to define flexible evaluation metrics for your AI agent or application.
...
Use [mlflow.genai.evaluate()](/docs/3.10.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.evaluate) to generate traces from the app. Since `evaluate()` requires at least one scorer, define a placeholder scorer for this initial trace generation:
...
![Trace visualization in notebook](/docs/3.10.1.dev0/images/genai/eval-monitor/trace-visualization.png)
...
Store the generated traces in a local variable. The [`mlflow.search_traces()`](/docs/3.10.1.dev0/api_reference/python_api/mlflow.html#mlflow.search_traces) function returns a Pandas DataFrame of traces.
...
[Learn about semantic evaluation using LLM-as-a-judge metrics](/docs/3.10.1.dev0/genai/eval-monitor/scorers/llm-judge/custom-judges.md)
