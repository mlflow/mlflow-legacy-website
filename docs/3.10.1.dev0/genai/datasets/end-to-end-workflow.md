...
Start with a traced GenAI application. This example shows a customer support bot, but the pattern applies to any LLM application. You can use the [mlflow.trace decorator](/docs/3.10.1.dev0/api_reference/python_api/mlflow.html#mlflow.trace) for manual instrumentation or [enable automatic tracing for OpenAI](/docs/3.10.1.dev0/api_reference/python_api/mlflow.openai.html#mlflow.openai.autolog) as shown below.
...
Run your application with real or test scenarios to capture traces. Later, you'll use [mlflow.search\_traces()](/docs/3.10.1.dev0/api_reference/python_api/mlflow.html#mlflow.search_traces) to retrieve these traces for annotation and dataset creation.
...
Add expectations to your traces to define what you expect as a response coming from your application. Use [mlflow.log\_expectation()](/docs/3.10.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_expectation) to annotate traces with ground truth values that will serve as your evaluation baseline. You can also directly apply expectations within the UI.

![Adding Expectations in UI](/docs/3.10.1.dev0/images/add-expectation-ui.png)
...
Transform your annotated traces into a reusable evaluation dataset. Use [create\_dataset()](/docs/3.10.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.datasets.create_dataset) to initialize your dataset and [merge\_records()](/docs/3.10.1.dev0/api_reference/python_api/mlflow.entities.html#mlflow.entities.EvaluationDataset.merge_records) to add test cases from multiple sources.
...
Evaluate your application against the dataset using built-in and custom scorers. Use [mlflow.genai.evaluate()](/docs/3.10.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.evaluate) to run comprehensive evaluations with scorers like [Correctness](/docs/3.10.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.Correctness) for factual accuracy assessment. You can also create custom scorers using the [@scorer decorator](/docs/3.10.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.scorer) to evaluate domain-specific criteria.
...
[Build sophisticated scorers for complex evaluation criteria](/docs/3.10.1.dev0/genai/eval-monitor/scorers.md)

[Learn more →](/docs/3.10.1.dev0/genai/eval-monitor/scorers.md)

### [SDK Reference](/docs/3.10.1.dev0/genai/datasets/sdk-guide.md)

[Deep dive into dataset management APIs](/docs/3.10.1.dev0/genai/datasets/sdk-guide.md)

[View guide →](/docs/3.10.1.dev0/genai/datasets/sdk-guide.md)

### [Production Monitoring](/docs/3.10.1.dev0/genai/tracing/prod-tracing.md)

[Set up continuous evaluation for production](/docs/3.10.1.dev0/genai/tracing/prod-tracing.md)
