...
[MLflow Tracing](/docs/3.10.1.dev0/genai/tracing.md) provides automatic tracing capability for Anthropic LLMs. By enabling auto tracing for Anthropic by calling the [`mlflow.anthropic.autolog()`](/docs/3.10.1.dev0/api_reference/python_api/mlflow.anthropic.html#mlflow.anthropic.autolog) function, MLflow will capture nested traces and log them to the active MLflow Experiment upon invocation of Anthropic Python SDK.

![Anthropic Tracing via autolog](/docs/3.10.1.dev0/images/llms/anthropic/anthropic-tracing.png)
...
![Anthropic Tracing](/docs/3.10.1.dev0/images/llms/anthropic/anthropic-basic-tracing.png)
