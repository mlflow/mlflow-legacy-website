...
![LiveKit Agents Tracing](/docs/3.10.1.dev0/images/llms/tracing/livekit-tracing.png)

[MLflow Tracing](/docs/3.10.1.dev0/genai/tracing.md) provides automatic tracing capability for [LiveKit Agents](https://github.com/livekit/agents), an open-source framework for building real-time multimodal AI applications. MLflow supports tracing for LiveKit Agents through the [OpenTelemetry](/docs/3.10.1.dev0/genai/tracing/opentelemetry.md) integration.
...
### [Evaluate the Agent](/docs/3.10.1.dev0/genai/eval-monitor/running-evaluation/agents.md)

[Learn how to evaluate the agent's performance with LLM judges.](/docs/3.10.1.dev0/genai/eval-monitor/running-evaluation/agents.md)
...
### [Automatic Agent Optimization](/docs/3.10.1.dev0/genai/prompt-registry/optimize-prompts.md)

[Automatically optimize the agent end-to-end with state-of-the-art algorithms.](/docs/3.10.1.dev0/genai/prompt-registry/optimize-prompts.md)
