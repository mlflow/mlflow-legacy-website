...
When [MLflow authentication](/docs/3.10.1.dev0/self-hosting/security/basic-http-auth.md) is enabled, workspaces support workspace-scoped permissions that complement resource-level access control:
...
See [Workspace Permissions](/docs/3.10.1.dev0/self-hosting/workspaces/permissions.md) for details.
...
* [Getting Started](/docs/3.10.1.dev0/self-hosting/workspaces/getting-started.md) - Step-by-step guide to setting up workspaces
* [Configuration](/docs/3.10.1.dev0/self-hosting/workspaces/configuration.md) - Server configuration and startup options
* [Workspace Providers](/docs/3.10.1.dev0/self-hosting/workspaces/workspace-providers.md) - Pluggable provider architecture
* [Permissions](/docs/3.10.1.dev0/self-hosting/workspaces/permissions.md) - Workspace-scoped access control

## API Reference[​](#api-reference "Direct link to API Reference")

* [mlflow.set\_workspace()](/docs/3.10.1.dev0/api_reference/python_api/mlflow.html#mlflow.set_workspace)
* [mlflow.get\_workspace()](/docs/3.10.1.dev0/api_reference/python_api/mlflow.html#mlflow.get_workspace)
* [mlflow.list\_workspaces()](/docs/3.10.1.dev0/api_reference/python_api/mlflow.html#mlflow.list_workspaces)
