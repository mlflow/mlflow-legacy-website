...
![Experiment Overview Usage Tab](/docs/3.13.0/assets/images/overview_usage_tab-3f972858bec76adaebb876f6c93c1fd7.png)
...
* **Quality Insights**: Displays metrics computed by [scorers](/docs/3.13.0/genai/eval-monitor/scorers.md), with a dedicated chart for each assessment type
* Charts are dynamically generated based on the assessments available in your traces

![Experiment Overview Quality Tab](/docs/3.13.0/assets/images/overview_quality_tab-2b09e28d9fb24da7c01b85ac8fc912ca.png)
...
![Experiment Overview Tool Calls Tab](/docs/3.13.0/assets/images/overview_tool_calls_tab-52fa54220793d89710cde32b4cb00def.png)
...
1. Follow the [Tracing Quickstart](/docs/3.13.0/genai/tracing/quickstart.md) to log your first traces.
...
For more details, see the [migration guide](/docs/3.13.0/self-hosting/migrate-from-file-store.md).
