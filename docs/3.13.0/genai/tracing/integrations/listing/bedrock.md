...
MLflow supports automatic tracing for Amazon Bedrock, a fully managed service on AWS that provides high-performing foundations from leading AI providers such as Anthropic, Cohere, Meta, Mistral AI, and more. By enabling auto tracing for Amazon Bedrock by calling the [`mlflow.bedrock.autolog()`](/docs/3.13.0/api_reference/python_api/mlflow.bedrock.html#mlflow.bedrock.autolog) function, MLflow will capture traces for LLM invocation and log them to the active MLflow Experiment.

![Bedrock DIY Agent Tracing](/docs/3.13.0/images/llms/tracing/bedrock-tracing-agent.png)
...
![Bedrock Trace](/docs/3.13.0/images/llms/tracing/bedrock-tracing-stream.png)
...
![Bedrock Stream Tracing](/docs/3.13.0/images/llms/tracing/bedrock-tracing-stream.png)
...
![Bedrock DIY Agent Tracing](/docs/3.13.0/assets/images/bedrock-tracing-agent-cae1bcf40457074afa5bfde0b05b292e.png)
