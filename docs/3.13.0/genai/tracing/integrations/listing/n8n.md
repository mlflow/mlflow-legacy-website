...
![MLflow trace detail](/docs/3.13.0/images/llms/tracing/n8n/mlflow-trace2.png)
...
![n8n OpenAI MLflow node configuration](/docs/3.13.0/images/llms/tracing/n8n/node-example.png)

## Workflow Setup[​](#workflow-setup "Direct link to Workflow Setup")

A typical n8n workflow using this node:

![n8n workflow with MLflow tracing node](/docs/3.13.0/images/llms/tracing/n8n/workflow-example.png)

## Chat Example[​](#chat-example "Direct link to Chat Example")

Sending a chat message through n8n:

![n8n chat interaction example](/docs/3.13.0/images/llms/tracing/n8n/n8n-chat-example.png)
...
![MLflow trace overview](/docs/3.13.0/images/llms/tracing/n8n/mlflow-trace1.png)

Enable **"Group by session"** to see all turns of a conversation grouped under one session:

![MLflow chat session grouped view](/docs/3.13.0/images/llms/tracing/n8n/mlflow-chat-session-example.png)
...
* [MLflow Tracing documentation](/docs/3.13.0/genai/tracing.md)
