...
| [Guidelines Judges](/docs/3.13.0/genai/eval-monitor/scorers/llm-judge/guidelines.md)    | ❌ (Use [MLflow Prompt Registry](/docs/3.13.0/genai/prompt-registry.md) instead) |
...
When you create a judge using the [Judge Builder UI](/docs/3.13.0/genai/eval-monitor/scorers/llm-judge/custom-judges.md), it is automatically registered to the current experiment as version 1.
