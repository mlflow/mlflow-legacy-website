...
![Gemini CLI trace in MLflow](/docs/3.13.0/assets/images/gemini-cli-trace-2ad3f989b37483cb713a5f47231fd2f1.png)

### [Usage Tracking](/docs/3.13.0/genai/governance/ai-gateway/usage-tracking.md)

[Monitor token usage and costs across all Gemini CLI sessions](/docs/3.13.0/genai/governance/ai-gateway/usage-tracking.md)
...
[Add content policies to all Gemini CLI requests automatically](/docs/3.13.0/genai/governance/ai-gateway/guardrails.md)
