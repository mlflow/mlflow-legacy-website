...
### Installing Community Flavors[​](#installing-community-flavors "Direct link to Installing Community Flavors")
...
### **Sktime**[​](#sktime "Direct link to sktime")
...
### **BigML Integration**[​](#bigml-integration "Direct link to bigml-integration")
...
### **MLflow Go Backend**[​](#mlflow-go-backend "Direct link to mlflow-go-backend")
...
#### **Server Usage**[​](#server-usage "Direct link to server-usage")
...
#### **Requirements & Limitations**[​](#requirements--limitations "Direct link to requirements--limitations")

**Database Required:** The Go backend currently requires a database backend store. File-based storage is not supported.
...
**Missing Endpoints:** Help implement remaining REST API endpoints in Go **Performance Optimization:** Improve existing Go implementations **Testing:** Add test coverage for edge cases and performance scenarios **Documentation:** Improve setup and usage documentation

**Getting Started with Go:** If you're new to Go, the project maintainers have compiled learning resources to help you contribute effectively.

**Community Support:** Join the `#mlflow-go` channel on the official MLflow Slack for questions and collaboration.

### **Creating Your Own Flavor**[​](#creating-your-own-flavor "Direct link to creating-your-own-flavor")

Build custom flavors for specialized ML frameworks not covered by existing options.

#### **Flavor Structure Requirements**[​](#flavor-structure-requirements "Direct link to flavor-structure-requirements")
...
#### **Contributing New Flavors**[​](#contributing-new-flavors "Direct link to contributing-new-flavors")
