...
[Workspaces](/docs/3.13.0/self-hosting/workspaces.md) partition experiments, registered models, prompts, and artifacts across teams on a shared server. Enabling workspaces requires a SQL database backend (PostgreSQL, MySQL, or MSSQL — not a file-based store) and a `defaultArtifactRoot`.
...
See [Getting Started with Workspaces](/docs/3.13.0/self-hosting/workspaces/getting-started.md) for workspace creation and client configuration.
...
See [Basic HTTP Auth](/docs/3.13.0/self-hosting/security/basic-http-auth.md) for user and permission management.
...
* [Architecture Overview](/docs/3.13.0/self-hosting/architecture/overview.md)
* [Backend Store](/docs/3.13.0/self-hosting/architecture/backend-store.md)
* [Artifact Store](/docs/3.13.0/self-hosting/architecture/artifact-store.md)
* [Network Security](/docs/3.13.0/self-hosting/security/network.md)
* [Basic HTTP Auth](/docs/3.13.0/self-hosting/security/basic-http-auth.md)
* [Kubernetes Auth Provider](/docs/3.13.0/self-hosting/security/kubernetes.md)
