...
Currently, MLflow supports the [GEPA](https://arxiv.org/abs/2507.19457) optimization algorithm through the [`GepaPromptOptimizer`](/docs/3.9.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.optimize.GepaPromptOptimizer). GEPA iteratively refines prompts using LLM-driven reflection and automated feedback, leading to systematic and data-driven improvements.
...
| **Optimizer**          | Prompt optimizer instance (e.g., [`GepaPromptOptimizer`](/docs/3.9.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.optimize.GepaPromptOptimizer))                                                                                                                    |
...
Create an optimizer instance for the optimization algorithm. Currently only [`GepaPromptOptimizer`](/docs/3.9.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.optimize.GepaPromptOptimizer) is supported natively.
