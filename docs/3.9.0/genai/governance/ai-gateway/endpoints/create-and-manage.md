...
For endpoints that need traffic splitting or fallbacks, see [Traffic Routing & Fallbacks](/docs/3.9.0/genai/governance/ai-gateway/traffic-routing-fallbacks.md).
