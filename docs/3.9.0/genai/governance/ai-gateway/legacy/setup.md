...
[Learn how to configure providers, endpoints, and advanced settings](/docs/3.9.0/genai/governance/ai-gateway/legacy/configuration.md)
...
[Start querying endpoints with Python client and REST APIs](/docs/3.9.0/genai/governance/ai-gateway/legacy/usage.md)
