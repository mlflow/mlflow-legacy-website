...
For new deployments, we recommend using the [Gateway Guide](/docs/3.9.0/genai/governance/ai-gateway/setup.md) which provides a modern web interface for managing endpoints, API keys, and routing configurations with zero-downtime updates.
