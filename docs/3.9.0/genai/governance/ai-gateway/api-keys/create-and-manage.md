...
4. **Regular rotation**: Periodically rotate credentials for security (see [Encryption & Rotation](/docs/3.9.0/genai/governance/ai-gateway/api-keys/key-rotation.md))
