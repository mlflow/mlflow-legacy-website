...
[Configure endpoints, API keys, and advanced routing features](/docs/3.9.0/genai/governance/ai-gateway/setup.md)

[Get started →](/docs/3.9.0/genai/governance/ai-gateway/setup.md)

### [Advanced Routing](/docs/3.9.0/genai/governance/ai-gateway/routing.md)

[Configure traffic splitting and fallbacks for high availability](/docs/3.9.0/genai/governance/ai-gateway/routing.md)

[Learn routing →](/docs/3.9.0/genai/governance/ai-gateway/routing.md)

### [Query Guide](/docs/3.9.0/genai/governance/ai-gateway/query.md)

[Learn how to call endpoints with unified and passthrough APIs](/docs/3.9.0/genai/governance/ai-gateway/query.md)

[View query guide →](/docs/3.9.0/genai/governance/ai-gateway/query.md)
