...
[](/docs/3.9.0/images/llms/tracing/openai-tracing.mp4)

[MLflow Tracing](/docs/3.9.0/genai/tracing.md) provides automatic tracing capability for OpenAI. By enabling auto tracing for OpenAI by calling the [`mlflow.openai.autolog()`](/docs/3.9.0/api_reference/python_api/mlflow.openai.html#mlflow.openai.autolog) function, MLflow will capture traces for LLM invocation and log them to the active MLflow Experiment. In Typescript, you can instead use the `tracedOpenAI` function to wrap the OpenAI client.
...
![OpenAI Tracing](/docs/3.9.0/images/llms/tracing/basic-openai-trace.png)
...
See [OpenAI Agents SDK Tracing](/docs/3.9.0/genai/tracing/integrations/listing/openai-agent.md) for more details.
...
![OpenAI Function Calling Trace](/docs/3.9.0/images/llms/tracing/openai-function-calling.png)
...
Refer to the [Typescript OpenAI Quickstart](/docs/3.9.0/genai/tracing/quickstart.md) for the example of function calling agent in Typescript SDK.
...
![OpenAI Token Usage](/docs/3.9.0/images/llms/tracing/openai-token-usage.png)
