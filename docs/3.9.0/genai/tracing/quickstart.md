...
Need help setting up tracing? Try [MLflow Assistant](/docs/3.9.0/genai/getting-started/try-assistant.md) - a powerful AI assistant that can add MLflow tracing to your project automatically.
...
For more details on tracking users and sessions, see the [Track Users & Sessions guide](/docs/3.9.0/genai/tracing/track-users-sessions.md).
