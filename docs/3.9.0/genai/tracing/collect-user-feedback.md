...
[](/docs/3.9.0/images/llms/tracing/logging-feedback.mp4)

## Adding Feedback with API[​](#adding-feedback-with-api "Direct link to Adding Feedback with API")

To annotate traces with feedback programmatically, use the [`mlflow.log_feedback()`](/docs/3.9.0/api_reference/python_api/mlflow.html#mlflow.log_feedback) API.
...
If you have a `Feedback` object already (e.g., a response from LLM-as-a-Judge), you can log it directly using the [`mlflow.log_assessment()`](/docs/3.9.0/api_reference/python_api/mlflow.html#mlflow.log_assessment) API. This is equivalent to using the

[`mlflow.log_feedback()`](/docs/3.9.0/api_reference/python_api/mlflow.html#mlflow.log_feedback) API with unpacked fields.
...
### [Feedback Concepts](/docs/3.9.0/genai/concepts/feedback.md)

[Deep dive into feedback architecture, schema, and best practices](/docs/3.9.0/genai/concepts/feedback.md)

[Learn concepts →](/docs/3.9.0/genai/concepts/feedback.md)

### [Search and Analyze Traces](/docs/3.9.0/genai/tracing/search-traces.md)

[Query traces with feedback data and analyze patterns for quality insights](/docs/3.9.0/genai/tracing/search-traces.md)

[Start analyzing →](/docs/3.9.0/genai/tracing/search-traces.md)

### [Evaluate Traces](/docs/3.9.0/genai/eval-monitor.md)

[Learn how to evaluate traces with feedback data and analyze patterns for quality insights](/docs/3.9.0/genai/eval-monitor.md)
