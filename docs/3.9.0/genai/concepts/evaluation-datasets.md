...
The [`mlflow.entities.EvaluationDataset()`](/docs/3.9.0/api_reference/python_api/mlflow.entities.html#mlflow.entities.EvaluationDataset) object contains the following fields:
...
[Complete reference for creating and managing evaluation datasets via the MLflow SDK](/docs/3.9.0/genai/datasets/sdk-guide.md)
...
[Learn the complete evaluation-driven development workflow from building to production](/docs/3.9.0/genai/datasets/end-to-end-workflow.md)

[See workflow →](/docs/3.9.0/genai/datasets/end-to-end-workflow.md)

### [Expectations](/docs/3.9.0/genai/assessments/expectations.md)

[Learn how to define ground truth and quality criteria for your test cases](/docs/3.9.0/genai/assessments/expectations.md)

[Understand expectations →](/docs/3.9.0/genai/assessments/expectations.md)
