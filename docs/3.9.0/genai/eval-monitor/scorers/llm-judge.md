...
The fastest way to create LLM judges is through the **Judge Builder UI** - no code required. Navigate to your experiment's **Judges** tab to create and test judges visually. See the [Template-based Scorers](/docs/3.9.0/genai/eval-monitor/scorers/llm-judge/make-judge.md) page for details. Requires MLflow >= 3.9.0.
...
[Template-based Scorers](/docs/3.9.0/genai/eval-monitor/scorers/llm-judge/make-judge.md)

[Simplicity: ★★★☆☆    Control: ★★★★☆](/docs/3.9.0/genai/eval-monitor/scorers/llm-judge/make-judge.md)
...
[AI Gateway](/docs/3.9.0/genai/governance/ai-gateway.md) endpoints are the recommended way to configure judge models, especially when creating judges from the UI. Benefits include:
