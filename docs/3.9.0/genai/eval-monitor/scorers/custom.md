...
To define a custom scorer, you can define a function that takes in the [input arguments](#input-format) and add the [@scorer](/docs/3.9.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.scorer) decorator to the function.
...
To return richer information beyond primitive values, you can return a [Feedback](/docs/3.9.0/api_reference/python_api/mlflow.entities.html#mlflow.entities.Feedback) object.
...
Then you can pass the functions directly to the [mlflow.genai.evaluate](/docs/3.9.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.evaluate) function, just like other predefined or LLM-based scorers.
...
![Code-based Scorers](/docs/3.9.0/images/mlflow-3/eval-monitor/scorers/code-scorers-results.png)
...
* The complete [MLflow trace](/docs/3.9.0/genai/concepts/trace.md), including spans, attributes, and outputs.
...
When running `mlflow.genai.evaluate()`, the inputs, outputs, and expectations parameters can be specified in the data argument, or parsed from the trace. See [How Scorers Work](/docs/3.9.0/genai/eval-monitor/scorers.md#how-scorers-work) for more details.
...
Return [Feedback](/docs/3.9.0/api_reference/python_api/mlflow.entities.html#mlflow.entities.Feedback) objects for detailed assessments with additional metadata such as explanation, source info, and error summary.
...
When an exception occurs, MLflow creates a [Feedback](/docs/3.9.0/api_reference/python_api/mlflow.entities.html#mlflow.entities.Feedback) with:
...
![Scorer Error](/docs/3.9.0/images/mlflow-3/eval-monitor/scorers/scorer-error.png)

### Handle exceptions explicitly[​](#handle-exceptions-explicitly "Direct link to Handle exceptions explicitly")

For custom error handling or to provide specific error messages, catch exceptions and return a [Feedback](/docs/3.9.0/api_reference/python_api/mlflow.entities.html#mlflow.entities.Feedback) with None value and error details:
...
### [Ground Truth Expectations](/docs/3.9.0/genai/assessments/expectations.md)

[Learn how to define and manage ground truth data for accurate evaluations](/docs/3.9.0/genai/assessments/expectations.md)

[Learn more →](/docs/3.9.0/genai/assessments/expectations.md)
