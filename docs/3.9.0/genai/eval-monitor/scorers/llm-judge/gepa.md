...
See [make\_judge documentation](/docs/3.9.0/genai/eval-monitor/scorers/llm-judge/make-judge.md) for details on creating judges.
...
For simpler alignment tasks, consider using the default [SIMBA optimizer](/docs/3.9.0/genai/eval-monitor/scorers/llm-judge/simba.md).
