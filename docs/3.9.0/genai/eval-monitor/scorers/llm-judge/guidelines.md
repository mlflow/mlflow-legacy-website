...
[Guidelines](/docs/3.9.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.Guidelines) is a powerful scorer class designed to let you quickly and easily customize evaluation by defining natural language criteria that are framed as pass/fail conditions. It is ideal for checking compliance with rules, style guides, or information inclusion/exclusion.
...
![Guidelines scorers result](/docs/3.9.0/images/mlflow-3/eval-monitor/scorers/guideline-scorers-results.png)
