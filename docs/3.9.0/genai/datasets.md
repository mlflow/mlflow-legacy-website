...
[](/docs/3.9.0/images/eval-datasets.mp4)
...
Source types are automatically inferred based on record characteristics but can be explicitly overridden when needed. See the [SDK Guide](/docs/3.9.0/genai/datasets/sdk-guide.md#source-type-inference) for detailed inference rules and examples.
...
### [Dataset Structure](/docs/3.9.0/genai/concepts/evaluation-datasets.md)

[Understand how evaluation datasets organize test inputs, expectations, and metadata](/docs/3.9.0/genai/concepts/evaluation-datasets.md)

[Learn the concepts →](/docs/3.9.0/genai/concepts/evaluation-datasets.md)

### [SDK Guide](/docs/3.9.0/genai/datasets/sdk-guide.md)

[Complete guide to creating and managing evaluation datasets programmatically](/docs/3.9.0/genai/datasets/sdk-guide.md)

[View SDK guide →](/docs/3.9.0/genai/datasets/sdk-guide.md)

### [Setting Expectations](/docs/3.9.0/genai/assessments/expectations.md)

[Learn how to define ground truth and expected outputs for your AI system](/docs/3.9.0/genai/assessments/expectations.md)

[Define expectations →](/docs/3.9.0/genai/assessments/expectations.md)

### [Tracing Guide](/docs/3.9.0/genai/tracing.md)

[Capture detailed execution data from your GenAI applications](/docs/3.9.0/genai/tracing.md)

[Start tracing →](/docs/3.9.0/genai/tracing.md)

### [Evaluation Framework](/docs/3.9.0/genai/eval-monitor.md)

[Run systematic evaluations using your datasets with automated scorers](/docs/3.9.0/genai/eval-monitor.md)

[Learn evaluation →](/docs/3.9.0/genai/eval-monitor.md)
