...
Need help setting up MLflow? Try [MLflow Assistant](/docs/3.9.0/genai/getting-started/try-assistant.md) - a powerful AI assistant that can help you set up MLflow for your project.
...
MLflow supports different backends for tracking your experiment data. Choose one of the following options to get started. Refer to the [Self Hosting Guide](/docs/3.9.0/self-hosting.md) for detailed setup and configurations.
...
Start a remote MLflow tracking server following the [Self Hosting Guide](/docs/3.9.0/self-hosting.md). Then configure your client to use the remote server:
...
Creating a Databricks Notebook will create an MLflow Experiment that is the container for your ML projects. Learn more about Experiments in the [MLflow documentation](/docs/3.9.0/ml/tracking.md).
