...
Reference for the core flags, env vars, and startup checks for workspace mode. For setup and end-to-end flows, see [Getting Started](/docs/3.12.1.dev0/self-hosting/workspaces/getting-started.md). For provider details and artifact routing options, see [Workspace Providers](/docs/3.12.1.dev0/self-hosting/workspaces/workspace-providers.md).
...
When using workspaces with basic-auth (`--app-name basic-auth`), additional settings in the [auth config file](/docs/3.12.1.dev0/self-hosting/security/basic-http-auth.md#configuration) (`basic_auth.ini`) control workspace-level permission behavior.
...
* [Getting Started](/docs/3.12.1.dev0/self-hosting/workspaces/getting-started.md) - Step-by-step enablement
* [Workspace Providers](/docs/3.12.1.dev0/self-hosting/workspaces/workspace-providers.md) - Provider selection and artifact routing
* [Permissions](/docs/3.12.1.dev0/self-hosting/workspaces/permissions.md) - Configure access control
* [Troubleshooting](/docs/3.12.1.dev0/self-hosting/troubleshooting.md) - Common issues and fixes
