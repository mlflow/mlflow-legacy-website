...
Workspace-scoped permissions provide convenient access control for all resources within a workspace when [authentication](/docs/3.12.1.dev0/self-hosting/security/basic-http-auth.md) is enabled.
...
## How Workspace Permissions Work[​](#how-workspace-permissions-work "Direct link to How Workspace Permissions Work")
...
### Permission Resolution Order[​](#permission-resolution-order "Direct link to Permission Resolution Order")
...
## Managing Workspace Permissions[​](#managing-workspace-permissions "Direct link to Managing Workspace Permissions")
...
### Permission Delegation[​](#permission-delegation "Direct link to Permission Delegation")
...
### Using AuthServiceClient[​](#using-authserviceclient "Direct link to Using AuthServiceClient")
...
### Grant Workspace Permission[​](#grant-workspace-permission "Direct link to Grant Workspace Permission")
...
### List Workspace Permissions[​](#list-workspace-permissions "Direct link to List Workspace Permissions")
...
### Revoke Workspace Permission[​](#revoke-workspace-permission "Direct link to Revoke Workspace Permission")
...
## Workspace Visibility in list\_workspaces()[​](#workspace-visibility-in-list_workspaces "Direct link to Workspace Visibility in list_workspaces()")
...
### Workspace Not Visible in list\_workspaces()[​](#workspace-not-visible-in-list_workspaces "Direct link to Workspace Not Visible in list_workspaces()")
...
* [Configuration](/docs/3.12.1.dev0/self-hosting/workspaces/configuration.md) - Server configuration options
* [Workspace Providers](/docs/3.12.1.dev0/self-hosting/workspaces/workspace-providers.md) - Implement custom providers
* [Authentication](/docs/3.12.1.dev0/self-hosting/security/basic-http-auth.md) - Set up MLflow authentication
