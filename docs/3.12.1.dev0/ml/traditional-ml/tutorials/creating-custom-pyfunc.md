...
MLflow offers a wide range of pre-defined model flavors, but there are instances where you'd want to go beyond these and craft something tailored to your needs. That's where custom PyFuncs come in handy.
...
* [Models, Flavors, and PyFuncs in MLflow](/docs/3.12.1.dev0/ml/traditional-ml/tutorials/creating-custom-pyfunc/part1-named-flavors.md)
* [Understanding Pyfunc Components](/docs/3.12.1.dev0/ml/traditional-ml/tutorials/creating-custom-pyfunc/part2-pyfunc-components.md)
* [Full Notebooks](/docs/3.12.1.dev0/ml/traditional-ml/tutorials/creating-custom-pyfunc/notebooks.md)
