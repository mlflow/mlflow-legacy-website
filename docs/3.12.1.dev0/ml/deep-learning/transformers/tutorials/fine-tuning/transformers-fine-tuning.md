...
### Model Configuration and Input Example[​](#model-configuration-and-input-example "Direct link to Model Configuration and Input Example")
...
#### Defining the Input Example[​](#defining-the-input-example "Direct link to Defining the Input Example")
