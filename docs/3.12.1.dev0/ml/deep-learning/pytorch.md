...
[](/docs/3.12.1.dev0/images/deep-learning/dl-training-ui.mp4)
...
You can customize system metrics collection frequency and behavior. See the **[System Metrics documentation](/docs/3.12.1.dev0/ml/tracking/system-metrics.md)** for detailed configuration options.
...
def train_distributed():
    ...
    sampler = DistributedSampler(train_dataset, num_replicas=dist.get_world_size(), rank=rank)
...
[Version and manage PyTorch models](/docs/3.12.1.dev0/ml/model-registry.md)
