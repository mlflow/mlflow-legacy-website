...
## Deploying Model to Modal[​](#deploying-model-to-modal "Direct link to Deploying Model to Modal")

This section outlines the process of deploying a model to Modal using the MLflow deployment plugin. For Python API references and tutorials, see the [Useful links](#deployment-modal-references) section.
...
Before deploying, you must have an MLflow Model. If you don't have one, you can create a sample scikit-learn model by following the [MLflow Tracking Quickstart](/docs/3.12.1.dev0/ml/getting-started.md). Remember to note down the model URI, such as `runs:/<run_id>/model` (or `models:/<model_name>/<model_version>` if you registered the model in the [MLflow Model Registry](/docs/3.12.1.dev0/ml/model-registry.md)).
...
### Step 2: Deploy to Modal[​](#step-2-deploy-to-modal "Direct link to Step 2: Deploy to Modal")
...
### Step 3: Make Predictions[​](#step-3-make-predictions "Direct link to Step 3: Make Predictions")
...
### GPU Selection[​](#gpu-selection "Direct link to GPU Selection")

Modal supports a wide range of GPU types for different workloads. See [Modal's GPU documentation](https://modal.com/docs/guide/gpu) for the full list of available GPUs and configuration options.
...
### High-Throughput Deployment[​](#high-throughput-deployment "Direct link to High-Throughput Deployment")
...
### Deploy to Specific Workspace[​](#deploy-to-specific-workspace "Direct link to Deploy to Specific Workspace")
...
### Modal Authentication Fails[​](#modal-authentication-fails "Direct link to Modal Authentication Fails")
...
### Deployment Times Out[​](#deployment-times-out "Direct link to Deployment Times Out")
...
### View Build Logs[​](#view-build-logs "Direct link to View Build Logs")
...
* [CLI Reference](/docs/3.12.1.dev0/api_reference/cli.html#mlflow-deployments)
* [Python API Documentation](/docs/3.12.1.dev0/api_reference/python_api/mlflow.deployments.html#mlflow.deployments)
...
* [MLflow Model Format](/docs/3.12.1.dev0/ml/model.md) - Understanding MLflow model packaging and flavors.
