"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([["4584"],{21527:function(e,t,n){n.r(t),n.d(t,{metadata:()=>i,default:()=>g,frontMatter:()=>c,contentTitle:()=>u,toc:()=>p,assets:()=>h});var i=JSON.parse('{"id":"model/notebooks/signature_examples-ipynb","title":"MLflow Signature Playground Notebook","description":"Download this notebook","source":"@site/docs/classic-ml/model/notebooks/signature_examples-ipynb.mdx","sourceDirName":"model/notebooks","slug":"/model/notebooks/signature_examples","permalink":"/docs/3.12.1.dev0/ml/model/notebooks/signature_examples","draft":false,"unlisted":false,"editUrl":"https://github.com/mlflow/mlflow/edit/master/docs/docs/classic-ml/model/notebooks/signature_examples.ipynb","tags":[],"version":"current","frontMatter":{"custom_edit_url":"https://github.com/mlflow/mlflow/edit/master/docs/docs/classic-ml/model/notebooks/signature_examples.ipynb","slug":"signature_examples"},"sidebar":"classicMLSidebar","previous":{"title":"Custom Python Model","permalink":"/docs/3.12.1.dev0/ml/model/python_model"},"next":{"title":"Community-Managed Model Integrations","permalink":"/docs/3.12.1.dev0/ml/community-model-flavors/"}}'),a=n(74848),r=n(28453),s=n(75940),o=n(75453),d=n(66354),l=n(42676);let c={custom_edit_url:"https://github.com/mlflow/mlflow/edit/master/docs/docs/classic-ml/model/notebooks/signature_examples.ipynb",slug:"signature_examples"},u="MLflow Signature Playground Notebook",h={},p=[{value:"Why Model Signatures Matter",id:"why-model-signatures-matter",level:3},{value:"Signature Enforcement in Action",id:"signature-enforcement-in-action",level:3},{value:"Practical Examples for a Deeper Understanding",id:"practical-examples-for-a-deeper-understanding",level:3},{value:"Scalar Support in MLflow Signatures",id:"scalar-support-in-mlflow-signatures",level:3},{value:"Understanding Type Conversion: Int to Long",id:"understanding-type-conversion-int-to-long",level:3},{value:"Why Integers are Inferred as Long",id:"why-integers-are-inferred-as-long",level:4},{value:"Signature Enforcement",id:"signature-enforcement",level:3},{value:"Updating Signatures",id:"updating-signatures",level:3},{value:"The Necessity of Schema Enforcement in MLflow",id:"the-necessity-of-schema-enforcement-in-mlflow",level:3},{value:"Why Schema Enforcement Matters",id:"why-schema-enforcement-matters",level:4},{value:"Updating Model Signature for Clearer Error Messages",id:"updating-model-signature-for-clearer-error-messages",level:4},{value:"Validating that schema enforcement will not permit a flawed input",id:"validating-that-schema-enforcement-will-not-permit-a-flawed-input",level:4},{value:"Wrapping Up: Insights and Best Practices from the MLflow Signature Playground",id:"wrapping-up-insights-and-best-practices-from-the-mlflow-signature-playground",level:3}];function m(e){let t={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h3:"h3",h4:"h4",header:"header",li:"li",p:"p",strong:"strong",ul:"ul",...(0,r.R)(),...e.components};return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(t.header,{children:(0,a.jsx)(t.h1,{id:"mlflow-signature-playground-notebook",children:"MLflow Signature Playground Notebook"})}),"\n",(0,a.jsxs)(t.p,{children:[(0,a.jsx)(l.O,{href:"https://raw.githubusercontent.com/mlflow/mlflow/master/docs/docs/classic-ml/model/notebooks/signature_examples.ipynb",children:"Download this notebook"}),"\nWelcome to the MLflow Signature Playground! This interactive Jupyter notebook is designed to guide you through the foundational concepts of ",(0,a.jsx)(t.a,{href:"https://mlflow.org/docs/latest/ml/model/signatures.html",children:"Model Signatures"})," within the MLflow ecosystem. As you progress through the notebook, you'll gain practical experience with defining, enforcing, and utilizing model signatures\u2014a critical aspect of model management that enhances reproducibility, reliability, and ease of use."]}),"\n",(0,a.jsx)(t.h3,{id:"why-model-signatures-matter",children:"Why Model Signatures Matter"}),"\n",(0,a.jsx)(t.p,{children:"In the realm of machine learning, defining the inputs and outputs of models with precision is key to ensuring smooth operations. Model signatures serve as the schema definition for the data your model expects and produces, acting as a blueprint for both model developers and users. This not only clarifies expectations but also facilitates automatic validation checks, streamlining the process from model training to deployment."}),"\n",(0,a.jsx)(t.h3,{id:"signature-enforcement-in-action",children:"Signature Enforcement in Action"}),"\n",(0,a.jsx)(t.p,{children:"By exploring the code cells in this notebook, you'll witness firsthand how model signatures can enforce data integrity, prevent common errors, and provide descriptive feedback when discrepancies occur. This is invaluable for maintaining the quality and consistency of model inputs, especially when models are served in production environments."}),"\n",(0,a.jsx)(t.h3,{id:"practical-examples-for-a-deeper-understanding",children:"Practical Examples for a Deeper Understanding"}),"\n",(0,a.jsx)(t.p,{children:"The notebook includes a range of examples showcasing different data types and structures, from simple scalars to complex nested dictionaries. These examples demonstrate how signatures are inferred, logged, and updated, providing you with a comprehensive understanding of the signature lifecycle.\nAs you interact with the provided PythonModel instances and invoke their predict methods, you'll learn how to handle various input scenarios\u2014accounting for both required and optional data fields\u2014and how to update existing models to include detailed signatures.\nWhether you're a data scientist looking to refine your model management practices or a developer integrating MLflow into your workflow, this notebook is your sandbox for mastering model signatures. Let's dive in and explore the robust capabilities of MLflow signatures!"}),"\n",(0,a.jsxs)(t.blockquote,{children:["\n",(0,a.jsxs)(t.p,{children:["NOTE: Several of the features shown in this notebook are only available in version 2.10.0 and higher of MLflow. In particular, the support for the ",(0,a.jsx)(t.code,{children:"Array"})," and ",(0,a.jsx)(t.code,{children:"Object"})," types are not available prior to version 2.10.0."]}),"\n"]}),"\n",(0,a.jsx)(s.d,{executionCount:1,children:`import numpy as np
import pandas as pd
...
None
params: 
None`}),"\n",(0,a.jsx)(t.h3,{id:"understanding-type-conversion-int-to-long",children:"Understanding Type Conversion: Int to Long"}),"\n",(0,a.jsxs)(t.p,{children:["In this section of the tutorial, we observe an interesting aspect of type conversion in MLflow's schema inference. When reporting the signature information for a list of integers, you might notice that the inferred data type is ",(0,a.jsx)(t.code,{children:"long"})," instead of ",(0,a.jsx)(t.code,{children:"int"}),". This conversion from int to long is not an error or bug but a valid and intentional type conversion within MLflow's schema inference mechanism."]}),"\n",(0,a.jsx)(t.h4,{id:"why-integers-are-inferred-as-long",children:"Why Integers are Inferred as Long"}),"\n",(0,a.jsxs)(t.ul,{children:["\n",(0,a.jsxs)(t.li,{children:[(0,a.jsx)(t.strong,{children:"Broader Compatibility:"})," The conversion to ",(0,a.jsx)(t.code,{children:"long"})," ensures compatibility across various platforms and systems. Since the size of an integer (int) can vary depending on the system architecture, using ",(0,a.jsx)(t.code,{children:"long"})," (which has a more consistent size specification) avoids potential discrepancies and data overflow issues."]}),"\n",(0,a.jsxs)(t.li,{children:[(0,a.jsx)(t.strong,{children:"Data Integrity:"})," By inferring integers as long, MLflow ensures that larger integer values, which might exceed the typical capacity of an int, are accurately represented and handled without data loss or overflow."]}),"\n",(0,a.jsxs)(t.li,{children:[(0,a.jsx)(t.strong,{children:"Consistency in Machine Learning Models:"})," In many machine learning frameworks, especially those involving larger datasets or computations, long integers are often the standard data type for numerical operations. This standardization in the inferred schema aligns with common practices in the machine learning community."]}),"\n"]}),"\n",(0,a.jsx)(s.d,{executionCount:8,children:`# List of integers
...
</div>`}})}),"\n",(0,a.jsxs)(t.p,{children:["We can check the inferred signature directly from the logged model information that is returned from the call to ",(0,a.jsx)(t.code,{children:"log_model()"})]}),"\n",(0,a.jsx)(s.d,{executionCount:16,children:"model_info.signature"}),"\n",(0,a.jsx)(o.p,{children:`inputs: 
['a': Array(string) (required), 'b': string (optional), 'c': {d: string (required), e: string (optional)} (required)]
outputs: 
['a': Array(string) (required), 'b': string (optional), 'c': {d: string (required), e: string (optional)} (required)]
params: 
None`}),"\n",(0,a.jsx)(t.p,{children:"We can also quickly verify that the logged input signature matches the signature inference. While we're at it, we can generate the output signature as well."}),"\n",(0,a.jsxs)(t.blockquote,{children:["\n",(0,a.jsx)(t.p,{children:"NOTE: it is recommended to log both the input and output signatures with your models."}),"\n"]}),"\n",(0,a.jsx)(s.d,{executionCount:17,children:"report_signature_info(data, prediction)"}),"\n",(0,a.jsx)(o.p,{children:`
The input data: 
[{'a': ['a', 'b', 'c'], 'b': 'b', 'c': {'d': 'd'}}, {'a': ['a'], 'c': {'d': 'd', 'e': 'e'}}].
The data is of type: <class 'list'>.
The inferred signature is:
...
--> 473                 raise MlflowException.invalid_parameter_value(
  ...
  475                     f"with schema '{input_schema}'. "`}),"\n",(0,a.jsx)(o.p,{isStderr:!0,children:"MlflowException: Failed to enforce schema of data '[{'b': 'b'}]' with schema '['a': Array(string) (required), 'b': string (optional), 'c': {d: string (required), e: string (optional)} (required)]'. Error: Model is missing inputs ['a', 'c']."}),"\n",(0,a.jsx)(t.h3,{id:"updating-signatures",children:"Updating Signatures"}),"\n",(0,a.jsx)(t.p,{children:"This section of the tutorial addresses the dynamic nature of data and models, focusing on the crucial task of updating an MLflow model's signature. As datasets evolve and requirements change, it becomes necessary to modify the signature of a model to align with the new data structure or inputs. This ability to update a signature is key to maintaining the accuracy and relevance of your model over time."}),"\n",(0,a.jsx)(t.p,{children:"We will demonstrate how to identify when a signature update is needed and walk through the process of creating and applying a new signature to an existing model. This section highlights the flexibility of MLflow in accommodating changes in data formats and structures without the need to re-save the entire model. However, for registered models in MLflow, updating the signature requires re-registering the model to reflect the changes in the registered version."}),"\n",(0,a.jsx)(t.p,{children:"By exploring the steps to update a model's signature, you will learn how to update the model signature in the event that you manually defined a signature that is invalid or if you failed to define one while logging and need to update the model with a valid signature."}),"\n",(0,a.jsx)(s.d,{executionCount:20,children:`# Updating an existing model that wasn't saved with a signature
...
[{'a': 'we are expecting strings', 'b': 'and only strings'}, [1, 2, 3]]`}),"\n",(0,a.jsx)(o.p,{children:"'Input is valid.'"}),"\n",(0,a.jsx)(t.h3,{id:"the-necessity-of-schema-enforcement-in-mlflow",children:"The Necessity of Schema Enforcement in MLflow"}),"\n",(0,a.jsx)(t.p,{children:"In this part of the tutorial, we address a common challenge in machine learning model deployment: the clarity and interpretability of error messages. Without schema enforcement, models can often return cryptic or misleading error messages. This occurs because, in the absence of a well-defined schema, the model attempts to process inputs that may not align with its expectations, leading to ambiguous or hard-to-diagnose errors."}),"\n",(0,a.jsx)(t.h4,{id:"why-schema-enforcement-matters",children:"Why Schema Enforcement Matters"}),"\n",(0,a.jsx)(t.p,{children:"Schema enforcement acts as a gatekeeper, ensuring that the data fed into a model precisely matches the expected format. This not only reduces the likelihood of runtime errors but also makes any errors that do occur much easier to understand and rectify. Without such enforcement, diagnosing issues becomes a time-consuming and complex task, often requiring deep dives into the model's internal logic."}),"\n",(0,a.jsx)(t.h4,{id:"updating-model-signature-for-clearer-error-messages",children:"Updating Model Signature for Clearer Error Messages"}),"\n",(0,a.jsxs)(t.p,{children:["To illustrate the value of schema enforcement, we will update the signature of a saved model to match an expected data structure. This process involves defining the expected data structure, using the ",(0,a.jsx)(t.code,{children:"infer_signature"})," function to generate the appropriate signature, and then applying this signature to the model using ",(0,a.jsx)(t.code,{children:"set_signature"}),". By doing so, we ensure that any future errors are more informative and aligned with the data structure we anticipate, simplifying troubleshooting and enhancing model reliability."]}),"\n",(0,a.jsx)(s.d,{executionCount:22,children:`expected_data_structure = [{"a": "string", "b": "another string"}, {"a": "string"}]
...
1  string             NaN`}),"\n",(0,a.jsx)(o.p,{children:"'Input is valid.'"}),"\n",(0,a.jsx)(t.h4,{id:"validating-that-schema-enforcement-will-not-permit-a-flawed-input",children:"Validating that schema enforcement will not permit a flawed input"}),"\n",(0,a.jsx)(t.p,{children:"Now that we've set our signature correctly and updated the model definition, let's ensure that the previous flawed input type will raise a useful error message!"}),"\n",(0,a.jsx)(s.d,{executionCount:25,children:"loaded_with_signature.predict(test_data)"}),"\n",(0,a.jsx)(o.p,{isStderr:!0,children:"---------------------------------------------------------------------------"}),"\n",(0,a.jsx)(o.p,{isStderr:!0,children:"AttributeError                            Traceback (most recent call last)"}),"\n",(0,a.jsx)(o.p,{isStderr:!0,children:`~/repos/mlflow-fork/mlflow/mlflow/pyfunc/__init__.py in predict(self, data, params)
  469             try:
--> 470                 data = _enforce_schema(data, input_schema)
  471             except Exception as e:`}),"\n",(0,a.jsx)(o.p,{isStderr:!0,children:`~/repos/mlflow-fork/mlflow/mlflow/models/utils.py in _enforce_schema(pf_input, input_schema)
...
--> 473                 raise MlflowException.invalid_parameter_value(
  474                     f"Failed to enforce schema of data '{data}' "
  475                     f"with schema '{input_schema}'. "`}),"\n",(0,a.jsx)(o.p,{isStderr:!0,children:"MlflowException: Failed to enforce schema of data '[{'a': 'we are expecting strings', 'b': 'and only strings'}, [1, 2, 3]]' with schema '['a': string (required), 'b': string (optional)]'. Error: 'list' object has no attribute 'keys'"}),"\n",(0,a.jsx)(t.h3,{id:""}),"\n",(0,a.jsx)(t.h3,{id:"wrapping-up-insights-and-best-practices-from-the-mlflow-signature-playground",children:"Wrapping Up: Insights and Best Practices from the MLflow Signature Playground"}),"\n",(0,a.jsx)(t.p,{children:"As we conclude our journey through the MLflow Signature Playground Notebook, we've gained invaluable insights into the intricacies of model signatures within the MLflow ecosystem. This tutorial has equipped you with the knowledge and practical skills needed to effectively manage and utilize model signatures, ensuring the robustness and accuracy of your machine learning models."}),"\n",(0,a.jsx)(t.p,{children:"Key takeaways include the importance of accurately defining scalar types, the significance of enforcing and adhering to model signatures for data integrity, and the flexibility offered by MLflow in updating an invalid model signature. These concepts are not just theoretical but are fundamental to successful model deployment and management in real-world scenarios."}),"\n",(0,a.jsx)(t.p,{children:"Whether you're a data scientist refining your models or a developer integrating machine learning into your applications, understanding and utilizing model signatures is crucial. We hope this tutorial has provided you with a solid foundation in MLflow signatures, empowering you to implement these best practices in your future ML projects."})]})}function g(e={}){let{wrapper:t}={...(0,r.R)(),...e.components};return t?(0,a.jsx)(t,{...e,children:(0,a.jsx)(m,{...e})}):m(e)}},75453:function(e,t,n){n.d(t,{p:()=>a});var i=n(74848);let a=({children:e,isStderr:t})=>(0,i.jsx)("pre",{style:{margin:0,borderRadius:0,background:"none",fontSize:"0.85rem",flexGrow:1,padding:"var(--padding-sm)"},children:e})},75940:function(e,t,n){n.d(t,{d:()=>r});var i=n(74848),a=n(37449);let r=({children:e,executionCount:t})=>(0,i.jsx)("div",{style:{flexGrow:1,minWidth:0,marginTop:"var(--padding-md)",width:"100%"},children:(0,i.jsx)(a.A,{className:"codeBlock_oJcR",language:"python",children:e})})},42676:function(e,t,n){n.d(t,{O:()=>s});var i=n(74848),a=n(96540);let r="3.12.1.dev0";function s({children:e,href:t}){let n=(0,a.useCallback)(async e=>{if(e.preventDefault(),window.gtag)try{window.gtag("event","notebook-download",{href:t})}catch{}r.includes("dev")||(t=t.replace(/\/master\//,`/v${r}/`));let n=await fetch(t),i=await n.blob(),a=window.URL.createObjectURL(i),s=document.createElement("a");s.style.display="none",s.href=a,s.download=t.split("/").pop(),document.body.appendChild(s),s.click(),window.URL.revokeObjectURL(a),document.body.removeChild(s)},[t]);return(0,i.jsx)("a",{className:"button button--primary",style:{marginBottom:"1rem",display:"block",width:"min-content"},href:t,download:!0,onClick:n,children:e})}},66354:function(e,t,n){n.d(t,{Q:()=>a});var i=n(74848);let a=({children:e})=>(0,i.jsx)("div",{style:{flexGrow:1,minWidth:0,fontSize:"0.8rem",width:"100%"},children:e})},52915:function(e,t,n){n.d(t,{A:()=>u});var i=n(74848);n(96540);var a=n(34164),r=n(71643),s=n(66697),o=n(92949),d=n(64560),l=n(35062);function c({language:e}){return(0,i.jsxs)("div",{className:(0,a.A)("codeBlockHeader_C_1e"),"aria-label":`Code block header for ${e} code with copy and toggle buttons`,children:[(0,i.jsx)("span",{className:"languageLabel_zr_I",children:e}),(0,i.jsx)(l.A,{})]})}function u({className:e}){let{metadata:t}=(0,r.Ph)(),n=t.language||"text";return(0,i.jsxs)(s.A,{as:"div",className:(0,a.A)(e,t.className),children:[t.title&&(0,i.jsx)("div",{className:"codeBlockTitle_d3dP",children:(0,i.jsx)(o.A,{children:t.title})}),(0,i.jsxs)("div",{className:"codeBlockContent_bxn0",children:[(0,i.jsx)(c,{language:n}),(0,i.jsx)(d.A,{})]})]})}}}]);