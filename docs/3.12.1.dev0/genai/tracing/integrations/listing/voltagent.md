...
![VoltAgent Tracing](/docs/3.12.1.dev0/images/llms/tracing/voltagent-tracing.png)

[MLflow Tracing](/docs/3.12.1.dev0/genai/tracing.md) provides automatic tracing capability for [VoltAgent](https://github.com/VoltAgent/voltagent), an open-source TypeScript framework for building AI agents. MLflow supports tracing for VoltAgent through the [OpenTelemetry](/docs/3.12.1.dev0/genai/tracing/opentelemetry.md) integration.
...
![VoltAgent trace in MLflow UI](/docs/3.12.1.dev0/images/llms/tracing/voltagent-tracing.png)
...
Since this integration is built on OpenTelemetry, you can combine the automatically generated traces with the [MLflow Tracing SDK](/docs/3.12.1.dev0/genai/tracing.md) (`@mlflow/core`) to add custom spans, set tags, and update trace metadata within the same trace.
