...
![Spring AI Tracing](/docs/3.12.1.dev0/assets/images/spring-ai-tracing-f802506208759be1fcd131364a71df3d.png)

[MLflow Tracing](/docs/3.12.1.dev0/genai/tracing.md) provides automatic tracing capability for [Spring AI](https://spring.io/projects/spring-ai), the Spring framework for building AI applications. MLflow supports tracing for Spring AI through the [OpenTelemetry](/docs/3.12.1.dev0/genai/tracing/opentelemetry.md) integration.
...
## Step 4: Create the Chat Service[​](#step-4-create-the-chat-service "Direct link to Step 4: Create the Chat Service")
...
## Step 5: Create a Chat Controller[​](#step-5-create-a-chat-controller "Direct link to Step 5: Create a Chat Controller")
...
## Step 6: Run the Application[​](#step-6-run-the-application "Direct link to Step 6: Run the Application")
