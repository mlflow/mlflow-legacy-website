...
![Feedbacks attached to traces](/docs/3.12.1.dev0/images/llms/tracing/genai-human-feedback.png)
...
![Feedback Architecture](/docs/3.12.1.dev0/assets/images/feedback_architecture-4294fe94ea1d82f20b5b16edddeab840.png)

Feedback is often created by different sources, such as human annotators, LLM judges, or real user's feedback in the application. The [`Feedback`](/docs/3.12.1.dev0/api_reference/python_api/mlflow.entities.html#mlflow.entities.Feedback) object in MLflow is a standard container for storing these signals along with metadata to track how they are created. Feedbacks are associated with a Trace, or a particular Span in the Trace.
...
### [Feedback Guide](/docs/3.12.1.dev0/genai/assessments/feedback.md)

[Complete guide for using mlflow.log\_feedback with practical examples and code samples](/docs/3.12.1.dev0/genai/assessments/feedback.md)

[View the feedback guide →](/docs/3.12.1.dev0/genai/assessments/feedback.md)

### [Expectations Concepts](/docs/3.12.1.dev0/genai/concepts/expectations.md)

[Learn how to define ground truth expectations for comprehensive evaluation](/docs/3.12.1.dev0/genai/concepts/expectations.md)

[Learn about expectations →](/docs/3.12.1.dev0/genai/concepts/expectations.md)

### [Ground Truth Expectations](/docs/3.12.1.dev0/genai/assessments/expectations.md)

[Understand how to define expected outputs for comprehensive evaluation](/docs/3.12.1.dev0/genai/assessments/expectations.md)

[Learn about expectations →](/docs/3.12.1.dev0/genai/assessments/expectations.md)
