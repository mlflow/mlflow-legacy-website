...
![Gateway Overview](/docs/3.12.1.dev0/assets/images/gateway-overview-2bbf3cf41c12806962300767a53094c0.png)
...
3. Select your provider from 100+ supported options
   ...
   * Click "LiteLLM" for the full LiteLLM catalog (**Note:** you will need to install LiteLLM separately)
...
![Create Endpoint](/docs/3.12.1.dev0/assets/images/create-endpoint-4b5244302954cd8e676b9f929168a048.png)

### Advanced Routing Options[​](#advanced-routing-options "Direct link to Advanced Routing Options")

For endpoints that need traffic splitting or fallbacks, see [Traffic Routing & Fallbacks](/docs/3.12.1.dev0/genai/governance/ai-gateway/traffic-routing-fallbacks.md).
