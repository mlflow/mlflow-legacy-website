...
![Create API Key](/docs/3.12.1.dev0/assets/images/create-api-key-680a70020d74cde71f658c2bf2962d9a.png)
...
[Learn about credential management and best practices for API keys](/docs/3.12.1.dev0/genai/governance/ai-gateway/api-keys/create-and-manage.md)

[Manage API keys →](/docs/3.12.1.dev0/genai/governance/ai-gateway/api-keys/create-and-manage.md)
