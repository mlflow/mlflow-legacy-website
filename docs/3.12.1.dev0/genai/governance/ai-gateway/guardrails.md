...
## Viewing Guardrails[​](#viewing-guardrails "Direct link to Viewing Guardrails")

Guardrails are configured per endpoint. Navigate to **AI Gateway > Endpoints**, click an endpoint, then select the **Guardrails** tab.

![Guardrails tab showing empty state](/docs/3.12.1.dev0/images/genai/governance/ai-gateway/guardrails-tab-empty.png)
...
## Creating a Guardrail[​](#creating-a-guardrail "Direct link to Creating a Guardrail")

Click **Create Guardrail** to open the creation wizard.

### Step 1 — Choose a type[​](#step-1--choose-a-type "Direct link to Step 1 — Choose a type")

![Create Guardrail modal showing type picker with Safety, PII Detection, and Custom Guardrail options](/docs/3.12.1.dev0/images/genai/governance/ai-gateway/guardrails-create-type-picker.png)

Several built-in types are available:

| Type                 | Description                                                                                                                                                                    |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Safety**           | Pre-loaded instructions for detecting harmful, offensive, or toxic content. Defaults to the *After* stage to check LLM responses.                                              |
| **PII Detection**    | Pre-loaded instructions for detecting names, emails, phone numbers, and other personally identifiable information. Defaults to the *Before* stage to screen incoming requests. |
...
### Step 2 — Configure the guardrail[​](#step-2--configure-the-guardrail "Direct link to Step 2 — Configure the guardrail")

![Create Guardrail configuration step showing Name, Stage picker, Instructions, Guardrail Model, and Action fields](/docs/3.12.1.dev0/images/genai/governance/ai-gateway/guardrails-create-config.png)
...
#### Guardrail Model[​](#guardrail-model "Direct link to Guardrail Model")
...
## How Blocking Works[​](#how-blocking-works "Direct link to How Blocking Works")
...
## Editing a Guardrail[​](#editing-a-guardrail "Direct link to Editing a Guardrail")
...
## Deleting a Guardrail[​](#deleting-a-guardrail "Direct link to Deleting a Guardrail")
...
## Ordering and Execution[​](#ordering-and-execution "Direct link to Ordering and Execution")
