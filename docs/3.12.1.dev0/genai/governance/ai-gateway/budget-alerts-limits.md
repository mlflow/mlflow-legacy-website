...
## Managing Budget Policies[​](#managing-budget-policies "Direct link to Managing Budget Policies")

Navigate to **AI Gateway > Budgets** in the MLflow UI to view and manage your budget policies.

![Budget policies list](/docs/3.12.1.dev0/images/budget-policies-list.png)
...
![Create budget policy dialog](/docs/3.12.1.dev0/images/budget-policies-create.png)
...
## Reject Behavior[​](#reject-behavior "Direct link to Reject Behavior")
...
When [authentication](/docs/3.12.1.dev0/self-hosting/security/basic-http-auth.md) is enabled for the tracking server, only admin users can create, update, or delete budget policies.
...
## Policy Refresh Interval[​](#policy-refresh-interval "Direct link to Policy Refresh Interval")
