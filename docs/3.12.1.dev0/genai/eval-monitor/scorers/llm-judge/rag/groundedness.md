...
The RetrievalGroundedness judge evaluates each retriever span separately and returns a separate Feedback object for each retriever span in your trace. Each [`Feedback`](/docs/3.12.1.dev0/api_reference/python_api/mlflow.entities.html#mlflow.entities.Feedback) object contains:
...
### [Evaluate context sufficiency](/docs/3.12.1.dev0/genai/eval-monitor/scorers/llm-judge/rag/context-sufficiency.md)

[Check if your retriever provides adequate information](/docs/3.12.1.dev0/genai/eval-monitor/scorers/llm-judge/rag/context-sufficiency.md)
...
[Ensure retrieved documents are relevant to queries](/docs/3.12.1.dev0/genai/eval-monitor/scorers/llm-judge/rag/relevance.md#retrievalrelevance-judge)

[Learn more →](/docs/3.12.1.dev0/genai/eval-monitor/scorers/llm-judge/rag/relevance.md#retrievalrelevance-judge)

### [Run comprehensive RAG evaluation](/docs/3.12.1.dev0/genai/eval-monitor/quickstart.md)

[Combine multiple judges for complete RAG assessment](/docs/3.12.1.dev0/genai/eval-monitor/quickstart.md)
