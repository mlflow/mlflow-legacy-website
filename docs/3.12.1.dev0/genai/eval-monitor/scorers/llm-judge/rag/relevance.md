...
You can invoke the judge directly with a single input for testing, or pass it to [mlflow.genai.evaluate](/docs/3.12.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.evaluate) for running full evaluation on a dataset.
...
For a complete RAG application example with these judges, see the [RAG Evaluation guide](/docs/3.12.1.dev0/genai/eval-monitor/scorers/llm-judge/rag.md).
...
The judge returns a [`Feedback`](/docs/3.12.1.dev0/api_reference/python_api/mlflow.entities.html#mlflow.entities.Feedback) object containing:
...
### [Explore other built-in judges](/docs/3.12.1.dev0/genai/eval-monitor/scorers/llm-judge/predefined.md#available-judges)

[Learn about groundedness, safety, and correctness judges](/docs/3.12.1.dev0/genai/eval-monitor/scorers/llm-judge/predefined.md#available-judges)
...
### [Evaluate RAG applications](/docs/3.12.1.dev0/genai/eval-monitor/quickstart.md)

[Apply relevance judges in comprehensive RAG evaluation](/docs/3.12.1.dev0/genai/eval-monitor/quickstart.md)
