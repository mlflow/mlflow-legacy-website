...
[](/docs/3.12.1.dev0/images/genai/issue-detection/issue-detection.mp4)
...
![Issue detection categories](/docs/3.12.1.dev0/images/genai/issue-detection/categories.png)
...
![Issue detection endpoints selection](/docs/3.12.1.dev0/images/genai/issue-detection/endpoint-selection.png)

![Issue detection models selection](/docs/3.12.1.dev0/images/genai/issue-detection/model-selection.png)

You can analyze all traces in your experiment or select a specific subset. For multi-turn conversations, you can group traces by [session](/docs/3.12.1.dev0/genai/tracing/track-users-sessions.md) to get conversation-aware analysis.
...
![Issue detection in progress](/docs/3.12.1.dev0/images/genai/issue-detection/issue-detection-progress.png)
...
![Detection complete with summary](/docs/3.12.1.dev0/images/genai/issue-detection/summary.png)
...
![Detected issues overview](/docs/3.12.1.dev0/images/genai/issue-detection/issue-cards.png)
...
![Issue with affected traces](/docs/3.12.1.dev0/images/genai/issue-detection/issue-details.png)
...
![Managing issue status](/docs/3.12.1.dev0/images/genai/issue-detection/issue-status.png)
...
![Editing issue details](/docs/3.12.1.dev0/images/genai/issue-detection/edit-issue.png)
...
To control costs at scale, connect via an [MLflow AI Gateway](/docs/3.12.1.dev0/genai/governance/ai-gateway.md) endpoint and use its built-in budget controls to cap spending across detection runs.
...
| ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| You want to detect unknown problems                                | You know the specific quality dimensions or hypotheses to test: use [MLflow Evaluation Judges](/docs/3.12.1.dev0/genai/eval-monitor/scorers.md)                          |
| You need to analyze many traces at once                            | You're debugging a single trace: use [MLflow Trace UI](/docs/3.12.1.dev0/genai/tracing/observe-with-traces/ui.md)                                                        |
| You want to track, triage, and resolve identified issues over time | You need continuous production monitoring: use [Automatic Evaluations](/docs/3.12.1.dev0/genai/eval-monitor/automatic-evaluations.md) to score every trace as it arrives |
