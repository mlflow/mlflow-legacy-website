...
4. **Serialization**: Use [`models-from-code`](/docs/3.12.1.dev0/ml/model/models-from-code.md) feature when logging models that are not picklable

### Debugging Tips[​](#debugging-tips "Direct link to Debugging Tips")

* 🧾 **Enable [tracing](/docs/3.12.1.dev0/genai/tracing.md)** to track execution flow
