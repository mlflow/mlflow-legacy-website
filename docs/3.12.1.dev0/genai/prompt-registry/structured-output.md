...
![Register prompt with structured output](/docs/3.12.1.dev0/assets/images/create-prompt-with-structured-output-0ef48fdf68419014254dba615e902767.png)
...
Use the [`mlflow.genai.register_prompt()`](/docs/3.12.1.dev0/api_reference/python_api/mlflow.genai.html#mlflow.genai.register_prompt) function with the `response_format` parameter to define structured output programmatically.
...
### [Create and Edit Prompts](/docs/3.12.1.dev0/genai/prompt-registry/create-and-edit-prompts.md)

[Learn the basics of prompt management in MLflow](/docs/3.12.1.dev0/genai/prompt-registry/create-and-edit-prompts.md)

[Manage prompts →](/docs/3.12.1.dev0/genai/prompt-registry/create-and-edit-prompts.md)

### [Use Prompts in Apps](/docs/3.12.1.dev0/genai/prompt-registry/use-prompts-in-apps.md)

[See how to integrate prompts into your applications](/docs/3.12.1.dev0/genai/prompt-registry/use-prompts-in-apps.md)

[Integrate prompts →](/docs/3.12.1.dev0/genai/prompt-registry/use-prompts-in-apps.md)

### [Evaluate Prompts](/docs/3.12.1.dev0/genai/prompt-registry/evaluate-prompts.md)

[Learn how to assess prompt performance with evaluations](/docs/3.12.1.dev0/genai/prompt-registry/evaluate-prompts.md)
