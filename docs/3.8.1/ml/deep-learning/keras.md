...
Save Keras models with [`mlflow.tensorflow.log_model()`](/docs/3.8.1/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.log_model):
...
[Version and manage Keras models](/docs/3.8.1/ml/model-registry.md)
