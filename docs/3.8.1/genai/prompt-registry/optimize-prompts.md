...
Currently, MLflow supports the [GEPA](https://arxiv.org/abs/2507.19457) optimization algorithm through the [`GepaPromptOptimizer`](/docs/3.8.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.optimize.GepaPromptOptimizer). GEPA iteratively refines prompts using LLM-driven reflection and automated feedback, leading to systematic and data-driven improvements.
...
The [`mlflow.genai.optimize_prompts()`](/docs/3.8.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.optimize_prompts) API requires the following components:

| Component              | Description                                                                                                                                                                                                                                                                    |
| ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Target Prompt URIs** | List of prompt URIs to optimize (e.g., `["prompts:/qa/1"]`)                                                                                                                                                                                                                    |
| **Predict Function**   | A callable that takes inputs as keyword arguments and returns outputs. Must load templates from MLflow prompt versions (e.g., call [`PromptVersion.format()`](/docs/3.8.1/api_reference/python_api/mlflow.entities.html#mlflow.entities.model_registry.PromptVersion.format)). |
...
| **Optimizer**          | Prompt optimizer instance (e.g., [`GepaPromptOptimizer`](/docs/3.8.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.optimize.GepaPromptOptimizer))                                                                                                                    |
...
* Load the template from MLflow prompt versions using one of the following methods:
  ...
  * [`PromptVersion.format()`](/docs/3.8.1/api_reference/python_api/mlflow.entities.html#mlflow.entities.model_registry.PromptVersion.format)
  * [`PromptVersion.template`](/docs/3.8.1/api_reference/python_api/mlflow.entities.html#mlflow.entities.model_registry.PromptVersion.template)
  * [`PromptVersion.to_single_brace_format()`](/docs/3.8.1/api_reference/python_api/mlflow.entities.html#mlflow.entities.model_registry.PromptVersion.to_single_brace_format)
...
Provide a dataset with `inputs` and `expectations`. Both columns should have dictionary values. `inputs` values will be passed to the predict function as keyword arguments. Please refer to [Predefined LLM Scorers](/docs/3.8.1/genai/eval-monitor/scorers/llm-judge/predefined.md) for the expected format of each built in scorers.
...
Create an optimizer instance for the optimization algorithm. Currently only [`GepaPromptOptimizer`](/docs/3.8.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.optimize.GepaPromptOptimizer) is supported natively.
...
Implement your own optimizer by extending [`BasePromptOptimizer`](/docs/3.8.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.optimize.BasePromptOptimizer):
...
The API returns a [`PromptOptimizationResult`](/docs/3.8.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.optimize.PromptOptimizationResult) object:
...
When switching between different language models (e.g., migrating from `gpt-5` to `gpt-5-mini` for cost reduction), you may need to rewrite your prompts to maintain output quality with the new model. The [`mlflow.genai.optimize_prompts()`](/docs/3.8.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.optimize_prompts) API can help adapt prompts automatically using your existing application outputs as training data.

See the [Auto-rewrite Prompts for New Models](/docs/3.8.1/genai/prompt-registry/rewrite-prompts.md) guide for a complete model migration workflow.
...
**Solution**: Ensure `predict_fn` calls [`PromptVersion.format()`](/docs/3.8.1/api_reference/python_api/mlflow.entities.html#mlflow.entities.model_registry.PromptVersion.format) during execution:
...
* [Auto-rewrite Prompts for New Models](/docs/3.8.1/genai/prompt-registry/rewrite-prompts.md): Adapt prompts when switching between language models
* [Create and Edit Prompts](/docs/3.8.1/genai/prompt-registry/create-and-edit-prompts.md): Basic Prompt Registry usage
* [Evaluate Prompts](/docs/3.8.1/genai/eval-monitor/running-evaluation/prompts.md): Evaluate prompt performance
