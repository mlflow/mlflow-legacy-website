...
[](/docs/3.8.1/images/llms/tracing/chat-sessions-demo.mp4)
...
To record user and session information in your application, use the [`mlflow.update_current_trace()`](/docs/3.8.1/api_reference/python_api/mlflow.html#mlflow.update_current_trace) API and pass the user and session IDs in the metadata.
...
### [Search Traces](/docs/3.8.1/genai/tracing/search-traces.md)

[Master advanced filtering techniques for user and session analysis](/docs/3.8.1/genai/tracing/search-traces.md)

[Learn search →](/docs/3.8.1/genai/tracing/search-traces.md)

### [Production Monitoring](/docs/3.8.1/genai/tracing/prod-tracing.md)

[Set up comprehensive production observability with user context](/docs/3.8.1/genai/tracing/prod-tracing.md)

[Monitor production →](/docs/3.8.1/genai/tracing/prod-tracing.md)
