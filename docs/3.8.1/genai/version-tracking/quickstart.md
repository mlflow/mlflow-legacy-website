...
![The MLflow UI showing a prompt version](/docs/3.8.1/images/mlflow-3/genai/chatbot_prompt.png)
...
![The MLflow UI showing the logged models in an experiment](/docs/3.8.1/images/mlflow-3/genai/logged_models_tab.png)

2. **Access Model Details**: Click on your model to view its unique `model_id`:

![The MLflow UI showing the logged model details page](/docs/3.8.1/images/mlflow-3/genai/logged_model_page.png)

3. **Analyze Generated Traces**: Navigate to the **Traces** tab to examine individual interactions:

![The MLflow UI showing the logged model autolog traces lineage](/docs/3.8.1/images/mlflow-3/genai/logged_model_autolog_traces.png)
...
### [Track Application Versions](/docs/3.8.1/genai/version-tracking/track-application-versions-with-mlflow.md)

[Learn advanced version tracking patterns for production GenAI applications](/docs/3.8.1/genai/version-tracking/track-application-versions-with-mlflow.md)

[Learn more →](/docs/3.8.1/genai/version-tracking/track-application-versions-with-mlflow.md)

### [Compare App Versions](/docs/3.8.1/genai/version-tracking/compare-app-versions.md)

[Analyze performance differences between versions using trace-based comparison](/docs/3.8.1/genai/version-tracking/compare-app-versions.md)

[Learn more →](/docs/3.8.1/genai/version-tracking/compare-app-versions.md)

### [Prompt Registry](/docs/3.8.1/genai/prompt-registry.md)

[Manage prompts at scale with MLflow's centralized prompt registry](/docs/3.8.1/genai/prompt-registry.md)

[Learn more →](/docs/3.8.1/genai/prompt-registry.md)

### [Evaluation & Monitoring](/docs/3.8.1/genai/eval-monitor.md)

[Build comprehensive evaluation pipelines for production GenAI applications](/docs/3.8.1/genai/eval-monitor.md)
