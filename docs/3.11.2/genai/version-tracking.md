...
[Learn comprehensive patterns for versioning complex LLM applications and AI agents with external code management](/docs/3.11.2/genai/version-tracking/track-application-versions-with-mlflow.md)

[Master versioning →](/docs/3.11.2/genai/version-tracking/track-application-versions-with-mlflow.md)

### [Deployment Strategies](/docs/3.11.2/genai/serving.md)

[Deploy versioned applications with confidence using MLflow's serving capabilities](/docs/3.11.2/genai/serving.md)

[Deploy versions →](/docs/3.11.2/genai/serving.md)
