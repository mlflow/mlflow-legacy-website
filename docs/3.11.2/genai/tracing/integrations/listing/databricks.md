...
![Databricks Tracing](/docs/3.11.2/images/llms/tracing/basic-openai-trace.png)
...
MLflow supports tracing for streaming and async Databricks APIs. Visit the [OpenAI Tracing documentation](/docs/3.11.2/genai/tracing/integrations/listing/openai.md) for example code snippets for tracing streaming and async calls through OpenAI SDK.
...
The automatic tracing capability in MLflow is designed to work seamlessly with the [Manual Tracing SDK](/docs/3.11.2/genai/tracing/app-instrumentation/manual-tracing.md) or multi-framework integrations. Please refer to the [Combining with frameworks or manual tracing](/docs/3.11.2/genai/tracing/integrations/listing/openai.md#combine-with-manual-tracing) for example code snippets.

![Databricks Tracing with Manual Tracing](/docs/3.11.2/images/llms/tracing/openai-trace-with-manual-span.png)
