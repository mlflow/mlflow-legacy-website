...
![Smolagents tracing via autolog](/docs/3.11.2/assets/images/smolagents-tracing-ce4f2c411221b1c5d54a65e704e6a945.png)

MLflow Tracing provides automatic tracing capability when using Smolagents. When Smolagents auto-tracing is enabled by calling the [`mlflow.smolagents.autolog()`](/docs/3.11.2/api_reference/python_api/mlflow.smolagents.html#mlflow.smolagents.autolog) function, usage of the Smolagents SDK will automatically record generated traces during interactive development.
...
MLflow automatically tracks token usage for Smolagents. See the [Token Usage and Cost Tracking](/docs/3.11.2/genai/tracing/token-usage-cost.md) documentation for details on accessing this information programmatically.
