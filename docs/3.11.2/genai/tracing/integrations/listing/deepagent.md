...
![Deep Agent Tracing in MLflow](/docs/3.11.2/images/llms/tracing/deepagent-tracing.png)
...
Since Deep Agent is built on LangGraph, [MLflow Tracing](/docs/3.11.2/genai/tracing.md) works out of the box via [`mlflow.langchain.autolog()`](/docs/3.11.2/api_reference/python_api/mlflow.langchain.html#mlflow.langchain.autolog). This automatically captures the entire agent execution including planning, tool calls, and subagent interactions.
