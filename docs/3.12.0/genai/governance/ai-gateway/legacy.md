...
For new deployments, we recommend using the [Gateway Quickstart](/docs/3.12.0/genai/governance/ai-gateway/quickstart.md) which provides a modern web interface for managing endpoints, API keys, and routing configurations with zero-downtime updates.
...
### [Setup](/docs/3.12.0/genai/governance/ai-gateway/legacy/setup.md)

[Install MLflow, configure environment, and start your gateway server](/docs/3.12.0/genai/governance/ai-gateway/legacy/setup.md)

[Get started →](/docs/3.12.0/genai/governance/ai-gateway/legacy/setup.md)

### [Configuration](/docs/3.12.0/genai/governance/ai-gateway/legacy/configuration.md)

[Configure providers, endpoints, and advanced routing settings](/docs/3.12.0/genai/governance/ai-gateway/legacy/configuration.md)

[Configure →](/docs/3.12.0/genai/governance/ai-gateway/legacy/configuration.md)

### [Usage](/docs/3.12.0/genai/governance/ai-gateway/legacy/usage.md)

[Query endpoints with Python client and REST APIs](/docs/3.12.0/genai/governance/ai-gateway/legacy/usage.md)

[Learn usage →](/docs/3.12.0/genai/governance/ai-gateway/legacy/usage.md)
