...
![LLM Connections Page](/docs/3.12.0/assets/images/llm-connections-53c4859074dfc944ece90f42f2172d1a.png)
...
4. **Regular rotation**: Periodically rotate API keys for security (see [Encryption & Rotation](/docs/3.12.0/genai/governance/ai-gateway/api-keys/key-rotation.md))
