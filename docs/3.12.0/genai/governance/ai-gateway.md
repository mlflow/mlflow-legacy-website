...
[Create and manage API keys for secure credential management](/docs/3.12.0/genai/governance/ai-gateway/api-keys/create-and-manage.md)

[Manage keys →](/docs/3.12.0/genai/governance/ai-gateway/api-keys/create-and-manage.md)
