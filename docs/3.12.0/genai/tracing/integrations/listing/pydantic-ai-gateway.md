...
This guide covers tracing LLM calls through **Pydantic AI Gateway**. If you're building agents using the Pydantic AI framework directly, see the [PydanticAI Integration](/docs/3.12.0/genai/tracing/integrations/listing/pydantic_ai.md) guide instead.
