...
![LiveKit Agents Tracing](/docs/3.12.0/images/llms/tracing/livekit-tracing.png)

[MLflow Tracing](/docs/3.12.0/genai/tracing.md) provides automatic tracing capability for [LiveKit Agents](https://github.com/livekit/agents), an open-source framework for building real-time multimodal AI applications. MLflow supports tracing for LiveKit Agents through the [OpenTelemetry](/docs/3.12.0/genai/tracing/opentelemetry.md) integration.
...
Since this integration is built on OpenTelemetry, you can combine the automatically generated traces with the [MLflow Tracing SDK](/docs/3.12.0/genai/tracing.md) to add custom spans, set tags, and log assessments within the same trace. This is useful when you want to enrich the auto-generated traces with additional application-specific context.

To enable this, set the `MLFLOW_USE_DEFAULT_TRACER_PROVIDER` environment variable to `false` and call [`mlflow.tracing.set_destination()`](/docs/3.12.0/api_reference/python_api/mlflow.tracing.html#mlflow.tracing.set_destination) to merge spans from both SDKs into a single trace.
...
For detailed instructions and examples, see [Combining the OpenTelemetry SDK and the MLflow Tracing SDK](/docs/3.12.0/genai/tracing/app-instrumentation/opentelemetry.md#combining-the-opentelemetry-sdk-and-the-mlflow-tracing-sdk).
...
### [Evaluate the Agent](/docs/3.12.0/genai/eval-monitor/running-evaluation/agents.md)

[Learn how to evaluate the agent's performance with LLM judges.](/docs/3.12.0/genai/eval-monitor/running-evaluation/agents.md)
...
### [Automatic Agent Optimization](/docs/3.12.0/genai/prompt-registry/optimize-prompts.md)

[Automatically optimize the agent end-to-end with state-of-the-art algorithms.](/docs/3.12.0/genai/prompt-registry/optimize-prompts.md)

[Optimize prompts →](/docs/3.12.0/genai/prompt-registry/optimize-prompts.md)
