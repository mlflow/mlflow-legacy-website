...
This guide covers the **LiteLLM Proxy Server**. If you're using the LiteLLM Python SDK directly in your application, see the [LiteLLM SDK Integration](/docs/3.12.0/genai/tracing/integrations/listing/litellm.md) guide instead.
