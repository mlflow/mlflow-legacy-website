...
MLflow captures image content parts passed through LangChain models. See [Multimodal Content and Attachments in Traces](/docs/3.12.0/genai/tracing/observe-with-traces/multimodal.md) for details.
