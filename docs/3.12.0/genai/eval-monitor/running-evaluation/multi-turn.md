...
![Multi-turn evaluation results](/docs/3.12.0/images/genai/multi-turn-view.png)
...
[Learn more about conversation simulation →](/docs/3.12.0/genai/eval-monitor/running-evaluation/conversation-simulation.md)
...
![Sessions View UI](/docs/3.12.0/images/genai/sessions-view-ui.png)
...
You can also retrieve complete sessions directly using [`mlflow.search_sessions`](/docs/3.12.0/api_reference/python_api/mlflow.html#mlflow.search_sessions):
...
For complete documentation on conversation simulation, including test case definition, predict function interfaces, and configuration options, see the [Conversation Simulation guide](/docs/3.12.0/genai/eval-monitor/running-evaluation/conversation-simulation.md).
...
MLflow provides built-in multi-turn judges including `ConversationCompleteness`, `UserFrustration`, `KnowledgeRetention`, and more. See the [Built-in Judges](/docs/3.12.0/genai/eval-monitor/scorers/llm-judge/predefined.md#multi-turn) page for the full list, usage examples, and API documentation.

### Custom Judges[​](#custom-judges "Direct link to Custom Judges")

You can create custom multi-turn judges using [make\_judge](/docs/3.12.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.judges.make_judge) with the `{{ conversation }}` template variable:
...
To evaluate a specific session, use [`mlflow.search_traces`](/docs/3.12.0/api_reference/python_api/mlflow.html#mlflow.search_traces) with a filter string:
...
### [Session Tracing Guide](/docs/3.12.0/genai/tracing/track-users-sessions.md)

[Learn how to track users and sessions in your conversational AI applications for better evaluation.](/docs/3.12.0/genai/tracing/track-users-sessions.md)

[Learn about sessions →](/docs/3.12.0/genai/tracing/track-users-sessions.md)

### [Built-in Judges](/docs/3.12.0/genai/eval-monitor/scorers/llm-judge/predefined.md#multi-turn)

[Explore built-in judges for conversation completeness, user frustration, and other multi-turn metrics.](/docs/3.12.0/genai/eval-monitor/scorers/llm-judge/predefined.md#multi-turn)

[View judges →](/docs/3.12.0/genai/eval-monitor/scorers/llm-judge/predefined.md#multi-turn)

### [Conversation Simulation](/docs/3.12.0/genai/eval-monitor/running-evaluation/conversation-simulation.md)

[Generate synthetic conversations to test your agent with diverse scenarios and user behaviors.](/docs/3.12.0/genai/eval-monitor/running-evaluation/conversation-simulation.md)

[Simulate conversations →](/docs/3.12.0/genai/eval-monitor/running-evaluation/conversation-simulation.md)
