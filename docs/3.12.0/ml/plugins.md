...
![Quickstart UI](/docs/3.12.0/assets/images/quickstart_ui_screenshot-3ea56ba2b1c9970e1ff466b8dc57b37d.png)
...
For full details on workspace provider architecture, discovery, and configuration, see the [Workspace Providers](/docs/3.12.0/self-hosting/workspaces/workspace-providers.md) documentation.
