...
[Determine similarity scores between sentences using embeddings](/docs/3.12.0/ml/deep-learning/sentence-transformers/tutorials/semantic-similarity/semantic-similarity-sentence-transformers.md)
...
[Find the most similar embeddings within a corpus of text](/docs/3.12.0/ml/deep-learning/sentence-transformers/tutorials/semantic-search/semantic-search-sentence-transformers.md)
