...
Workspace-scoped permissions provide convenient access control for all resources within a workspace when [authentication](/docs/3.12.0/self-hosting/security/basic-http-auth.md) is enabled.
...
* [Configuration](/docs/3.12.0/self-hosting/workspaces/configuration.md) - Server configuration options
* [Workspace Providers](/docs/3.12.0/self-hosting/workspaces/workspace-providers.md) - Implement custom providers
* [Authentication](/docs/3.12.0/self-hosting/security/basic-http-auth.md) - Set up MLflow authentication
