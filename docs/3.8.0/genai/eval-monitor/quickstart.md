...
![Simple Evaluation Results](/docs/3.8.0/images/mlflow-3/eval-monitor/quickstart-eval-hero.png)
...
* [Correctness](/docs/3.8.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.Correctness): Evaluates if the answer is factually correct, using the "expected\_response" field in the dataset.
* [Guidelines](/docs/3.8.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.Guidelines): Evaluates if the answer meets the given guidelines.
* `is_concise`: A custom scorer defined using the [scorer](/docs/3.8.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.scorer) decorator to judge if the answer is concise (less than 5 words).
...
![Detailed Evaluation Results](/docs/3.8.0/images/mlflow-3/eval-monitor/quickstart-eval-trace.png)
