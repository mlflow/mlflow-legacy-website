...
![Expectations in UI](/docs/3.8.0/assets/images/add_expectation_ui-5d57bfe9d75f1e2bedc36c493aacbd01.png)
...
### [Annotating Expectations](/docs/3.8.0/genai/assessments/expectations.md)

[Learn how to annotate ground truth expectations for your GenAI applications](/docs/3.8.0/genai/assessments/expectations.md)

[Start annotating →](/docs/3.8.0/genai/assessments/expectations.md)

### [Expectations API Guide](/docs/3.8.0/genai/assessments/expectations.md)

[Complete reference for the expectations API with practical examples](/docs/3.8.0/genai/assessments/expectations.md)

[View API docs →](/docs/3.8.0/genai/assessments/expectations.md)

### [Feedback Integration](/docs/3.8.0/genai/concepts/feedback.md)

[Understand how expectations work with feedback for comprehensive evaluation](/docs/3.8.0/genai/concepts/feedback.md)

[Learn about feedback →](/docs/3.8.0/genai/concepts/feedback.md)
