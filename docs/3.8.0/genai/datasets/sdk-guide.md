...
Evaluation Datasets require an MLflow Tracking Server with a **[SQL backend](/docs/3.8.0/self-hosting/architecture/backend-store.md#types-of-backend-stores)** (PostgreSQL, MySQL, SQLite, or MSSQL). This feature is **not available** with FileStore (local file system-based tracking).

## Creating a Dataset[​](#creating-a-dataset "Direct link to Creating a Dataset")

Use [`mlflow.genai.datasets.create_dataset()`](/docs/3.8.0/api_reference/python_api/mlflow.genai.html#mlflow.genai.datasets.create_dataset) to create a new evaluation dataset:
...
You can also use the [`mlflow.tracking.MlflowClient()`](/docs/3.8.0/api_reference/python_api/mlflow.html#mlflow.tracking.MlflowClient) API:
...
Use the [`mlflow.entities.EvaluationDataset.merge_records()`](/docs/3.8.0/api_reference/python_api/mlflow.entities.html#mlflow.entities.EvaluationDataset.merge_records) method to add new records to your dataset. Records can be added from dictionaries, DataFrames, or traces:
...
The [`mlflow.entities.EvaluationDataset()`](/docs/3.8.0/api_reference/python_api/mlflow.entities.html#mlflow.entities.EvaluationDataset) object provides several ways to access and analyze records:
...
### [End-to-End Workflow](/docs/3.8.0/genai/datasets/end-to-end-workflow.md)

[Learn the complete evaluation-driven development workflow from app building to production](/docs/3.8.0/genai/datasets/end-to-end-workflow.md)

[View complete workflow →](/docs/3.8.0/genai/datasets/end-to-end-workflow.md)

### [Run Evaluations](/docs/3.8.0/genai/eval-monitor.md)

[Use your datasets to systematically evaluate and improve your GenAI applications](/docs/3.8.0/genai/eval-monitor.md)

[Start evaluating →](/docs/3.8.0/genai/eval-monitor.md)

### [Define Expectations](/docs/3.8.0/genai/assessments/expectations.md)

[Learn how to add ground truth expectations to your test data for quality validation](/docs/3.8.0/genai/assessments/expectations.md)

[Set expectations →](/docs/3.8.0/genai/assessments/expectations.md)
