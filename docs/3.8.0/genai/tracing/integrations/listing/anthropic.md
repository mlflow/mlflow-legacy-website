...
![Anthropic Tracing via autolog](/docs/3.8.0/assets/images/anthropic-tracing-7b02a80b9cdd323dafdb413542b2b70b.png)

[MLflow Tracing](/docs/3.8.0/genai/tracing.md) provides automatic tracing capability for Anthropic LLMs. By enabling auto tracing for Anthropic by calling the [`mlflow.anthropic.autolog()`](/docs/3.8.0/api_reference/python_api/mlflow.anthropic.html#mlflow.anthropic.autolog) function, MLflow will capture nested traces and log them to the active MLflow Experiment upon invocation of Anthropic Python SDK. In Typescript, you can instead use the `tracedAnthropic` function to wrap the Anthropic client.
...
![Anthropic Tool Calling Trace](/docs/3.8.0/assets/images/anthropic-tool-calling-e6041af25796ba10c96fc0b6719a6307.png)
