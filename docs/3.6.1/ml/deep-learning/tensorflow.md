...
![TensorFlow Training](/docs/3.6.1/images/deep-learning/tensorflow-training-ui.gif)
...
For more control, use [`mlflow.tensorflow.MlflowCallback()`](/docs/3.6.1/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.MlflowCallback):
...
Save TensorFlow models with [`mlflow.tensorflow.log_model()`](/docs/3.6.1/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.log_model):
...
[Version and manage TensorFlow models](/docs/3.6.1/ml/model-registry.md)

[Learn more →](/docs/3.6.1/ml/model-registry.md)

### [MLflow Tracking](/docs/3.6.1/ml/tracking.md)

[Track experiments, parameters, and metrics](/docs/3.6.1/ml/tracking.md)

[Learn more →](/docs/3.6.1/ml/tracking.md)
