...
MLflow provides native support for spaCy models through the [`mlflow.spacy.log_model()`](/docs/3.6.1/api_reference/python_api/mlflow.spacy.html#mlflow.spacy.log_model) function:
