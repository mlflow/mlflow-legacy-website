...
**Environment-based Models** support mature MLOps workflows. Create separate registered models per environment: `dev.XGBoostChurnModel`, `staging.XGBoostChurnModel`, `prod.XGBoostChurnModel`, and use [`copy_model_version()`](/docs/3.6.1/api_reference/python_api/mlflow.client.html#mlflow.client.MlflowClient.copy_model_version) to promote models across environments.
