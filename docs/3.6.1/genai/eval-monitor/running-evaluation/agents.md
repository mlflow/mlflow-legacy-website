...
![Agent Evaluation](/docs/3.6.1/images/mlflow-3/eval-monitor/agent-evaluation-hero.png)
...
Create a math agent that can use tools to answer questions. We use [OpenAI Agents](/docs/3.6.1/genai/tracing/integrations/listing/openai-agent.md) to build the tool-calling agent in a few lines of code.
...
For more details, see the [Evaluate Traces](/docs/3.6.1/genai/eval-monitor/running-evaluation/traces.md) guide.
...
![Agent Evaluation](/docs/3.6.1/images/mlflow-3/eval-monitor/agent-evaluation-result.png)
...
![Agent Evaluation](/docs/3.6.1/images/mlflow-3/eval-monitor/agent-evaluation-trace.png)
...
In MLflow 2.x, you can pass the model URI directly to the `model` argument of the legacy [`mlflow.evaluate()`](/docs/3.6.1/api_reference/python_api/mlflow.html#mlflow.evaluate) API (deprecated). The new GenAI evaluation API in MLflow **3.x** still support evaluating MLflow Models, but the workflow is slightly different.
...
### [Customize Scorers](/docs/3.6.1/genai/eval-monitor/scorers.md)

[Build advanced evaluation criteria and metrics specifically designed for agent behaviors and tool usage patterns.](/docs/3.6.1/genai/eval-monitor/scorers.md)

[Create custom scorers →](/docs/3.6.1/genai/eval-monitor/scorers.md)

### [Evaluate Production Traces](/docs/3.6.1/genai/eval-monitor/running-evaluation/traces.md)

[Analyze real agent executions in production environments to understand performance and identify improvement opportunities.](/docs/3.6.1/genai/eval-monitor/running-evaluation/traces.md)

[Analyze traces →](/docs/3.6.1/genai/eval-monitor/running-evaluation/traces.md)

### [Collect User Feedback](/docs/3.6.1/genai/assessments/feedback.md)

[Gather human feedback on agent performance to create training data and improve evaluation accuracy.](/docs/3.6.1/genai/assessments/feedback.md)

[Start collecting →](/docs/3.6.1/genai/assessments/feedback.md)
