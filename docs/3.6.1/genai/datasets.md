...
### [Evaluation Integration](/docs/3.6.1/genai/eval-monitor.md)

[Learn how to use datasets with MLflow's evaluation framework](/docs/3.6.1/genai/eval-monitor.md)

[Explore evaluation →](/docs/3.6.1/genai/eval-monitor.md)
