...
The [MLflow Tracing SDK `mlflow-tracing`](/docs/3.6.1/genai/tracing/lightweight-sdk.md) is a lightweight package that only includes the minimum set of dependencies to instrument your code/models/agents with MLflow Tracing.
...
Refer to the [tracking server setup guide](/docs/3.6.1/ml/tracking.md#tracking-setup) for more details.
...
MLflow Traces can be exported to any OpenTelemetry-compatible backend. See the [OpenTelemetry Integration](/docs/3.6.1/genai/tracing/opentelemetry/export.md) documentation for more details.
...
**[Searching for traces](/docs/3.6.1/genai/tracing/search-traces.md)**: Understand how to access trace data for analysis with UI or API.

**[Track Users & Sessions](/docs/3.6.1/genai/tracing/track-users-sessions.md)**: Implement user and session context tracking for better monitoring insights
