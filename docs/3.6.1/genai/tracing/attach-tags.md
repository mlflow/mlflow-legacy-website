...
If the key is already present, the [`mlflow.update_current_trace()`](/docs/3.6.1/api_reference/python_api/mlflow.html#mlflow.update_current_trace) function will update the key with the new value.
