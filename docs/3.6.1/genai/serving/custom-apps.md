...
4. **Serialization**: Use [`models-from-code`](/docs/3.6.1/ml/model/models-from-code.md) feature when logging models that are not picklable

### Debugging Tips[​](#debugging-tips "Direct link to Debugging Tips")

* 🧾 **Enable [tracing](/docs/3.6.1/genai/tracing.md)** to track execution flow
