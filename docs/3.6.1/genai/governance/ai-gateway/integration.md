...
### [Tutorial](/docs/3.6.1/genai/governance/ai-gateway.md)

[Complete step-by-step walkthrough from setup to deployment](/docs/3.6.1/genai/governance/ai-gateway.md)

[Follow tutorial →](/docs/3.6.1/genai/governance/ai-gateway.md)
