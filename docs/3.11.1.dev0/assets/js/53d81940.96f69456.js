...
client = OpenAI(
    base_url="${t.baseUrl}",
    api_key="${t.apiKeyPlaceholder}"${I?A(j):""},
)
...
const client = tracedOpenAI(
  new OpenAI({
    baseURL: "${t.baseUrl}",
    apiKey: "${t.apiKeyPlaceholder}"${v?w(b):""},
  })
);
