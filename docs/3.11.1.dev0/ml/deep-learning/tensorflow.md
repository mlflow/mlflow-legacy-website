...
[](/docs/3.11.1.dev0/images/deep-learning/tensorflow-training-ui.mp4)
...
For more control, use [`mlflow.tensorflow.MlflowCallback()`](/docs/3.11.1.dev0/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.MlflowCallback):
...
Save TensorFlow models with [`mlflow.tensorflow.log_model()`](/docs/3.11.1.dev0/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.log_model):
...
[Version and manage TensorFlow models](/docs/3.11.1.dev0/ml/model-registry.md)
