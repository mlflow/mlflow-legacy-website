...
[](/docs/3.11.1.dev0/images/deep-learning/dl-training-ui.mp4)
...
You can customize system metrics collection frequency and behavior. See the **[System Metrics documentation](/docs/3.11.1.dev0/ml/tracking/system-metrics.md)** for detailed configuration options.
...
[Version and manage PyTorch models](/docs/3.11.1.dev0/ml/model-registry.md)
