...
## What Are Model Signatures and Input Examples?[​](#what-are-model-signatures-and-input-examples "Direct link to What Are Model Signatures and Input Examples?")
...
![Model signatures comparison](/docs/3.11.1.dev0/assets/images/signature-vs-no-signature-6981ed9f06b1c588ccd0a276c350c62a.png)
...
### Signature Types Overview[​](#signature-types-overview "Direct link to Signature Types Overview")
...
### Quick Start with Type Hints[​](#quick-start-with-type-hints "Direct link to Quick Start with Type Hints")
...
### When to Use Type Hints[​](#when-to-use-type-hints "Direct link to When to Use Type Hints")
...
### Basic Pydantic Usage[​](#basic-pydantic-usage "Direct link to Basic Pydantic Usage")
...
### Type Hints Best Practices[​](#type-hints-best-practices "Direct link to Type Hints Best Practices")
...
### Primitive Types[​](#primitive-types-1 "Direct link to Primitive Types")
...
### Common Parameter Patterns[​](#common-parameter-patterns "Direct link to Common Parameter Patterns")
...
![Signature enforcement process](/docs/3.11.1.dev0/assets/images/signature-enforcement-e5974f544a264396c51cb2511dd158f1.png)
...
### Handling Common Issues[​](#handling-common-issues "Direct link to Handling Common Issues")
...
### Benefits of Input Examples[​](#benefits-of-input-examples "Direct link to Benefits of Input Examples")
...
### Input Example Formats[​](#input-example-formats "Direct link to Input Example Formats")
...
### Serving Input Examples[​](#serving-input-examples "Direct link to Serving Input Examples")
...
### Validating Serving Examples[​](#validating-serving-examples "Direct link to Validating Serving Examples")
...
Or view examples directly: [Signature Examples Notebook](/docs/3.11.1.dev0/ml/model/notebooks/signature_examples.md)
...
### Debugging Signatures[​](#debugging-signatures "Direct link to Debugging Signatures")
...
* [Signature Examples Notebook](/docs/3.11.1.dev0/ml/model/notebooks/signature_examples.md) - Interactive examples
* [Model API Documentation](/docs/3.11.1.dev0/ml/model.md#model-api) - Complete API reference
* [Deployment Guide](/docs/3.11.1.dev0/ml/deployment.md) - Using signatures in production
* [MLflow Model Format](/docs/3.11.1.dev0/ml/model.md#storage-format) - Technical specification
