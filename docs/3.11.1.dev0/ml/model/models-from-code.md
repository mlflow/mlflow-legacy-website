...
Models from Code is available in MLflow 2.12.2 and above. For earlier versions, use the legacy serialization methods outlined in the [Custom Python Model](/docs/3.11.1.dev0/ml/model.md#custom-python-models) documentation.
...
## Why Models From Code?[​](#why-models-from-code "Direct link to Why Models From Code?")
...
![Models from code comparison with legacy serialization](/docs/3.11.1.dev0/assets/images/models_from_code_journey-de9843c474c53ab2434d43a56b6ac3be.png)
...
## Core Requirements[​](#core-requirements "Direct link to Core Requirements")

Understanding these key concepts will help you use Models from Code effectively:

### Script Execution[​](#script-execution "Direct link to Script Execution")
...
### Import Management[​](#import-management "Direct link to Import Management")
...
### Using %%writefile[​](#using-writefile "Direct link to Using %%writefile")
...
## Examples and Patterns[​](#examples-and-patterns "Direct link to Examples and Patterns")
...
### Creating the Model Script[​](#creating-the-model-script "Direct link to Creating the Model Script")
...
![The MLflow UI showing the stored model code as a serialized python script](/docs/3.11.1.dev0/assets/images/basic_model_from_code_ui-d31f6ac1bd0841c97400f569fdb779cb.png)

This example shows how to work with multiple Python files using the `code_paths` feature.

### Creating Helper Functions[​](#creating-helper-functions "Direct link to Creating Helper Functions")
...
![The MLflow UI showing models from code usage along with dependent code\_paths script stored in the model artifacts](/docs/3.11.1.dev0/assets/images/model_from_code_code_paths-3b33bcd962d79ed834c40fa25fa14988.png)

This example demonstrates MLflow's native LangChain Models from Code support for building AI applications.

### Creating a LangChain Model[​](#creating-a-langchain-model "Direct link to Creating a LangChain Model")
...
![The MLflow UI showing models from code usage and the mfc.py script that defines the LangChain LCEL chain definition](/docs/3.11.1.dev0/assets/images/langchain_model_from_code-8813a0926cbf8c6d8d03b2fe5dcd6d91.png)
...
### NameError When Loading Models[​](#nameerror-when-loading-models "Direct link to NameError When Loading Models")
...
1. Delete the MLflow run: Use the UI or [`delete_run()` API](/docs/3.11.1.dev0/api_reference/python_api/mlflow.client.html#mlflow.client.MlflowClient.delete_run)
...
### Before (Legacy)[​](#before-legacy "Direct link to Before (Legacy)")
...
* [Model API Documentation](/docs/3.11.1.dev0/ml/model.md#model-api)
* [Managing Dependencies in MLflow Models](/docs/3.11.1.dev0/ml/model/dependencies.md)
* [Custom Python Models](/docs/3.11.1.dev0/ml/model.md#custom-python-models)
