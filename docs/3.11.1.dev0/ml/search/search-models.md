...
## Search Logged Models Overview[​](#search-logged-models-overview "Direct link to Search Logged Models Overview")
...
Looking for guidance on searching over Runs? See the [Search Runs](/docs/3.11.1.dev0/ml/search/search-runs.md) documentation.
...
## Search Query Syntax[​](#search-logged-models-syntax "Direct link to Search Query Syntax")
...
[`mlflow.search_logged_models()`](/docs/3.11.1.dev0/api_reference/python_api/mlflow.html#mlflow.search_logged_models) provides a convenient interface for model search:
...
[`mlflow.client.MlflowClient.search_logged_models()`](/docs/3.11.1.dev0/api_reference/python_api/mlflow.client.html#mlflow.client.MlflowClient.search_logged_models) offers more control with pagination support:
...
Do not search over more than 10 experiments when using the `search_logged_models` API. Excessive search space over experiments will impact the tracking server's performance.
...
### Model Selection for Deployment[​](#model-selection-for-deployment "Direct link to Model Selection for Deployment")
...
### Accessing Metrics from LoggedModel[​](#accessing-metrics-from-loggedmodel "Direct link to Accessing Metrics from LoggedModel")
...
* Use ordering and max\_results to find top performers
