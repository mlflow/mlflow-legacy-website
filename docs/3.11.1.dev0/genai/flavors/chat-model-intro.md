...
If you're already familiar with [`PythonModel`](/docs/3.11.1.dev0/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.PythonModel), you might wonder why [`ChatModel`](/docs/3.11.1.dev0/api_reference/python_api/mlflow.pyfunc.html#mlflow.pyfunc.ChatModel) is needed. As GenAI applications grow more complex, mapping inputs, outputs, and parameters with a custom `PythonModel` can be challenging. `ChatModel` simplifies this by offering a structured, OpenAI-compatible schema for conversational AI models.
