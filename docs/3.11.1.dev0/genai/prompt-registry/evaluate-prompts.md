...
To create a new prompt using the Python API, use [`mlflow.register_prompt()`](/docs/3.11.1.dev0/api_reference/python_api/mlflow.html#mlflow.register_prompt) API:
