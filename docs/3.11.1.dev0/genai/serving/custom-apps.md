...
## Custom PyFunc Model[​](#custom-pyfunc-model "Direct link to Custom PyFunc Model")

### Custom Model[​](#custom-model "Direct link to Custom Model")
...
### Local Serving[​](#local-serving "Direct link to Local Serving")
...
## Integration with Databricks[​](#integration-with-databricks "Direct link to Integration with Databricks")
...
4. **Serialization**: Use [`models-from-code`](/docs/3.11.1.dev0/ml/model/models-from-code.md) feature when logging models that are not picklable

### Debugging Tips[​](#debugging-tips "Direct link to Debugging Tips")

* 🧾 **Enable [tracing](/docs/3.11.1.dev0/genai/tracing.md)** to track execution flow
