...
[](/docs/3.11.1.dev0/images/llms/tracing/chat-sessions-demo.mp4)
...
To record user and session information in your application, use the [`mlflow.update_current_trace()`](/docs/3.11.1.dev0/api_reference/python_api/mlflow.html#mlflow.update_current_trace) API and pass the user and session IDs in the metadata.
...
[Assess multi-turn session quality with conversation-level scorers](/docs/3.11.1.dev0/genai/eval-monitor/running-evaluation/multi-turn.md)
...
[Master advanced filtering techniques for user and session analysis](/docs/3.11.1.dev0/genai/tracing/search-traces.md)

[Learn search →](/docs/3.11.1.dev0/genai/tracing/search-traces.md)

### [Production Monitoring](/docs/3.11.1.dev0/genai/tracing/prod-tracing.md)

[Set up comprehensive production observability with user context](/docs/3.11.1.dev0/genai/tracing/prod-tracing.md)

[Monitor production →](/docs/3.11.1.dev0/genai/tracing/prod-tracing.md)
