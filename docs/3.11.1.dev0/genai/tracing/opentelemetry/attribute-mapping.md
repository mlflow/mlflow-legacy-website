...
When a trace is received via the [OTLP endpoint](/docs/3.11.1.dev0/genai/tracing/opentelemetry/ingest.md), MLflow runs each span through a series of translators. Each translator understands a specific set of OTel semantic conventions and maps them to MLflow span attributes.
...
## Translated Span Attributes[​](#translated-span-attributes "Direct link to Translated Span Attributes")
...
## Mapping Tables[​](#mapping-tables "Direct link to Mapping Tables")
...
### OpenInference (Arize)[​](#openinference-arize "Direct link to OpenInference (Arize)")
...
### Traceloop / OpenLLMetry[​](#traceloop--openllmetry "Direct link to Traceloop / OpenLLMetry")
...
| `gen_ai.prompt.*.content` *(pattern)*                    | `mlflow.spanInputs`  |
| `gen_ai.completion.*.tool_calls.*.arguments` *(pattern)* | `mlflow.spanInputs`  |
| `traceloop.entity.output`                                | `mlflow.spanOutputs` |
| `gen_ai.completion.*.content` *(pattern)*                | `mlflow.spanOutputs` |
...
### Spring AI[​](#spring-ai "Direct link to Spring AI")
...
### Google ADK[​](#google-adk "Direct link to Google ADK")
...
### LiveKit Agents[​](#livekit-agents "Direct link to LiveKit Agents")

Based on [LiveKit Agents](https://docs.livekit.io/agents/observability/) telemetry. Inherits GenAI semantic conventions for token usage and event-based message extraction.
...
### VoltAgent[​](#voltagent "Direct link to VoltAgent")
...
## Session and User Mapping[​](#session-and-user-mapping "Direct link to Session and User Mapping")
...
For more details, see [Track Users and Sessions](/docs/3.11.1.dev0/genai/tracing/track-users-sessions.md).
