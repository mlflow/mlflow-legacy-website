...
![OpenRouter Tracing](/docs/3.11.1.dev0/images/llms/openrouter/openrouter-tracing.png)
...
Before following the steps below, you need to create an [OpenRouter account](https://openrouter.ai/) and generate an API key from the [Keys page](https://openrouter.ai/keys).
