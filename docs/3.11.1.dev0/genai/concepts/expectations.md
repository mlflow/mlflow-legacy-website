...
![Expectations in UI](/docs/3.11.1.dev0/assets/images/add_expectation_ui-5d57bfe9d75f1e2bedc36c493aacbd01.png)
...
| `value`               | `Any`                      | The expected value, which can be<br /><br />- Text responses (e.g., `"The capital of France is Paris"`)<br />- Structured data (e.g., `{"category": "complaint", "priority": "high"}`)<br />- Lists (e.g., `["doc_123", "doc_456"]` for expected retrieval results)<br />- Any JSON-serializable value representing the desired output |
...
## Expectation Examples[​](#expectation-examples "Direct link to Expectation Examples")
...
### [Annotating Expectations](/docs/3.11.1.dev0/genai/assessments/expectations.md)

[Learn how to annotate ground truth expectations for your LLM applications and AI agents](/docs/3.11.1.dev0/genai/assessments/expectations.md)

[Start annotating →](/docs/3.11.1.dev0/genai/assessments/expectations.md)

### [Expectations API Guide](/docs/3.11.1.dev0/genai/assessments/expectations.md)

[Complete reference for the expectations API with practical examples](/docs/3.11.1.dev0/genai/assessments/expectations.md)

[View API docs →](/docs/3.11.1.dev0/genai/assessments/expectations.md)

### [Feedback Integration](/docs/3.11.1.dev0/genai/concepts/feedback.md)

[Understand how expectations work with feedback for comprehensive evaluation](/docs/3.11.1.dev0/genai/concepts/feedback.md)

[Learn about feedback →](/docs/3.11.1.dev0/genai/concepts/feedback.md)
