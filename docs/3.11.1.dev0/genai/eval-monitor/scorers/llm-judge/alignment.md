...
## Transform Generic Judges into Domain Experts[​](#transform-generic-judges-into-domain-experts "Direct link to Transform Generic Judges into Domain Experts")
...
## Why Alignment Matters[​](#why-alignment-matters "Direct link to Why Alignment Matters")
...
## How Judge Alignment Works[​](#how-judge-alignment-works "Direct link to How Judge Alignment Works")
...
## Quick Start: Align Your First Judge[​](#quick-start-align-your-first-judge "Direct link to Quick Start: Align Your First Judge")
...
**The assessment name must exactly match the judge name** - if your judge is named "product\_quality", both the judge's assessments and human feedback must use the name "product\_quality".

The order doesn't matter - humans can provide feedback before or after the judge evaluates.

### Step 1: Setup and Generate Traces[​](#step-1-setup-and-generate-traces "Direct link to Step 1: Setup and Generate Traces")
...
### Step 3: Align and Register[​](#step-3-align-and-register "Direct link to Step 3: Align and Register")
...
* [**SIMBA**](/docs/3.11.1.dev0/genai/eval-monitor/scorers/llm-judge/simba.md) (default) - Uses DSPy's SIMBA algorithm for prompt optimization
* [**GEPA**](/docs/3.11.1.dev0/genai/eval-monitor/scorers/llm-judge/gepa.md) - Uses DSPy's GEPA algorithm with LLM-driven reflection for iterative refinement
* [**MemAlign**](/docs/3.11.1.dev0/genai/eval-monitor/scorers/llm-judge/memalign.md) (experimental) - Uses a dual-memory system for fast and cheap few-shot alignment

You can also [create custom optimizers](/docs/3.11.1.dev0/genai/eval-monitor/scorers/llm-judge/custom-optimizers.md) to implement domain-specific alignment strategies.
...
### Feedback Collection Approaches[​](#feedback-collection-approaches "Direct link to Feedback Collection Approaches")
...
4. **Select the assessment name** that matches your judge name (e.g., "product\_quality")
...
![MLflow UI Feedback Interface](/docs/3.11.1.dev0/images/assessments/add_feedback_ui.png)
...
### [Create Custom Judges](/docs/3.11.1.dev0/genai/eval-monitor/scorers/llm-judge/custom-judges.md)

[Learn to create domain-specific judges with make\_judge.](/docs/3.11.1.dev0/genai/eval-monitor/scorers/llm-judge/custom-judges.md)

[Create judges →](/docs/3.11.1.dev0/genai/eval-monitor/scorers/llm-judge/custom-judges.md)

### [Development Workflow](/docs/3.11.1.dev0/genai/eval-monitor/scorers/llm-judge/workflow.md)

[See complete workflow from creation to aligned production judge.](/docs/3.11.1.dev0/genai/eval-monitor/scorers/llm-judge/workflow.md)

[View workflow →](/docs/3.11.1.dev0/genai/eval-monitor/scorers/llm-judge/workflow.md)

### [Dataset Integration](/docs/3.11.1.dev0/genai/datasets.md)

[Use judges with evaluation datasets for systematic testing.](/docs/3.11.1.dev0/genai/datasets.md)

[Learn integration →](/docs/3.11.1.dev0/genai/datasets.md)
