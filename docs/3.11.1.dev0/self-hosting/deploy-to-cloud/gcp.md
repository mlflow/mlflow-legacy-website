...
![overall architecture](/docs/3.11.1.dev0/assets/images/gcp-deployment-arch-1e4cbc4611b1c869a4516bcc41e40712.png)
...
## Step 1: Create a docker image and upload it to GCP:[​](#step-1-create-a-docker-image-and-upload-it-to-gcp "Direct link to Step 1: Create a docker image and upload it to GCP:")
...
## Step 2: Create a bucket in Google Cloud Storage[​](#step-2-create-a-bucket-in-google-cloud-storage "Direct link to Step 2: Create a bucket in Google Cloud Storage")
...
![create bucket](/docs/3.11.1.dev0/assets/images/gcp-create-bucket-0f8ccfa4d6723c8cdb67d64171c1d23b.png)
...
![storage iam role](/docs/3.11.1.dev0/assets/images/storage-iam-role-1e685fd99465eff77745dbfc3f83270d.png)
...
![create cloud SQL instance](/docs/3.11.1.dev0/assets/images/gcp-create-cloud-sql-instance-21b02568bf9967e4ce927fff4db76aa9.png)
...
## Step 5: Create Cloud Run instance[​](#step-5-create-cloud-run-instance "Direct link to Step 5: Create Cloud Run instance")
...
![cloud run instance](/docs/3.11.1.dev0/assets/images/gcp-cloud-run-instance-d14de9d4b799d2b71f0d4bc7cca57c73.png)
...
## Step 6: Validate the deployment[​](#step-6-validate-the-deployment "Direct link to Step 6: Validate the deployment")
