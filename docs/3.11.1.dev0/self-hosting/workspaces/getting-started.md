...
* [Configuration](/docs/3.11.1.dev0/self-hosting/workspaces/configuration.md) - Learn about server configuration options
* [Workspace Providers](/docs/3.11.1.dev0/self-hosting/workspaces/workspace-providers.md) - Understand the provider architecture
* [Permissions](/docs/3.11.1.dev0/self-hosting/workspaces/permissions.md) - Configure workspace-scoped access control
