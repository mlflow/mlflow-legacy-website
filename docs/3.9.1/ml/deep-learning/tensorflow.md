...
[](/docs/3.9.1/images/deep-learning/tensorflow-training-ui.mp4)
...
For more control, use [`mlflow.tensorflow.MlflowCallback()`](/docs/3.9.1/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.MlflowCallback):
...
Save TensorFlow models with [`mlflow.tensorflow.log_model()`](/docs/3.9.1/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.log_model):
...
[Version and manage TensorFlow models](/docs/3.9.1/ml/model-registry.md)
