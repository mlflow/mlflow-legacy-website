...
Need help setting up tracing? Try [MLflow Assistant](/docs/3.9.1/genai/getting-started/try-assistant.md) - a powerful AI assistant that can add MLflow tracing to your project automatically.
...
![New Experiment](/docs/3.9.1/images/llms/tracing/quickstart/mlflow-ui-new-experiment.png)
...
For a comprehensive list of LLM providers supported by MLflow, see the [LLM Integrations Overview](/docs/3.9.1/genai/tracing/integrations.md).
...
For a deeper dive into using MLflow together with OpenTelemetry, see the [OpenTelemetry guide](/docs/3.9.1/genai/tracing/opentelemetry.md).
...
![Single Trace](/docs/3.9.1/images/llms/tracing/quickstart/single-openai-trace-list.png)

![Single Trace](/docs/3.9.1/images/llms/tracing/quickstart/single-openai-trace-detail.png)
...
For more details on tracking users and sessions, see the [Track Users & Sessions guide](/docs/3.9.1/genai/tracing/track-users-sessions.md).
...
### [Automatic Tracing](/docs/3.9.1/genai/tracing/app-instrumentation/automatic.md)

[Explore one-line automatic tracing for popular GenAI libraries and frameworks](/docs/3.9.1/genai/tracing/app-instrumentation/automatic.md)

[Enable auto-tracing →](/docs/3.9.1/genai/tracing/app-instrumentation/automatic.md)

### [Tracing UI](/docs/3.9.1/genai/tracing/observe-with-traces/ui.md)

[Learn how to explore and analyze your traces in the MLflow UI](/docs/3.9.1/genai/tracing/observe-with-traces/ui.md)

[View traces →](/docs/3.9.1/genai/tracing/observe-with-traces/ui.md)

### [Quality Test Traces](/docs/3.9.1/genai/eval-monitor/running-evaluation/traces.md)

[Run quality evaluations on your logged traces to ensure response accuracy](/docs/3.9.1/genai/eval-monitor/running-evaluation/traces.md)
