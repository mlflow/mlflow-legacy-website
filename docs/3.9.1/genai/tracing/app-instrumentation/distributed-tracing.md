...
* Use the [`mlflow.tracing.get_tracing_context_headers_for_http_request()`](/docs/3.9.1/api_reference/python_api/mlflow.tracing.html#mlflow.tracing.get_tracing_context_headers_for_http_request) API in the client to fetch headers.
* Use the [`mlflow.tracing.set_tracing_context_from_http_request_headers()`](/docs/3.9.1/api_reference/python_api/mlflow.tracing.html#mlflow.tracing.set_tracing_context_from_http_request_headers) API in the server to extract the trace and span information from the request headers and set them to current trac context.

![Tracing Decorator](/docs/3.9.1/assets/images/distributed-tracing-fe2c7bb6f698ad0135204756a8b57a3e.png)
