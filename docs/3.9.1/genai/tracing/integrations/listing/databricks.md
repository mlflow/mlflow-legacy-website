...
![Databricks Tracing](/docs/3.9.1/images/llms/tracing/basic-openai-trace.png)
...
MLflow supports tracing for streaming and async Databricks APIs. Visit the [OpenAI Tracing documentation](/docs/3.9.1/genai/tracing/integrations/listing/openai.md) for example code snippets for tracing streaming and async calls through OpenAI SDK.
