...
To create a custom alignment optimizer, extend the [AlignmentOptimizer](/docs/3.9.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.judges.base.AlignmentOptimizer) abstract base class:
