...
![Multi-turn evaluation results](/docs/3.9.1/images/genai/multi-turn-view.png)
...
[Learn more about conversation simulation →](/docs/3.9.1/genai/eval-monitor/running-evaluation/conversation-simulation.md)
...
You can also retrieve complete sessions directly using [`mlflow.search_sessions`](/docs/3.9.1/api_reference/python_api/mlflow.html#mlflow.search_sessions):
...
For complete documentation on conversation simulation, including test case definition, predict function interfaces, and configuration options, see the [Conversation Simulation guide](/docs/3.9.1/genai/eval-monitor/running-evaluation/conversation-simulation.md).
...
MLflow provides built-in multi-turn judges including `ConversationCompleteness`, `UserFrustration`, `KnowledgeRetention`, and more. See the [Built-in Judges](/docs/3.9.1/genai/eval-monitor/scorers/llm-judge/predefined.md#multi-turn) page for the full list, usage examples, and API documentation.
...
To evaluate a specific session, use [`mlflow.search_traces`](/docs/3.9.1/api_reference/python_api/mlflow.html#mlflow.search_traces) with a filter string:
...
### [Built-in Judges](/docs/3.9.1/genai/eval-monitor/scorers/llm-judge/predefined.md#multi-turn)
...
### [Conversation Simulation](/docs/3.9.1/genai/eval-monitor/running-evaluation/conversation-simulation.md)

[Generate synthetic conversations to test your agent with diverse scenarios and user behaviors.](/docs/3.9.1/genai/eval-monitor/running-evaluation/conversation-simulation.md)

[Simulate conversations →](/docs/3.9.1/genai/eval-monitor/running-evaluation/conversation-simulation.md)
