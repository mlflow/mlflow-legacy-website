...
![App basic information](/docs/3.9.1/assets/images/sso-okta-app-info-9365af0cc69abd2c1eaea6618f9cc4f1.png)
...
![callback setting](/docs/3.9.1/assets/images/sso-callback-setting-3124cf89e452a185873109970f304ed8.png)
...
![custom action setting](/docs/3.9.1/assets/images/sso-custom-action-574a3cb8aba9e4b4b4229fe01762180e.png)

Then in Okta account sidebar menu: Actions -> Triggers -> Sign up & Login: post-login, install the trigger as follows:

![custom action setting](/docs/3.9.1/assets/images/sso-install-trigger-d27a07510f656b6b28daa82ed0d5197a.png)
...
![custom action setting](/docs/3.9.1/assets/images/oidc-page-969e8ee4b1ef0c80bdbbfe0b2681b3c8.png)
...
![custom action setting](/docs/3.9.1/assets/images/sso-access-token-e12e7c6c03cb5819c0ebb8de421ef7f4.png)
