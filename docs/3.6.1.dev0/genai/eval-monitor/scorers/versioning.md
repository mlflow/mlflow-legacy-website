...
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| [Agent-as-a-Judge](/docs/3.6.1.dev0/genai/eval-monitor/scorers/llm-judge/agentic-overview.md)       | ✅                                                                                   |
| [Template-based LLM Scorers](/docs/3.6.1.dev0/genai/eval-monitor/scorers/llm-judge/make-judge.md)   | ✅                                                                                   |
| [Code-based Scorers](/docs/3.6.1.dev0/genai/eval-monitor/scorers/custom.md)                         | ✅                                                                                   |
| [Guidelines-based LLM Scorers](/docs/3.6.1.dev0/genai/eval-monitor/scorers/llm-judge/guidelines.md) | ❌ (Use [MLflow Prompt Registry](/docs/3.6.1.dev0/genai/prompt-registry.md) instead) |
| [Predefined Scorers](/docs/3.6.1.dev0/genai/eval-monitor/scorers/llm-judge/predefined.md)           | ❌ (Prompts are hard-coded in MLflow)                                                |
