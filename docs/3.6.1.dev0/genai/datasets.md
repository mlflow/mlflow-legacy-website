...
### [Dataset Structure](/docs/3.6.1.dev0/genai/concepts/evaluation-datasets.md)

[Understand how evaluation datasets organize test inputs, expectations, and metadata](/docs/3.6.1.dev0/genai/concepts/evaluation-datasets.md)

[Learn the concepts →](/docs/3.6.1.dev0/genai/concepts/evaluation-datasets.md)

### [SDK Guide](/docs/3.6.1.dev0/genai/datasets/sdk-guide.md)

[Complete guide to creating and managing evaluation datasets programmatically](/docs/3.6.1.dev0/genai/datasets/sdk-guide.md)

[View SDK guide →](/docs/3.6.1.dev0/genai/datasets/sdk-guide.md)

### [Evaluation Integration](/docs/3.6.1.dev0/genai/eval-monitor.md)

[Learn how to use datasets with MLflow's evaluation framework](/docs/3.6.1.dev0/genai/eval-monitor.md)

[Explore evaluation →](/docs/3.6.1.dev0/genai/eval-monitor.md)

## Next Steps[​](#next-steps "Direct link to Next Steps")

Ready to improve your GenAI testing? Start with these resources:

### [Setting Expectations](/docs/3.6.1.dev0/genai/assessments/expectations.md)

[Learn how to define ground truth and expected outputs for your AI system](/docs/3.6.1.dev0/genai/assessments/expectations.md)

[Define expectations →](/docs/3.6.1.dev0/genai/assessments/expectations.md)

### [Tracing Guide](/docs/3.6.1.dev0/genai/tracing.md)

[Capture detailed execution data from your GenAI applications](/docs/3.6.1.dev0/genai/tracing.md)

[Start tracing →](/docs/3.6.1.dev0/genai/tracing.md)

### [Evaluation Framework](/docs/3.6.1.dev0/genai/eval-monitor.md)

[Run systematic evaluations using your datasets with automated scorers](/docs/3.6.1.dev0/genai/eval-monitor.md)

[Learn evaluation →](/docs/3.6.1.dev0/genai/eval-monitor.md)
