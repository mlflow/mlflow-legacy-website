...
**[LLM Evaluation Guide](/docs/3.6.1.dev0/genai/eval-monitor.md)**: Learn how to evaluate your GenAI applications

**[Custom Metrics](/docs/3.6.1.dev0/genai/eval-monitor.md)**: Create domain-specific evaluation functions

**[Trace Analysis](/docs/3.6.1.dev0/genai/tracing/search-traces.md)**: Explore how to query and analyze trace data with feedback

**[Quality Monitoring](/docs/3.6.1.dev0/genai/tracing/prod-tracing.md)**: Set up ongoing quality assessment
