...
## Application Integrations[​](#application-integrations "Direct link to Application Integrations")
...
### Registering Models[​](#registering-models "Direct link to Registering Models")
...
### Monitoring and Logging[​](#monitoring-and-logging "Direct link to Monitoring and Logging")
...
### [Configuration Guide](/docs/3.6.1.dev0/genai/governance/ai-gateway/configuration.md)

[Learn how to configure providers and advanced settings](/docs/3.6.1.dev0/genai/governance/ai-gateway/configuration.md)
...
[Master basic querying and client usage patterns](/docs/3.6.1.dev0/genai/governance/ai-gateway/usage.md)

[Learn usage →](/docs/3.6.1.dev0/genai/governance/ai-gateway/usage.md)

### [Tutorial](/docs/3.6.1.dev0/genai/governance/ai-gateway/guides.md)

[Complete step-by-step walkthrough from setup to deployment](/docs/3.6.1.dev0/genai/governance/ai-gateway/guides.md)

[Follow tutorial →](/docs/3.6.1.dev0/genai/governance/ai-gateway/guides.md)
