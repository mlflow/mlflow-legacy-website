...
* [Example of using OpenAI Autologging](#example-of-using-openai-autologging)
* [FAQ](#faq)

## Quickstart[​](#quickstart "Direct link to Quickstart")

To get started with MLflow's OpenAI autologging, you simply need to call [`mlflow.openai.autolog()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.openai.html#mlflow.openai.autolog) at the beginning of your script or notebook. Enabling autologging with no argument overrides will enable tracing by default.

tip

The only element that is **enabled by default** when autologging is activated is the recording of trace information. You can read more about MLflow tracing [here](/docs/3.6.1.dev0/genai/tracing.md).
...
## Example of using OpenAI Autologging[​](#example-of-using-openai-autologging "Direct link to Example of using OpenAI Autologging")
...
![OpenAI Autologging artifacts and traces](/docs/3.6.1.dev0/assets/images/openai-autolog-bb60103a751343c4c1fa27f464e4f333.gif)

## FAQ[​](#faq "Direct link to FAQ")

### Are asynchronous APIs supported in autologging?[​](#are-asynchronous-apis-supported-in-autologging "Direct link to Are asynchronous APIs supported in autologging?")

The MLflow OpenAI autologging feature **does not support asynchronous APIs** for logging models or traces.

Saving your async implementation is best done by using the [models from code feature](/docs/3.6.1.dev0/ml/model/models-from-code.md).
