...
![MLflow 3 Landing Page](/docs/3.6.1.dev0/assets/images/landing-page-29cdaf74869d32d0f04cda4292762ecb.png)
...
First, we create a prompt template and register it with [MLflow Prompt Registry](/docs/3.6.1.dev0/genai/prompt-registry.md).
...
![The MLflow UI showing a prompt version](/docs/3.6.1.dev0/assets/images/ai_assistant_prompt-c4cf3d721fdf218fe7b84686a06e0808.png)
...
![The MLflow UI showing the logged model traces](/docs/3.6.1.dev0/assets/images/simple_example_traces-02326fd9400d4b9556178f37fb8e4592.png)
...
![The MLflow UI showing the models tab](/docs/3.6.1.dev0/assets/images/simple_example_models_tab-3f095d0d315e1162ca3d676d59127493.png)

![The MLflow UI showing the logged model](/docs/3.6.1.dev0/assets/images/simple_example_model-2e4308dadc59c0c42361949f5a628051.png)

Clicking on the source\_run takes you to the evaluation run's page with all the metrics:

![The MLflow UI showing the run and logged model](/docs/3.6.1.dev0/assets/images/simple_example_run_page-9db892145698174ce764fdfe7bb025e2.png)
...
[GenAI with MLflow 3](/docs/3.6.1.dev0/genai/mlflow-3/genai-agent.md)

[Discover how to log, evaluate, and trace GenAI agents using MLflow 3.](/docs/3.6.1.dev0/genai/mlflow-3/genai-agent.md)

[Deep Learning with MLflow 3](/docs/3.6.1.dev0/genai/mlflow-3/deep-learning.md)

[Learn how to leverage MLflow 3 to identify the best models in deep learning workflows.](/docs/3.6.1.dev0/genai/mlflow-3/deep-learning.md)
...
``` |
| Model artifacts storage location | model artifacts are stored as run artifacts.                                                                                                                                                         | Model artifacts are stored into models artifacts location. Note: this impacts the behavior of [list\_artifacts](/docs/3.6.1.dev0/api_reference/python_api/mlflow.client.html#mlflow.client.MlflowClient.list_artifacts) API.                                                                                                                                                                                                                                              |
...
Please refer to this [page](/docs/3.6.1.dev0/genai/mlflow-3/breaking-changes.md) for the full list of breaking changes in MLflow 3.
