...
You can delete traces based on specific criteria using the [`mlflow.client.MlflowClient.delete_traces()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.client.html#mlflow.client.MlflowClient.delete_traces) method. This method allows you to delete traces by **experiment ID**, **maximum timestamp**, or **trace IDs**.
...
## Deletion Methods[​](#deletion-methods "Direct link to Deletion Methods")
...
## Parameters Reference[​](#parameters-reference "Direct link to Parameters Reference")
