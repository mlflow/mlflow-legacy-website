...
This guide shows you how to programmatically query traces using the MLflow SDK for debugging, monitoring, and analysis. While the [Search Traces](/docs/3.6.1.dev0/genai/tracing/search-traces.md) guide covers comprehensive search functionality, this page focuses on practical SDK usage patterns for observability workflows. To learn more about detailed search syntax and filtering capabilities, see the [Search Traces](/docs/3.6.1.dev0/genai/tracing/search-traces.md) guide.

## Why Query Traces Programmatically?[​](#why-query-traces-programmatically "Direct link to Why Query Traces Programmatically?")
...
## Basic Query Methods[​](#basic-query-methods "Direct link to Basic Query Methods")

The [`mlflow.search_traces()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.search_traces) function returns trace data in two formats:
...
### Choosing the Right Return Type[​](#choosing-the-right-return-type "Direct link to Choosing the Right Return Type")
...
### Finding and Analyzing Errors[​](#finding-and-analyzing-errors "Direct link to Finding and Analyzing Errors")
...
### User Session Analysis[​](#user-session-analysis "Direct link to User Session Analysis")
...
**Use Time Windows**: Always filter by timestamp\_ms when analyzing recent data to keep queries fast and relevant.
...
**[MLflow Tracing UI](/docs/3.6.1.dev0/genai/tracing/observe-with-traces/ui.md)**: Learn the web interface for interactive trace exploration

**[Search Traces](/docs/3.6.1.dev0/genai/tracing/search-traces.md)**: Master advanced search and filtering techniques

**[Delete and Manage Traces](/docs/3.6.1.dev0/genai/tracing/observe-with-traces/delete-traces.md)**: Understand trace lifecycle management
