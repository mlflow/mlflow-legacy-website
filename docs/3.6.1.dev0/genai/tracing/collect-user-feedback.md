...
![Feedback in MLflow UI](/docs/3.6.1.dev0/assets/images/assessments_trace_detail_ui-d460aa8741ab1feca6d3fd1ac864bcd8.png)
...
![Create Feedback](/docs/3.6.1.dev0/assets/images/add_feedback_ui-d41b6141727bf92f5d87568ae5522ae1.png)

**Adding Additional Feedback:**

![Additional Feedback](/docs/3.6.1.dev0/assets/images/additional_feedback_ui-55514604c28b292d5b976cb56a30773a.png)
...
### [Feedback API Guide](/docs/3.6.1.dev0/genai/assessments/feedback.md)

[Comprehensive guide to all feedback APIs with advanced patterns and examples](/docs/3.6.1.dev0/genai/assessments/feedback.md)

[View API reference →](/docs/3.6.1.dev0/genai/assessments/feedback.md)

### [Feedback Concepts](/docs/3.6.1.dev0/genai/concepts/feedback.md)

[Deep dive into feedback architecture, schema, and best practices](/docs/3.6.1.dev0/genai/concepts/feedback.md)

[Learn concepts →](/docs/3.6.1.dev0/genai/concepts/feedback.md)

### [Search and Analyze Traces](/docs/3.6.1.dev0/genai/tracing/search-traces.md)

[Query traces with feedback data and analyze patterns for quality insights](/docs/3.6.1.dev0/genai/tracing/search-traces.md)

[Start analyzing →](/docs/3.6.1.dev0/genai/tracing/search-traces.md)
