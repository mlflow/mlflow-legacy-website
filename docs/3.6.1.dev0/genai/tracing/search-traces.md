...
![search components](/docs/3.6.1.dev0/assets/images/search_syntax-8db1091a58dda699e58cd3846c12cace.png)
...
5. **Status Filtering**: Filter by trace execution status (OK, ERROR, IN\_PROGRESS)

### Syntax Rules:[​](#syntax-rules "Direct link to Syntax Rules:")
...
## Filtering Traces in the UI[​](#filtering-traces-in-the-ui "Direct link to Filtering Traces in the UI")

Use the search box in the MLflow Trace UI to filter traces by various criteria using the same syntax described above.

![Search Traces UI](/docs/3.6.1.dev0/assets/images/search-traces-on-ui-0b3c9f96553ea37d8c654c5b33fe22f8.png)
...
[`mlflow.search_traces()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.search_traces) provides convenient trace search functionality:
...
The `return_type` parameter is available in MLflow 2.21.1+. For older versions, use [`mlflow.client.MlflowClient.search_traces()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.client.html#mlflow.client.MlflowClient.search_traces) for list output.

### Return Format[​](#return-format "Direct link to Return Format")

#### 1. DataFrame[​](#1-dataframe "Direct link to 1. DataFrame")
...
Alternatively, you can specify `return_type="list"` to get a list of [`mlflow.entities.Trace()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.entities.html#mlflow.entities.Trace) objects instead of a DataFrame.
...
### Extract Span Fields[​](#extract-span-fields "Direct link to Extract Span Fields")
...
[`mlflow.client.MlflowClient.search_traces()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.client.html#mlflow.client.MlflowClient.search_traces) supports pagination:
...
### Error Analysis[​](#error-analysis "Direct link to Error Analysis")
...
### Model Performance Comparison[​](#model-performance-comparison "Direct link to Model Performance Comparison")
...
### Creating Evaluation Datasets[​](#creating-evaluation-datasets "Direct link to Creating Evaluation Datasets")
...
### Environment Monitoring[​](#environment-monitoring "Direct link to Environment Monitoring")
...
## Create Example Traces[​](#create-example-traces "Direct link to Create Example Traces")
...
### Alternative Setup - Production-Like Traces[​](#alternative-setup---production-like-traces "Direct link to Alternative Setup - Production-Like Traces")
...
### Backend Considerations[​](#backend-considerations "Direct link to Backend Considerations")
