...
The Python quickstart is available [here](/docs/3.6.1.dev0/genai/tracing/quickstart/python-openai.md).
...
![New Experiment](/docs/3.6.1.dev0/images/llms/tracing/quickstart/mlflow-ui-new-experiment.png)
...
If [authentication](/docs/3.6.1.dev0/self-hosting/security/basic-http-auth.md) is enabled on the tracking server, you can pass the credential through `trackingServerUsername` and `trackingServerPassword`.
...
![Single Trace](/docs/3.6.1.dev0/images/llms/tracing/quickstart/single-openai-trace-list.png)
...
![Single Trace Detail](/docs/3.6.1.dev0/images/llms/tracing/quickstart/single-openai-trace-detail.png)
...
![Tool Calling Trace](/docs/3.6.1.dev0/images/llms/tracing/quickstart/openai-tool-calling-trace-detail.png)
...
![Tool Calling Trace Timeline](/docs/3.6.1.dev0/images/llms/tracing/quickstart/openai-tool-calling-trace-timeline.png)
...
![Feedback Input Form](/docs/3.6.1.dev0/images/llms/tracing/quickstart/openai-trace-feedback-input.png)

When you submit the form with "Create" button, the feedback will be attached to the trace.

![Feedback List](/docs/3.6.1.dev0/images/llms/tracing/quickstart/openai-trace-feedback-record.png)
...
![Feedback Aggregated](/docs/3.6.1.dev0/images/llms/tracing/quickstart/openai-trace-feedback-aggregate.png)
...
* [Typescript SDK Guide](/docs/3.6.1.dev0/genai/tracing/app-instrumentation/typescript-sdk.md): Learn more about how to use the Typescript SDK.
* [Automatic Evaluation](/docs/3.6.1.dev0/genai/eval-monitor.md): Learn how to set up automatic evaluation for traces using MLflow's GenAI evaluation feature.
