...
The [MLflow Tracing SDK `mlflow-tracing`](/docs/3.6.1.dev0/genai/tracing/lightweight-sdk.md) is a lightweight package that only includes the minimum set of dependencies to instrument your code/models/agents with MLflow Tracing.
...
Refer to the [tracking server setup guide](/docs/3.6.1.dev0/ml/tracking.md#tracking-setup) for more details.
...
MLflow Traces can be exported to any OpenTelemetry-compatible backend. See the [OpenTelemetry Integration](/docs/3.6.1.dev0/genai/tracing/opentelemetry/export.md) documentation for more details.
...
**[Debug & Observe Your App with Tracing](/docs/3.6.1.dev0/genai/tracing/observe-with-traces.md)**: Learn foundational observability concepts and techniques

**[Query Traces via SDK](/docs/3.6.1.dev0/genai/tracing/observe-with-traces/query-via-sdk.md)**: Understand how to programmatically access trace data for analysis

**[Track Users & Sessions](/docs/3.6.1.dev0/genai/tracing/track-users-sessions.md)**: Implement user and session context tracking for better monitoring insights
