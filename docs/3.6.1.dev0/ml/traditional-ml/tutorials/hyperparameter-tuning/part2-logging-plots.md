...
## Role of Visualizations in Model Analysis[​](#role-of-visualizations-in-model-analysis "Direct link to Role of Visualizations in Model Analysis")
...
### A Warning about Procedural Generation of Plots[​](#a-warning-about-procedural-generation-of-plots "Direct link to A Warning about Procedural Generation of Plots")
...
![Notebook state](/docs/3.6.1.dev0/assets/images/notebook-dangers-433eb6afa332607d1c3e7af4d59a3024.svg)
...
## Benefits of Integrating Visualizations with MLflow[​](#benefits-of-integrating-visualizations-with-mlflow "Direct link to Benefits of Integrating Visualizations with MLflow")
...
## Generating a Plot[​](#generating-a-plot "Direct link to Generating a Plot")
...
### Defining a Plot[​](#defining-a-plot "Direct link to Defining a Plot")
...
### Defining a Plot to be Saved Locally[​](#defining-a-plot-to-be-saved-locally "Direct link to Defining a Plot to be Saved Locally")
...
### Logging plot images[​](#logging-plot-images "Direct link to Logging plot images")
...
![Viewing plots in the UI](/docs/3.6.1.dev0/assets/images/plots-in-ui-a58dbe250b71f76b1c59fa89e871ea56.gif)
...
[Download the notebook](https://raw.githubusercontent.com/mlflow/mlflow/master/docs/docs/classic-ml/traditional-ml/tutorials/hyperparameter-tuning/notebooks/logging-plots-in-mlflow.ipynb)
