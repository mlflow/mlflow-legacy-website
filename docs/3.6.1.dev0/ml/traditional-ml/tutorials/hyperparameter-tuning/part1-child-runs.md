...
## Core Concepts of MLflow: Tags, Experiments, and Runs[​](#core-concepts-of-mlflow-tags-experiments-and-runs "Direct link to Core Concepts of MLflow: Tags, Experiments, and Runs")
...
![Tags, experiments, and runs relationships](/docs/3.6.1.dev0/assets/images/tag-exp-run-relationship-fc898eccc4bb05fe59f41372ab5f6b50.svg)

A model grouping hierarchy

### Key Aspects[​](#key-aspects "Direct link to Key Aspects")
...
## The Real-world Challenge: Hyperparameter Tuning[​](#the-real-world-challenge-hyperparameter-tuning "Direct link to The Real-world Challenge: Hyperparameter Tuning")
...
### Benefits of Hyperparameter Tuning[​](#benefits-of-hyperparameter-tuning "Direct link to Benefits of Hyperparameter Tuning")
...
![Challenges with hyperparameter data storage](/docs/3.6.1.dev0/assets/images/what-to-do-with-hyperparam-runs-f300784edeacd21609ad71852b184bd5.svg)
...
## What are Parent and Child Runs?[​](#what-are-parent-and-child-runs "Direct link to What are Parent and Child Runs?")
...
## Relationship between Experiments, Parent Runs, and Child Runs[​](#relationship-between-experiments-parent-runs-and-child-runs "Direct link to Relationship between Experiments, Parent Runs, and Child Runs")
...
### Naive Approach with no child runs[​](#naive-approach-with-no-child-runs "Direct link to Naive Approach with no child runs")
...
![Hyperparameter tuning no child runs](/docs/3.6.1.dev0/assets/images/no-child-first-ac9b59845a4d7aa095ec913220cc5913.gif)
...
![Adding more runs](/docs/3.6.1.dev0/assets/images/no-child-more-be952d9e9b8c849bf5b05290d49ce24a.gif)
...
### Adapting for Parent and Child Runs[​](#adapting-for-parent-and-child-runs "Direct link to Adapting for Parent and Child Runs")
...
![Using child runs](/docs/3.6.1.dev0/assets/images/child-runs-3a77b805cd47d1e997c3268c47b6d22d.gif)
...
[Download the notebook](https://raw.githubusercontent.com/mlflow/mlflow/master/docs/docs/classic-ml/traditional-ml/tutorials/hyperparameter-tuning/notebooks/parent-child-runs.ipynb)
...
![Challenge](/docs/3.6.1.dev0/assets/images/parent-child-challenge-b7198bdf22d9b91c5bff5de671e5f629.gif)
