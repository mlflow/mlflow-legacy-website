...
MLflow can automatically log metrics, parameters, and models from your TensorFlow training runs. Simply call [`mlflow.tensorflow.autolog()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.autolog) or [`mlflow.autolog()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.autolog) before your training code:
...
You can customize autologging behavior by passing arguments to [`mlflow.tensorflow.autolog()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.autolog):
...
MLflow provides [`mlflow.tensorflow.MlflowCallback`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.MlflowCallback) that offers the same functionality as autologging but with more explicit control:
...
If you haven't enabled autologging (which saves models automatically), you can manually save your TensorFlow model using [`mlflow.tensorflow.log_model()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.log_model):
...
![TensorFlow Model Signature](/docs/3.6.1.dev0/assets/images/tensorflow-model-signature-b99a17dca0d6d45fc0e0663f41824bf1.png)
