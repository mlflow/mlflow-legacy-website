...
## Setting Up Keras Backend[​](#setting-up-keras-backend "Direct link to Setting Up Keras Backend")
...
## Logging Keras Experiments to MLflow[​](#logging-keras-experiments-to-mlflow "Direct link to Logging Keras Experiments to MLflow")

### Autologging Keras Experiments[​](#autologging-keras-experiments "Direct link to Autologging Keras Experiments")

MLflow provides seamless autologging integration with Keras/TensorFlow. To enable automatic logging of metrics, parameters, and models, simply call [`mlflow.tensorflow.autolog()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.tensorflow.html#mlflow.tensorflow.autolog) or [`mlflow.autolog()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.autolog) before your training code.
...
#### Automatic Run Management[​](#automatic-run-management "Direct link to Automatic Run Management")
...
### Manually Logging Keras Experiments[​](#manually-logging-keras-experiments "Direct link to Manually Logging Keras Experiments")

For more control over what gets logged, you can manually instrument your Keras training code using MLflow's logging APIs:

* [`mlflow.log_metric()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_metric) / [`mlflow.log_metrics()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_metrics): Log metrics such as accuracy and loss during training
* [`mlflow.log_param()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_param) / [`mlflow.log_params()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_params): Log parameters such as learning rate and batch size
* [`mlflow.keras.log_model()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.keras.html#mlflow.keras.log_model): Save your Keras model to MLflow
* [`mlflow.log_artifact()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_artifact): Log artifacts such as model checkpoints and plots

#### Best Practices for Manual Logging[​](#best-practices-for-manual-logging "Direct link to Best Practices for Manual Logging")

When manually logging Keras experiments, follow these best practices:

* **Log training parameters** at the beginning of training via [`mlflow.log_params()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_params), including learning rate, batch size, epochs, etc.
* **Log model architecture** at the beginning of training via [`mlflow.log_artifact()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_artifact). You can save the model summary as a text file
* **Log training and validation metrics** inside your training loop or callbacks via [`mlflow.log_metric()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_metric)
* **Log your trained model** to MLflow via [`mlflow.keras.log_model()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.keras.html#mlflow.keras.log_model) at the end of training
* **\[Optional] Log model checkpoints** during training via [`mlflow.log_artifact()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_artifact) to preserve intermediate training states

#### Complete Manual Logging Example[​](#complete-manual-logging-example "Direct link to Complete Manual Logging Example")
...
## Using MLflow's Keras Callback[​](#using-mlflows-keras-callback "Direct link to Using MLflow's Keras Callback")

MLflow provides a built-in callback for Keras that simplifies experiment tracking. The [`mlflow.keras.MlflowCallback()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.keras.html#mlflow.keras.MlflowCallback) integrates seamlessly with your Keras training loop:
...
Save your trained Keras model using [`mlflow.keras.log_model()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.keras.html#mlflow.keras.log_model):
...
### Hyperparameter Tuning with Keras and MLflow[​](#hyperparameter-tuning-with-keras-and-mlflow "Direct link to Hyperparameter Tuning with Keras and MLflow")
