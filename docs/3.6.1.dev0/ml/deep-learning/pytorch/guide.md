...
#### Dynamic Computation Design[​](#dynamic-computation-design "Direct link to Dynamic Computation Design")
...
#### Powerful Ecosystem[​](#powerful-ecosystem "Direct link to Powerful Ecosystem")
...
## Logging PyTorch Experiments to MLflow[​](#logging-pytorch-experiments-to-mlflow "Direct link to Logging PyTorch Experiments to MLflow")

### Understanding PyTorch Autologging Limitations[​](#understanding-pytorch-autologging-limitations "Direct link to Understanding PyTorch Autologging Limitations")
...
### Manually Logging PyTorch Experiments[​](#manually-logging-pytorch-experiments "Direct link to Manually Logging PyTorch Experiments")

For standard PyTorch workflows, you can easily integrate MLflow logging into your training loops using these key APIs:

* [`mlflow.log_metric()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_metric) / [`mlflow.log_metrics()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_metrics): Log metrics like accuracy and loss during training
* [`mlflow.log_param()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_param) / [`mlflow.log_params()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_params): Log parameters like learning rate and batch size
* [`mlflow.pytorch.log_model()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.pytorch.html#mlflow.pytorch.log_model): Save your PyTorch model to MLflow
* [`mlflow.log_artifact()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_artifact): Log artifacts like model checkpoints and visualizations

Best Practices for PyTorch Logging

#### Initialization Phase[​](#initialization-phase "Direct link to Initialization Phase")

* 📋 **Log Configuration Parameters**: Use [`mlflow.log_params()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_params) at the beginning of training to record learning rate, batch size, optimizer configuration, etc.
* 🏗️ **Log Model Architecture**: Use `torchinfo` to generate a model summary and log it via [`mlflow.log_artifact()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_artifact)
* ⚙️ **Log Dependencies**: Record PyTorch version and key packages to ensure reproducibility

#### Training Phase[​](#training-phase "Direct link to Training Phase")

* 📊 **Batch vs. Epoch Logging**: For long epochs, log key metrics every N batches; otherwise, log per epoch
* 📈 **Use Batched Logging**: Prefer [`mlflow.log_metrics()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_metrics) over multiple [`mlflow.log_metric()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.html#mlflow.log_metric) calls for better performance
* 🔄 **Track Training Dynamics**: Log not just final metrics but their evolution throughout training

#### Finalization Phase[​](#finalization-phase "Direct link to Finalization Phase")

* 💾 **Save Final Model**: Use [`mlflow.pytorch.log_model()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.pytorch.html#mlflow.pytorch.log_model) to save the trained model
...
### Complete PyTorch Logging Example[​](#complete-pytorch-logging-example "Direct link to Complete PyTorch Logging Example")
...
![Basic Example of PyTorch with MLflow](/docs/3.6.1.dev0/assets/images/pytorch-guide-basic-example-ui-cf99aaf7644ae4e390f28f6be1ba594c.png)

## Saving Your PyTorch Model to MLflow[​](#saving-your-pytorch-model-to-mlflow "Direct link to Saving Your PyTorch Model to MLflow")
...
![Basic PyTorch Saving](/docs/3.6.1.dev0/assets/images/pytorch-guide-basic-saving-af066edf360c780042fd3085792ec1d2.png)
...
![PyTorch Model Signature](/docs/3.6.1.dev0/assets/images/pytorch-guide-model-signature-f8e63d83e73f9283d985016616ae1cab.png)
...
## Advanced PyTorch Tracking[​](#advanced-pytorch-tracking "Direct link to Advanced PyTorch Tracking")

### Custom Training Loop with Detailed Metrics[​](#custom-training-loop-with-detailed-metrics "Direct link to Custom Training Loop with Detailed Metrics")

For more sophisticated tracking, you can implement custom callbacks and visualizations:

Comprehensive Tracking with Visualizations
