...
## Logging spaCy Models to MLflow[​](#logging-spacy-models-to-mlflow "Direct link to Logging spaCy Models to MLflow")

### Basic Model Logging[​](#basic-model-logging "Direct link to Basic Model Logging")

MLflow provides native support for spaCy models through the [`mlflow.spacy.log_model()`](/docs/3.6.1.dev0/api_reference/python_api/mlflow.spacy.html#mlflow.spacy.log_model) function:
...
#### Model Components & Architecture[​](#model-components--architecture "Direct link to Model Components & Architecture")
...
#### Dependencies & Environment[​](#dependencies--environment "Direct link to Dependencies & Environment")
...
#### Deployment Artifacts[​](#deployment-artifacts "Direct link to Deployment Artifacts")
...
### Automatic PyFunc Flavor for Text Classification[​](#automatic-pyfunc-flavor-for-text-classification "Direct link to Automatic PyFunc Flavor for Text Classification")
...
#### Automatic PyFunc Generation[​](#automatic-pyfunc-generation "Direct link to Automatic PyFunc Generation")
...
#### Input/Output Format[​](#inputoutput-format "Direct link to Input/Output Format")
...
#### Deployment Benefits[​](#deployment-benefits "Direct link to Deployment Benefits")
...
## Advanced spaCy Training with MLflow Integration[​](#advanced-spacy-training-with-mlflow-integration "Direct link to Advanced spaCy Training with MLflow Integration")

### Custom Training Logger[​](#custom-training-logger "Direct link to Custom Training Logger")
...
#### Configuration File Integration[​](#configuration-file-integration "Direct link to Configuration File Integration")
...
### Complete Training Integration Example[​](#complete-training-integration-example "Direct link to Complete Training Integration Example")
...
### Basic Model Operations[​](#basic-model-operations "Direct link to Basic Model Operations")
...
#### Native spaCy Loading[​](#native-spacy-loading "Direct link to Native spaCy Loading")
...
### Model Signatures for spaCy Models[​](#model-signatures-for-spacy-models "Direct link to Model Signatures for spaCy Models")
...
## Advanced spaCy Tracking Patterns[​](#advanced-spacy-tracking-patterns "Direct link to Advanced spaCy Tracking Patterns")

### Custom Component Tracking[​](#custom-component-tracking "Direct link to Custom Component Tracking")
...
### Pipeline Optimization Tracking[​](#pipeline-optimization-tracking "Direct link to Pipeline Optimization Tracking")
...
### Local Model Serving[​](#local-model-serving "Direct link to Local Model Serving")
