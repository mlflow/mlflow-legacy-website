...
## Quick Start: Automatic SHAP Explanations[​](#quick-start-automatic-shap-explanations "Direct link to Quick Start: Automatic SHAP Explanations")
...
## Understanding SHAP Outputs[​](#understanding-shap-outputs "Direct link to Understanding SHAP Outputs")

### Feature Importance Visualization[​](#feature-importance-visualization "Direct link to Feature Importance Visualization")
...
![](/docs/3.6.1.dev0/assets/images/model_evaluation_feature_importance-e3b91eb353333c150ec7b4e91f67f5f4.png)

Shap feature importances logged to MLflow when Shap evaluation is enabled

### Configuring SHAP Explanations[​](#configuring-shap-explanations "Direct link to Configuring SHAP Explanations")
...
#### Explainer Types[​](#explainer-types "Direct link to Explainer Types")
...
#### Output Control[​](#output-control "Direct link to Output Control")
...
## Working with SHAP Explainers[​](#working-with-shap-explainers "Direct link to Working with SHAP Explainers")

* Loading & Using Explainers
...
#### Summary Plots[​](#summary-plots "Direct link to Summary Plots")

* **Bar plots**: Average feature importance across all predictions
* **Dot plots**: Feature importance distribution showing positive/negative impacts
* **Violin plots**: Distribution of SHAP values for each feature

#### Individual Explanations[​](#individual-explanations "Direct link to Individual Explanations")

* **Waterfall plots**: Step-by-step breakdown of a single prediction
* **Force plots**: Visual representation of feature contributions
* **Decision plots**: Path through feature space for predictions

## Production SHAP Workflows[​](#production-shap-workflows "Direct link to Production SHAP Workflows")
...
## Best Practices and Use Cases[​](#best-practices-and-use-cases "Direct link to Best Practices and Use Cases")

### When to Use SHAP Integration[​](#when-to-use-shap-integration "Direct link to When to Use SHAP Integration")
...
## Integration with MLflow Model Registry[​](#integration-with-mlflow-model-registry "Direct link to Integration with MLflow Model Registry")
