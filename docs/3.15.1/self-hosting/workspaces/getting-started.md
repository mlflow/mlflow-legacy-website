...
## Step 2: Create a Workspace[​](#step-2-create-a-workspace "Direct link to Step 2: Create a Workspace")
...
### Workspace Naming Rules[​](#workspace-naming-rules "Direct link to Workspace Naming Rules")
...
## Step 3: Grant Workspace Permissions (Optional)[​](#step-3-grant-workspace-permissions-optional "Direct link to Step 3: Grant Workspace Permissions (Optional)")
...
## Step 4: Use Workspaces from Python Client[​](#step-4-use-workspaces-from-python-client "Direct link to Step 4: Use Workspaces from Python Client")
...
## Managing Workspaces[​](#managing-workspaces "Direct link to Managing Workspaces")
...
### Get Workspace Details[​](#get-workspace-details "Direct link to Get Workspace Details")
...
### REST API Alternatives[​](#rest-api-alternatives "Direct link to REST API Alternatives")
...
## Using REST APIs with Workspaces[​](#using-rest-apis-with-workspaces "Direct link to Using REST APIs with Workspaces")
...
* [Configuration](/docs/3.15.1/self-hosting/workspaces/configuration.md) - Learn about server configuration options
* [Workspace Providers](/docs/3.15.1/self-hosting/workspaces/workspace-providers.md) - Understand the provider architecture
* [Permissions](/docs/3.15.1/self-hosting/workspaces/permissions.md) - Configure workspace-scoped access control
