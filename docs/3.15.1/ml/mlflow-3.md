...
This change impacts the behavior of [`mlflow.client.MlflowClient.list_artifacts()`](/docs/3.15.1/api_reference/python_api/mlflow.client.html#mlflow.client.MlflowClient.list_artifacts). Model artifacts are no longer stored as run artifacts.
...
Use [`mlflow.models.update_model_requirements()`](/docs/3.15.1/api_reference/python_api/mlflow.models.html#mlflow.models.update_model_requirements):
