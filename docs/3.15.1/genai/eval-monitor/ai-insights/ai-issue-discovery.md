...
* MLflow MCP server (see [MCP setup guide](/docs/3.15.1/genai/mcp.md))
...
* **Environment Variables**: Use pre-configured MLflow environment variables like `MLFLOW_TRACKING_URI` (see [environment setup guide](/docs/3.15.1/genai/getting-started/connect-environment.md))

![Setup and Authentication](/docs/3.15.1/images/genai/ai-issue-discovery/setup-authentication.png)
...
![Experiment Selection](/docs/3.15.1/images/genai/ai-issue-discovery/experiment-selection.png)
...
![Agent Purpose Identification](/docs/3.15.1/images/genai/ai-issue-discovery/agent-purpose.png)
...
![Hypothesis-Driven Analysis](/docs/3.15.1/images/genai/ai-issue-discovery/hypothesis-analysis.png)
...
![Report Generation](/docs/3.15.1/images/genai/ai-issue-discovery/report-generation.png)
