...
If you're also tracing your agent, see the [Google ADK tracing integration](/docs/3.15.1/genai/tracing/integrations/listing/google-adk.md) for one-line auto-tracing setup. The deterministic scorers on this page read tool calls directly from those traces.
...
| ------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- | --------------------------------------------------- |
| [ToolTrajectory](/docs/3.15.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.google_adk.ToolTrajectory) | Does the agent call the correct tools in the expected order?         | [Link](https://google.github.io/adk-docs/evaluate/) |
| [ResponseMatch](/docs/3.15.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.google_adk.ResponseMatch)   | How similar is the agent's response to a reference answer (ROUGE-1)? | [Link](https://google.github.io/adk-docs/evaluate/) |
...
| Scorer                                                                                                                           | What does it evaluate?                                             | ADK Docs                                            |
| -------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------ | --------------------------------------------------- |
| [ResponseEvaluation](/docs/3.15.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.google_adk.ResponseEvaluation) | Does the agent's response match the expected response (LLM judge)? | [Link](https://google.github.io/adk-docs/evaluate/) |
| [Safety](/docs/3.15.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.google_adk.Safety)                         | Is the agent's response safe and free of harmful content?          | [Link](https://google.github.io/adk-docs/evaluate/) |
| [Hallucination](/docs/3.15.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.google_adk.Hallucination)           | Is the agent's response factually grounded (not hallucinated)?     | [Link](https://google.github.io/adk-docs/evaluate/) |

note

LLM judge scorers require a model that ADK's `LlmRegistry` can resolve, such as `gemini-2.5-flash`. MLflow model URIs like `databricks` or `openai:/gpt-4o` aren't supported here, because ADK's evaluators wire directly into Google's model registry. If you need an OpenAI, Anthropic, or Databricks judge backend, the [TruLens](/docs/3.15.1/genai/eval-monitor/scorers/third-party/trulens.md) and [DeepEval](/docs/3.15.1/genai/eval-monitor/scorers/third-party/deepeval.md) integrations cover the broader provider set.
...
You can also create Google ADK scorers dynamically using [get\_scorer](/docs/3.15.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.google_adk.get_scorer):
...
### [Predefined Scorers](/docs/3.15.1/genai/eval-monitor/scorers/llm-judge/predefined.md)

[Explore MLflow's built-in evaluation scorers](/docs/3.15.1/genai/eval-monitor/scorers/llm-judge/predefined.md)
