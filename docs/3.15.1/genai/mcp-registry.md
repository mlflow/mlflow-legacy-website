...
![Create MCP Server UI](/docs/3.15.1/assets/images/register-mcp-server-ui-867e86cdd8569d4f17293586dda577e3.png)
...
To register an MCP server using the Python API, use [`mlflow.genai.register_mcp_server()`](/docs/3.15.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.register_mcp_server):
...
![MCP Registry Server List](/docs/3.15.1/assets/images/mcp-registry-server-list-0225beb40302aea424c5d961f5b8407f.png)
...
Use [`mlflow.genai.search_mcp_servers()`](/docs/3.15.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.search_mcp_servers) to find registered servers:
...
![Create Access Endpoint](/docs/3.15.1/assets/images/create-access-endpoint-e4934d6b1c0564932f1a6fe9da806d0b.png)
...
Use [`mlflow.genai.create_mcp_access_endpoint()`](/docs/3.15.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.create_mcp_access_endpoint) to register a connection endpoint:
...
* [Register MCP Servers](/docs/3.15.1/genai/mcp-registry/register-mcp-servers.md) — detailed guide for registration methods and `server_json` structure
* [Manage Versions and Aliases](/docs/3.15.1/genai/mcp-registry/manage-versions-and-aliases.md) — versioning, status lifecycle, aliases, and tags
* [Connect to MCP Servers](/docs/3.15.1/genai/mcp-registry/connect-to-servers.md) — access endpoints, connection instructions, and tool discovery
