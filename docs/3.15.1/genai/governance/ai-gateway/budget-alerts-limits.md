...
![Budget policies list](/docs/3.15.1/images/budget-policies-list.png)
...
![Create budget policy dialog](/docs/3.15.1/images/budget-policies-create.png)
...
When [authentication](/docs/3.15.1/self-hosting/security/basic-http-auth.md) is enabled for the tracking server, only admin users can create, update, or delete budget policies.
