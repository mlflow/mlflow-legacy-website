...
To create a new prompt programmatically, use the [`mlflow.genai.register_prompt()`](/docs/3.15.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.register_prompt) function. This is particularly useful for automating prompt creation or managing prompts as part of a larger script.
...
To create a new version of an existing prompt, you again use the [`mlflow.genai.register_prompt()`](/docs/3.15.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.register_prompt) function, but this time, you provide the `name` of an existing prompt. MLflow will automatically increment the version number.
...
![Compare Prompt Versions](/docs/3.15.1/assets/images/compare-prompt-versions-cfb444eca59dc0c2e14b98d480aa2c17.png)
