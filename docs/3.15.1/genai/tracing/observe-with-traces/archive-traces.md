...
Trace archival lets MLflow move older trace span payloads out of the SQL tracking store and into a configured archive artifact location while keeping the traces readable in the UI and APIs. To enable trace archival on a self-hosted server, see [MLflow Tracking Server](/docs/3.15.1/self-hosting/architecture/tracking-server.md).
...
![Trace archival flow](/docs/3.15.1/images/llms/tracing/archive-diagram.svg)
...
| Workspace  | [`mlflow.create_workspace()`](/docs/3.15.1/api_reference/python_api/mlflow.html#mlflow.create_workspace) / [`mlflow.update_workspace()`](/docs/3.15.1/api_reference/python_api/mlflow.html#mlflow.update_workspace) with `TraceArchivalConfig` | Workspace-specific archive location and retention defaults           |
...
![Archive after badge in the trace list](/docs/3.15.1/images/llms/tracing/archive-after-badge.png)
...
For workspace-specific setup, see [Getting Started with Workspaces](/docs/3.15.1/self-hosting/workspaces/getting-started.md).
...
* If you need to remove old traces permanently rather than move their payloads, use [Delete Traces](/docs/3.15.1/genai/tracing/observe-with-traces/delete-traces.md).

For related workflows, see [View Traces](/docs/3.15.1/genai/tracing/observe-with-traces/ui.md) and [Search Traces](/docs/3.15.1/genai/tracing/search-traces.md).
