...
[](/docs/3.15.1/images/llms/tracing/trace-set-tag.mp4)

## Setting Tags on Ongoing Traces[​](#setting-tags-on-ongoing-traces "Direct link to Setting Tags on Ongoing Traces")

Use [`mlflow.update_current_trace()`](/docs/3.15.1/api_reference/python_api/mlflow.html#mlflow.update_current_trace) to add tags during trace execution.
...
If the key is already present, the [`mlflow.update_current_trace()`](/docs/3.15.1/api_reference/python_api/mlflow.html#mlflow.update_current_trace) function will update the key with the new value.
