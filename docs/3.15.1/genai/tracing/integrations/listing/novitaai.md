...
[MLflow Tracing](/docs/3.15.1/genai/tracing/integrations.md) provides automatic tracing capability for <!-- -->Novita AI<!-- --> models through the OpenAI SDK integration. Since <!-- -->Novita AI<!-- --> offers an OpenAI-compatible API format, you can use<!-- --> `mlflow.openai.autolog()` to trace interactions with <!-- -->Novita AI<!-- --> models.

![Tracing via autolog](/docs/3.15.1/images/llms/tracing/openai-function-calling.png)
...
![Novita AI Tracing](/docs/3.15.1/images/llms/tracing/basic-openai-trace.png)
...
MLflow supports tracing for streaming and async <!-- -->Novita AI<!-- --> APIs. Visit the<!-- --> [OpenAI Tracing documentation](/docs/3.15.1/genai/tracing/integrations/listing/openai.md) for example code snippets for tracing streaming and async calls through OpenAI SDK.

## Combine with frameworks or manual tracing

The automatic tracing capability in MLflow is designed to work seamlessly with the<!-- --> [Manual Tracing SDK](/docs/3.15.1/genai/tracing/app-instrumentation/manual-tracing.md) or multi-framework integrations. The examples below show Python (manual span) and JS/TS (manual span) at the same level of complexity.
...
![Novita AI Tracing with Manual Tracing](/docs/3.15.1/images/llms/tracing/openai-trace-with-manual-span.png)
