...
Or use [Docker Compose](/docs/3.15.1/self-hosting.md#docker-compose):
...
[Search and filter traces to find specific agent sessions.](/docs/3.15.1/genai/tracing/search-traces.md)
