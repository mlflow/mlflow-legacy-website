...
![Agno Tracing via autolog](/docs/3.15.1/images/llms/agno/agno-tracing-basic.png)
...
[MLflow Tracing](/docs/3.15.1/genai/tracing/integrations.md) provides automatic tracing capability for Agno. By enabling auto tracing for Agno by calling the [`mlflow.agno.autolog()`](/docs/3.15.1/api_reference/python_api/mlflow.agno.html#mlflow.agno.autolog) function, MLflow will capture traces for Agent invocation and log them to the active MLflow Experiment.
...
![Agno Tracing via autolog](/docs/3.15.1/images/llms/agno/agno-tracing.png)
