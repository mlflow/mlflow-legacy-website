...
![Update Version Status](/docs/3.15.1/assets/images/update-version-status-dda3bf8ca2a24b28df00dfd6ef341405.png)
...
Use [`mlflow.genai.update_mcp_server_version()`](/docs/3.15.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.update_mcp_server_version) to change status:
...
![Compare MCP Server Versions](/docs/3.15.1/assets/images/compare-versions-6a5ac31e53f5c2b330710bc6457e5e05.png)
...
![Create MCP Server Alias](/docs/3.15.1/assets/images/create-alias-dfcdde16fa3d6664c4e0e3d54985766e.png)
