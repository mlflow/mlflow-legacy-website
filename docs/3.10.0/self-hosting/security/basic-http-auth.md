...
| [Search Model Versions](/docs/3.10.0/api_reference/rest-api.html/#mlflowmodelregistryservicesearchmodelversions)                  | `2.0/mlflow/model-versions/search`                 | `GET`    | None                |
...
| [Search Model Versions](/docs/3.10.0/api_reference/rest-api.html/#mlflowmodelregistryservicesearchmodelversions)       | `2.0/mlflow/model-versions/search`    | `GET`  | Only returns registered models which the user has `READ` permission on. |
