...
![Claude Code Tracing via CLI autolog](/docs/3.10.0/assets/images/claude-code-tracing-b1f69a5ecbf65655844589733ee28896.png)

[MLflow Tracing](/docs/3.10.0/genai/tracing.md) provides automatic tracing for Claude Code:
