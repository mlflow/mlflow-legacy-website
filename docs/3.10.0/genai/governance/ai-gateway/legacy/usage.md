...
### [Gateway Overview](/docs/3.10.0/genai/governance/ai-gateway.md)

[Return to the AI Gateway overview page](/docs/3.10.0/genai/governance/ai-gateway.md)

[View overview →](/docs/3.10.0/genai/governance/ai-gateway.md)

### [Configuration Guide](/docs/3.10.0/genai/governance/ai-gateway/legacy/configuration.md)

[Learn how to configure providers and advanced settings](/docs/3.10.0/genai/governance/ai-gateway/legacy/configuration.md)

[Configure providers →](/docs/3.10.0/genai/governance/ai-gateway/legacy/configuration.md)

### [Setup Guide](/docs/3.10.0/genai/governance/ai-gateway/legacy/setup.md)

[Get started with installation and environment setup](/docs/3.10.0/genai/governance/ai-gateway/legacy/setup.md)

[View setup →](/docs/3.10.0/genai/governance/ai-gateway/legacy/setup.md)
