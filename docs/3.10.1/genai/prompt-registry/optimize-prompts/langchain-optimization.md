...
![LangChain Logo](/docs/3.10.1/images/logos/langchain-logo.png)

This guide demonstrates how to leverage [`mlflow.genai.optimize_prompts()`](/docs/3.10.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.optimize_prompts) alongside [LangChain](https://python.langchain.com/) to enhance your chain's prompts automatically. The [`mlflow.genai.optimize_prompts()`](/docs/3.10.1/api_reference/python_api/mlflow.genai.html#mlflow.genai.optimize_prompts) API is framework-agnostic, enabling you to perform end-to-end prompt optimization of your chains from any framework using state-of-the-art techniques. For more information about the API, please visit [Optimize Prompts](/docs/3.10.1/genai/prompt-registry/optimize-prompts.md).
