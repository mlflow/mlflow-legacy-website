...
### [Quickstart](/docs/3.10.1/genai/governance/ai-gateway/quickstart.md)

[Get your AI Gateway running in minutes with a simple walkthrough](/docs/3.10.1/genai/governance/ai-gateway/quickstart.md)

[Get started →](/docs/3.10.1/genai/governance/ai-gateway/quickstart.md)

### [API Keys](/docs/3.10.1/genai/governance/ai-gateway/api-keys/create-and-manage.md)

[Create and manage API keys for secure credential management](/docs/3.10.1/genai/governance/ai-gateway/api-keys/create-and-manage.md)

[Manage keys →](/docs/3.10.1/genai/governance/ai-gateway/api-keys/create-and-manage.md)

### [Endpoints](/docs/3.10.1/genai/governance/ai-gateway/endpoints/create-and-manage.md)

[Create, configure, and query AI model endpoints](/docs/3.10.1/genai/governance/ai-gateway/endpoints/create-and-manage.md)

[Configure endpoints →](/docs/3.10.1/genai/governance/ai-gateway/endpoints/create-and-manage.md)

### [Traffic Routing](/docs/3.10.1/genai/governance/ai-gateway/traffic-routing-fallbacks.md)

[Configure traffic splitting and fallbacks for high availability](/docs/3.10.1/genai/governance/ai-gateway/traffic-routing-fallbacks.md)

[Learn routing →](/docs/3.10.1/genai/governance/ai-gateway/traffic-routing-fallbacks.md)

### [Usage Tracking](/docs/3.10.1/genai/governance/ai-gateway/usage-tracking.md)

[Monitor endpoint usage, performance, token consumption, and costs](/docs/3.10.1/genai/governance/ai-gateway/usage-tracking.md)

[View metrics →](/docs/3.10.1/genai/governance/ai-gateway/usage-tracking.md)

### [Authentication](/docs/3.10.1/self-hosting/security/basic-http-auth.md#ai-gateway-permissions)

[Configure HTTP Basic Authentication for AI Gateway resources](/docs/3.10.1/self-hosting/security/basic-http-auth.md#ai-gateway-permissions)

[Learn more →](/docs/3.10.1/self-hosting/security/basic-http-auth.md#ai-gateway-permissions)
