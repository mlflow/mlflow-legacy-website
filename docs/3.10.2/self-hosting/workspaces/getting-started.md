...
* [Configuration](/docs/3.10.2/self-hosting/workspaces/configuration.md) - Learn about server configuration options
* [Workspace Providers](/docs/3.10.2/self-hosting/workspaces/workspace-providers.md) - Understand the provider architecture
* [Permissions](/docs/3.10.2/self-hosting/workspaces/permissions.md) - Configure workspace-scoped access control
