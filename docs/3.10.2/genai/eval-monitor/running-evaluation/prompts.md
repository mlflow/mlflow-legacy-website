...
Prompts are the core components of LLM applications and AI agents. However, iterating over prompts can be challenging because it is hard to know if the new prompt is better than the old one. MLflow provides a framework to systematically evaluate prompt templates and track performance over time. MLflow can also [optimize prompts automatically](https://mlflow.org/prompt-optimization) using algorithms that improve your prompts based on evaluation data. See the [optimization guide](/docs/3.10.2/genai/prompt-registry/optimize-prompts.md) to get started.

![Prompt Evaluation](/docs/3.10.2/images/mlflow-3/eval-monitor/prompt-evaluation-hero.png)
...
Let's define a simple prompt template to evaluate. We use [MLflow Prompt Registry](/docs/3.10.2/genai/prompt-registry.md) to save the prompt and version control it, but it is optional for evaluation.
...
Finally, let's define a few [scorers](/docs/3.10.2/genai/eval-monitor/scorers.md) that decide the evaluation criteria. Here we use two types of scorers:
...
![Prompt Evaluation](/docs/3.10.2/images/mlflow-3/eval-monitor/prompt-evaluation-results.png)

By clicking on the each row in the result, you can open the trace and see the detailed score and rationale.

![Prompt Evaluation](/docs/3.10.2/images/mlflow-3/eval-monitor/prompt-evaluation-trace.png)
...
![Prompt Evaluation](/docs/3.10.2/images/mlflow-3/eval-monitor/prompt-evaluation-dropdown.png)
...
![Prompt Evaluation](/docs/3.10.2/images/mlflow-3/eval-monitor/prompt-evaluation-compare.png)

## Next steps[​](#next-steps "Direct link to Next steps")

### [Customize Scorers](/docs/3.10.2/genai/eval-monitor/scorers.md)

[Build specialized evaluation metrics for your specific use cases and requirements.](/docs/3.10.2/genai/eval-monitor/scorers.md)

[Learn about custom scorers →](/docs/3.10.2/genai/eval-monitor/scorers.md)

### [Evaluate Agents](/docs/3.10.2/genai/eval-monitor/running-evaluation/agents.md)

[Evaluate complex AI agents with tool calling and multi-step workflows.](/docs/3.10.2/genai/eval-monitor/running-evaluation/agents.md)

[Evaluate agents →](/docs/3.10.2/genai/eval-monitor/running-evaluation/agents.md)

### [Optimize Prompts](/docs/3.10.2/genai/prompt-registry/optimize-prompts.md)

[Use automated optimization techniques to systematically improve your prompts.](/docs/3.10.2/genai/prompt-registry/optimize-prompts.md)
