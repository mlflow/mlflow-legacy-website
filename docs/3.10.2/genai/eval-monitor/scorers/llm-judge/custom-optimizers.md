...
To create a custom alignment optimizer, extend the [AlignmentOptimizer](/docs/3.10.2/api_reference/python_api/mlflow.genai.html#mlflow.genai.judges.base.AlignmentOptimizer) abstract base class:
