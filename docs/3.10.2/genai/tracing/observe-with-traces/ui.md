...
[](/docs/3.10.2/images/llms/tracing/overview_demo.mp4)
...
![Experiment Overview Usage Tab](/docs/3.10.2/assets/images/overview_usage_tab-3f972858bec76adaebb876f6c93c1fd7.png)
...
* **Quality Insights**: Displays metrics computed by [scorers](/docs/3.10.2/genai/eval-monitor/scorers.md), with a dedicated chart for each assessment type
* Charts are dynamically generated based on the assessments available in your traces

![Experiment Overview Quality Tab](/docs/3.10.2/assets/images/overview_quality_tab-2b09e28d9fb24da7c01b85ac8fc912ca.png)
...
![Experiment Overview Tool Calls Tab](/docs/3.10.2/assets/images/overview_tool_calls_tab-52fa54220793d89710cde32b4cb00def.png)

## Traces within MLflow Experiments[​](#traces-within-mlflow-experiments "Direct link to Traces within MLflow Experiments")

After logging your traces, you can view them in the [MLflow UI](/docs/3.10.2/genai/tracing/observe-with-traces/ui.md), under the "Traces" tab in the main experiment page. This tab is also available within the individual run pages, if your trace was logged within a run context.

![MLflow Tracking UI](/docs/3.10.2/assets/images/trace-experiment-ui-1e174436e7842bab2320c79e501839a4.png)
...
Using the search bar in the UI, you can easily filter your traces based on name, tags, or other metadata. Check out the [search docs](/docs/3.10.2/genai/tracing/search-traces.md) for details about the query string format.

[](/docs/3.10.2/images/llms/tracing/trace-session-id.mp4)
...
[](/docs/3.10.2/images/llms/tracing/trace-delete.mp4)

You can also edit key-value tags on your traces via the UI.

[](/docs/3.10.2/images/llms/tracing/trace-set-tag.mp4)
...
![Image content rendered inline in the trace viewer](/docs/3.10.2/assets/images/trace-image-content-a17f5ef35bd737c5ccd1c9927b6e1177.png)
...
![Audio content rendered with an inline player in the trace viewer](/docs/3.10.2/assets/images/trace-audio-player-9cff82ff97b49b3b9f962c06023214b2.png)
...
You can also attach multimodal content to spans when using [manual tracing](/docs/3.10.2/genai/tracing/app-instrumentation/manual-tracing.md). Set the `mlflow.chat.messages` span attribute with content parts following the OpenAI format:
