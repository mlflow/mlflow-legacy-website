...
![Goose Tracing via MLflow](/docs/3.10.2/images/llms/tracing/goose-tracing.png)

[MLflow Tracing](/docs/3.10.2/genai/tracing.md) provides automatic tracing capability for [Goose](https://github.com/block/goose), an open-source AI agent by Block that automates engineering tasks on your local machine. MLflow supports tracing for Goose through the [OpenTelemetry](/docs/3.10.2/genai/tracing/opentelemetry.md) integration.
...
This example uses SQLite as the backend store. To use other types of SQL databases such as PostgreSQL, MySQL, and MSSQL, change the store URI as described in the [backend store documentation](/docs/3.10.2/self-hosting/architecture/backend-store.md).

Managed MLflow

For a fully managed experience with built-in authentication, scalable storage, and team collaboration, [try Managed MLflow for free](/docs/3.10.2/genai/getting-started/databricks-trial.md).
...
### [Evaluate the Agent](/docs/3.10.2/genai/eval-monitor/running-evaluation/traces.md)

[Learn how to evaluate the agent's performance.](/docs/3.10.2/genai/eval-monitor/running-evaluation/traces.md)

[Evaluate traces →](/docs/3.10.2/genai/eval-monitor/running-evaluation/traces.md)

### [Collect User Feedback](/docs/3.10.2/genai/tracing/collect-user-feedback.md)

[Learn how to collect user feedback on traces for improving the agent.](/docs/3.10.2/genai/tracing/collect-user-feedback.md)

[Collect feedback →](/docs/3.10.2/genai/tracing/collect-user-feedback.md)

### [Search Traces](/docs/3.10.2/genai/tracing/search-traces.md)

[Learn how to search and analyze traces for insights.](/docs/3.10.2/genai/tracing/search-traces.md)
