...
![LangGraph Tracing via autolog](/docs/3.10.2/images/llms/tracing/langgraph-agent-trace.png)
...
Start the MLflow server following the [Self-Hosting Guide](/docs/3.10.2/self-hosting.md), if you don't have one already.
...
By combining auto-tracing with the [manual tracing APIs](/docs/3.10.2/genai/tracing/app-instrumentation/manual-tracing.md), you can add child spans inside a node or tool, to get more detailed insights for the step.
...
![LangGraph Child Span](/docs/3.10.2/assets/images/langgraph-child-span-076b0cb599aeabce965b36602d5fda82.png)
...
![LangGraph Thread ID](/docs/3.10.2/assets/images/langgraph-thread-id-f180f62c969e783d2a312a5d69ccd2fd.png)

By navigating to the Session tab on the side bar, you can view all the traces in the session.

![LangGraph Session Page](/docs/3.10.2/assets/images/langgraph-session-page-c27d68787ae5bbefa08c8bb485273697.png)
...
When using LangGraph.js with OpenTelemetry-based tracing, you can combine the automatically generated traces with the [MLflow Tracing SDK](/docs/3.10.2/genai/tracing.md) (`@mlflow/core`) to add custom spans, set tags, and update trace metadata within the same trace.
