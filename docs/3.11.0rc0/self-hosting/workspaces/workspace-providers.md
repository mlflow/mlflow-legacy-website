...
* [Permissions](/docs/3.11.0rc0/self-hosting/workspaces/permissions.md) - Configure workspace-scoped permissions
* [Getting Started](/docs/3.11.0rc0/self-hosting/workspaces/getting-started.md) - Set up your first workspace
