...
For a complete RAG application example with this judge, see the [RAG Evaluation guide](/docs/3.11.0rc0/genai/eval-monitor/scorers/llm-judge/rag.md).

## Interpret results[​](#interpret-results "Direct link to Interpret results")

The RetrievalSufficiency judge evaluates each retriever span separately and returns a separate Feedback object for each retriever span in your trace. Each [`Feedback`](/docs/3.11.0rc0/api_reference/python_api/mlflow.entities.html#mlflow.entities.Feedback) object contains:
...
### [Evaluate context relevance](/docs/3.11.0rc0/genai/eval-monitor/scorers/llm-judge/rag/relevance.md#retrievalrelevance-judge)

[Ensure retrieved documents are relevant before checking sufficiency](/docs/3.11.0rc0/genai/eval-monitor/scorers/llm-judge/rag/relevance.md#retrievalrelevance-judge)

[Learn more →](/docs/3.11.0rc0/genai/eval-monitor/scorers/llm-judge/rag/relevance.md#retrievalrelevance-judge)

### [Evaluate groundedness](/docs/3.11.0rc0/genai/eval-monitor/scorers/llm-judge/rag/groundedness.md)

[Verify that responses use only the provided context](/docs/3.11.0rc0/genai/eval-monitor/scorers/llm-judge/rag/groundedness.md)
...
[Create ground truth datasets with expected facts for testing](/docs/3.11.0rc0/genai/datasets.md)
