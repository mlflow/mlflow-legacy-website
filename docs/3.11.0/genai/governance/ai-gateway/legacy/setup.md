...
### [Configuration Guide](/docs/3.11.0/genai/governance/ai-gateway/legacy/configuration.md)

[Learn how to configure providers, endpoints, and advanced settings](/docs/3.11.0/genai/governance/ai-gateway/legacy/configuration.md)

[Configure providers →](/docs/3.11.0/genai/governance/ai-gateway/legacy/configuration.md)

### [Usage Guide](/docs/3.11.0/genai/governance/ai-gateway/legacy/usage.md)

[Start querying endpoints with Python client and REST APIs](/docs/3.11.0/genai/governance/ai-gateway/legacy/usage.md)

[Start using →](/docs/3.11.0/genai/governance/ai-gateway/legacy/usage.md)

### [Main AI Gateway](/docs/3.11.0/genai/governance/ai-gateway.md)

[Explore the modern AI Gateway with enhanced features and UI management](/docs/3.11.0/genai/governance/ai-gateway.md)

[View AI Gateway →](/docs/3.11.0/genai/governance/ai-gateway.md)
