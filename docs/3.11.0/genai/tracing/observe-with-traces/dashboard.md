...
1. Follow the [Tracing Quickstart](/docs/3.11.0/genai/tracing/quickstart.md) to log your first traces.
...
For more details, see the [migration guide](/docs/3.11.0/self-hosting/migrate-from-file-store.md).
