...
Custom scorers are written in Python and give you full control to evaluate any data from your app's traces. After you define a custom scorer, you can use it exactly like a [built-in LLM Judge](/docs/3.11.0/genai/eval-monitor/scorers/llm-judge/predefined.md#available-judges).
...
### [Evaluate GenAI during development](/docs/3.11.0/genai/eval-monitor.md)
