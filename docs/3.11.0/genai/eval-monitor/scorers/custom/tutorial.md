...
In MLflow Evaluation, [custom code-based scorers](/docs/3.11.0/genai/eval-monitor/scorers/custom.md) allow you to define flexible evaluation metrics for your AI agent or application.
