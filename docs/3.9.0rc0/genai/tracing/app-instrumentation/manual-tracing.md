...
In addition to the [Auto Tracing](/docs/3.9.0rc0/genai/tracing/app-instrumentation/automatic.md) integrations, you can instrument your GenAI application by using MLflow's manual tracing APIs.
...
![Tracing Decorator](/docs/3.9.0rc0/assets/images/trace-decorator-8ae22208121b562582947549f8b9a46e.png)
...
* 🎯 **`span_type` parameter** to set the type of span. Set either one of built-in [Span Types](/docs/3.9.0rc0/genai/concepts/span.md#span-types) or a string.
...
Use the [`mlflow.get_current_active_span()`](/docs/3.9.0rc0/api_reference/python_api/mlflow.html#mlflow.get_current_active_span) API.
...
Tags can be added to traces to provide additional metadata at the trace level. There are a few different ways to set tags on a trace. Please refer to the [how-to guide](/docs/3.9.0rc0/genai/tracing/attach-tags.md) for the other methods.
...
Use the [`mlflow.start_span()`](/docs/3.9.0rc0/api_reference/python_api/mlflow.html#mlflow.start_span) context manager.
...
[](/docs/3.9.0rc0/images/llms/tracing/trace-exception.mp4)
...
Of course, we recommend using the [auto-tracing for OpenAI](/docs/3.9.0rc0/genai/tracing/integrations/listing/openai.md) for examples like this, which does the same job but with one-liner code. The example below is for demonstration purposes.
...
![Multi threaded tracing](/docs/3.9.0rc0/assets/images/tracing-multi-thread-acfb6f382ce45e030c95b7c0536749bf.png)
...
**[Combining with Auto-Tracing](/docs/3.9.0rc0/genai/tracing/app-instrumentation/automatic.md#combining-manual-and-automatic-tracing)**: Mix automatic and manual tracing for optimal observability

**[Trace Concepts](/docs/3.9.0rc0/genai/concepts/trace.md)**: Understand the structure and components of MLflow traces

**[Querying Traces](/docs/3.9.0rc0/genai/tracing/search-traces.md)**: Programmatically search and analyze your traces
