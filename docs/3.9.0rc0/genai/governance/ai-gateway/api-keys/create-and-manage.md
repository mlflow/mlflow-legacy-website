...
![API Keys Page](/docs/3.9.0rc0/assets/images/api-keys-page-120794235927669caacd55978043270f.png)
...
4. **Regular rotation**: Periodically rotate credentials for security (see [Encryption & Rotation](/docs/3.9.0rc0/genai/governance/ai-gateway/api-keys/key-rotation.md))
