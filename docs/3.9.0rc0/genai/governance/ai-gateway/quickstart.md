...
![Create API Key](/docs/3.9.0rc0/assets/images/create-api-key-680a70020d74cde71f658c2bf2962d9a.png)
...
* **[Create and Manage API Keys](/docs/3.9.0rc0/genai/governance/ai-gateway/api-keys/create-and-manage.md)** - Learn about credential management and best practices
* **[Create and Manage Endpoints](/docs/3.9.0rc0/genai/governance/ai-gateway/endpoints/create-and-manage.md)** - Configure endpoints with multiple models
* **[Query Endpoints](/docs/3.9.0rc0/genai/governance/ai-gateway/endpoints/query-endpoints.md)** - Explore unified and passthrough APIs
* **[Model Providers](/docs/3.9.0rc0/genai/governance/ai-gateway/endpoints/model-providers.md)** - See all supported providers and models
* **[Traffic Routing & Fallbacks](/docs/3.9.0rc0/genai/governance/ai-gateway/traffic-routing-fallbacks.md)** - Set up A/B testing and high availability
