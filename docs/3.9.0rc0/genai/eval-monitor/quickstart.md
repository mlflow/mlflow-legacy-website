...
![Simple Evaluation Results](/docs/3.9.0rc0/images/mlflow-3/eval-monitor/quickstart-eval-hero.png)
...
MLflow stores evaluation results in a [MLflow Tracking Server](/docs/3.9.0rc0/self-hosting/architecture/tracking-server.md).
...
Create a file named `quickstart_eval.py`. This script will contain your mock agent, evaluation dataset, scorers, and the evaluation execution. Alternatively, you may run this in a [notebook](/docs/3.9.0rc0/genai/eval-monitor/notebooks/quickstart-eval.md).
...
* [Correctness](/docs/3.9.0rc0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.Correctness): Evaluates if the answer is factually correct, using the "expected\_response" field in the dataset.
* [Guidelines](/docs/3.9.0rc0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.Guidelines): Evaluates if the answer meets the given guidelines.
* `is_concise`: A custom scorer defined using the [scorer](/docs/3.9.0rc0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.scorer) decorator to judge if the answer is concise (less than 5 words).
...
![Detailed Score Rationale](/docs/3.9.0rc0/images/mlflow-3/eval-monitor/quickstart-eval-trace.png)
...
![Compare Evaluation Runs](/docs/3.9.0rc0/images/mlflow-3/eval-monitor/quickstart-eval-runs-compare.png)
