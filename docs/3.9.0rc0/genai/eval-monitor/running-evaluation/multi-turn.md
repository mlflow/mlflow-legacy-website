...
![Sessions View UI](/docs/3.9.0rc0/images/genai/sessions-view-ui.png)

To evaluate conversations, [get traces from your experiment](/docs/3.9.0rc0/genai/tracing/search-traces.md) and pass them to `mlflow.genai.evaluate`:
...
* **[ConversationCompleteness](/docs/3.9.0rc0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.ConversationCompleteness)**: Evaluates whether the agent addressed all user questions throughout the conversation (returns "yes" or "no")
* **[ConversationalGuidelines](/docs/3.9.0rc0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.ConversationalGuidelines)**: Evaluates whether the assistant's responses throughout the conversation comply with provided guidelines (returns "yes" or "no")
* **[KnowledgeRetention](/docs/3.9.0rc0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.KnowledgeRetention)**: Evaluates whether the assistant correctly retains information from earlier user inputs without contradiction or distortion (returns "yes" or "no")
* **[UserFrustration](/docs/3.9.0rc0/api_reference/python_api/mlflow.genai.html#mlflow.genai.scorers.UserFrustration)**: Detects and tracks user frustration patterns (returns "none", "resolved", or "unresolved")

See the [Predefined Scorers](/docs/3.9.0rc0/genai/eval-monitor/scorers/llm-judge/predefined.md#multi-turn-scorers) page for detailed usage examples and API documentation.

### Custom Scorers[​](#custom-scorers "Direct link to Custom Scorers")

You can create custom multi-turn scorers using [make\_judge](/docs/3.9.0rc0/api_reference/python_api/mlflow.genai.html#mlflow.genai.judges.make_judge) with the `{{ conversation }}` template variable:
...
### [Session Tracing Guide](/docs/3.9.0rc0/genai/tracing/track-users-sessions.md)

[Learn how to track users and sessions in your conversational AI applications for better evaluation.](/docs/3.9.0rc0/genai/tracing/track-users-sessions.md)

[Learn about sessions →](/docs/3.9.0rc0/genai/tracing/track-users-sessions.md)

### [Built-in Multi-Turn Scorers](/docs/3.9.0rc0/genai/eval-monitor/scorers/llm-judge/predefined.md#multi-turn-scorers)

[Explore predefined scorers for conversation completeness, user frustration, and other multi-turn metrics.](/docs/3.9.0rc0/genai/eval-monitor/scorers/llm-judge/predefined.md#multi-turn-scorers)

[View scorers →](/docs/3.9.0rc0/genai/eval-monitor/scorers/llm-judge/predefined.md#multi-turn-scorers)

### [Create Custom Multi-Turn Judges](/docs/3.9.0rc0/genai/eval-monitor/scorers/llm-judge/make-judge.md)

[Build custom LLM judges using make\_judge to evaluate conversation-specific criteria and patterns.](/docs/3.9.0rc0/genai/eval-monitor/scorers/llm-judge/make-judge.md)

[Create custom judges →](/docs/3.9.0rc0/genai/eval-monitor/scorers/llm-judge/make-judge.md)
