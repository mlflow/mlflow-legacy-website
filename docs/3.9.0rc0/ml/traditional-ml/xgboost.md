...
### [Tracking Server Setup](/docs/3.9.0rc0/ml/tracking/tutorials/remote-server.md)

[Set up a self-hosted MLflow tracking server for team collaboration and remote experiment tracking.](/docs/3.9.0rc0/ml/tracking/tutorials/remote-server.md)

[Learn more →](/docs/3.9.0rc0/ml/tracking/tutorials/remote-server.md)

### [Model Evaluation](/docs/3.9.0rc0/ml/evaluation.md)

[Evaluate XGBoost models using MLflow's comprehensive evaluation framework with built-in metrics and custom evaluators.](/docs/3.9.0rc0/ml/evaluation.md)

[Learn more →](/docs/3.9.0rc0/ml/evaluation.md)

### [Model Deployment](/docs/3.9.0rc0/ml/deployment.md)

[Deploy XGBoost models locally, to Kubernetes, AWS SageMaker, or other cloud platforms using MLflow's deployment tools.](/docs/3.9.0rc0/ml/deployment.md)
